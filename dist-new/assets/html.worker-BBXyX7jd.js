...
` + e.stack) : e;
	...
	const ko = "Canceled";
	function So(e) {
		return e instanceof Ri ? !0 : e instanceof Error && e.name === "Canceled" && e.message === "Canceled";
	}
	var Ri = class extends Error {
		constructor() {
			super(ko), this.name = this.message;
		}
	}, pn = class vi extends Error {
		constructor(t) {
	...
	}, oe = class ao extends Error {
		constructor(t) {
			super(t || "An unexpected bug occurred."), Object.setPrototypeOf(this, ao.prototype);
		}
	};
	function Lo(e, t = "Unreachable") {
		throw new Error(t);
	}
	function xo(e, t = "unexpected state") {
		if (!e) throw typeof t == "string" ? new oe(`Assertion Failed: ${t}`) : t;
	}
	function Rt(e) {
		if (!e()) {
			debugger;
			e(), At(new oe("Assertion Failed"));
		}
	}
	function Mi(e, t) {
		let n = 0;
	...
	(function(e) {
		...
		e.from = a;
		function* o(f) {
			for (let _ = f.length - 1; _ >= 0; _--) yield f[_];
		}
		e.reverse = o;
		function l(f) {
		...
		function u(f, _) {
			let C = 0;
			for (const z of f) if (_(z, C++)) return !0;
			return !1;
		}
		e.some = u;
		function d(f, _) {
			let C = 0;
			for (const z of f) if (!_(z, C++)) return !1;
			return !0;
		}
		e.every = d;
		function m(f, _) {
			for (const C of f) if (_(C)) return C;
		}
		e.find = m;
		function* p(f, _) {
			for (const C of f) _(C) && (yield C);
		}
		e.filter = p;
		function* b(f, _) {
			let C = 0;
			for (const z of f) yield _(z, C++);
		}
		e.map = b;
		function* g(f, _) {
			let C = 0;
		...
		e.flatMap = g;
		function* v(...f) {
			for (const _ of f) Ro(_) ? yield* _ : yield _;
		}
		e.concat = v;
		function T(f, _, C) {
			let z = C;
			for (const L of f) z = _(z, L);
			return z;
		}
		e.reduce = T;
		function k(f) {
		...
		e.length = k;
		function* E(f, _, C = f.length) {
			for (_ < -f.length && (_ = 0), _ < 0 && (_ += f.length), C < 0 ? C += f.length : C > f.length && (C = f.length); _ < C; _++) yield f[_];
		}
		e.slice = E;
		function I(f, _ = Number.POSITIVE_INFINITY) {
			const C = [];
			if (_ === 0) return [C, f];
			const z = f[Symbol.iterator]();
			for (let L = 0; L < _; L++) {
				const S = z.next();
				if (S.done) return [C, e.empty()];
				C.push(S.value);
			}
		...
		async function D(f) {
			const _ = [];
			for await (const C of f) _.push(C);
			return _;
		}
		e.asyncToArray = D;
		async function w(f) {
			let _ = [];
			for await (const C of f) _ = _.concat(C);
			return _;
		}
		e.asyncToArrayFlat = w;
	})(Mt || (Mt = {}));
	function Ei(e) {
		if (Mt.is(e)) {
			const t = [];
	...
	var gn = class oo {
		...
		add(t) {
			if (!t || t === ht.None) return t;
			if (t === this) throw new Error("Cannot register a disposable on itself!");
			return this._isDisposed ? oo.DISABLE_DISPOSED_WARNING || console.warn((/* @__PURE__ */ new Error("Trying to add a disposable to a DisposableStore that has already been disposed of. The added object will be leaked!")).stack) : this._toDispose.add(t), t;
		}
		delete(t) {
			if (t) {
		...
		constructor() {
			this._store = new gn(), this._store;
		}
		dispose() {
			this._store.dispose();
		}
		...
		static {
			this.Undefined = new on(void 0);
		}
		constructor(t) {
			this.element = t, this.next = on.Undefined, this.prev = on.Undefined;
		}
	}, No = class {
		constructor() {
		...
		_insert(e, t) {
			const n = new K(e);
			if (this._first === K.Undefined) this._first = n, this._last = n;
			else if (t) {
				const i = this._last;
	...
	const Co = globalThis.performance.now.bind(globalThis.performance);
	var Ni = class lo {
		static create(t) {
			return new lo(t);
		}
		constructor(t) {
			this._now = t === !1 ? Date.now : Co, this._startTime = this._now(), this._stopTime = -1;
		}
		stop() {
	...
	(function(e) {
		e.None = () => ht.None;
		function t(S, A) {
			return m(S, () => {}, 0, void 0, !0, void 0, A);
		}
		e.defer = t;
		function n(S) {
			return (A, y = null, R) => {
				let N = !1, H;
				return H = S((q) => {
					if (!N) return H ? H.dispose() : N = !0, A.call(y, q);
				}, null, R), N && H.dispose(), H;
			};
		}
		e.once = n;
		function r(S, A) {
			return e.once(e.filter(S, A));
		}
		e.onceIf = r;
		function i(S, A, y) {
			return u((R, N = null, H) => S((q) => R.call(N, A(q)), null, H), y);
		}
		e.map = i;
		function s(S, A, y) {
			return u((R, N = null, H) => S((q) => {
				A(q), R.call(N, q);
			}, null, H), y);
		}
		e.forEach = s;
		function a(S, A, y) {
			return u((R, N = null, H) => S((q) => A(q) && R.call(N, q), null, H), y);
		}
		e.filter = a;
		function o(S) {
			return S;
		...
		e.signal = o;
		function l(...S) {
			return (A, y = null, R) => d(Mo(...S.map((N) => N((H) => A.call(y, H)))), R);
		}
		e.any = l;
		function c(S, A, y, R) {
			let N = y;
			return i(S, (H) => (N = A(N, H), N), R);
		}
		e.reduce = c;
		function u(S, A) {
			let y;
			...
			return A?.add(R), R.event;
		}
		function d(S, A) {
			return A instanceof Array ? A.push(S) : A && A.add(S), S;
		}
		function m(S, A, y = 100, R = !1, N = !1, H, q) {
			let P, W, G, Z = 0, ae;
			const Ce = new ke({
				leakWarningThreshold: H,
				onWillAddFirstListener() {
					P = S((Ou) => {
						Z++, W = A(W, Ou), R && !G && (Ce.fire(W), W = void 0), ae = () => {
							const Fu = W;
							W = void 0, G = void 0, (!R || Z > 1) && Ce.fire(Fu), Z = 0;
						}, typeof y == "number" ? (G && clearTimeout(G), G = setTimeout(ae, y)) : G === void 0 && (G = null, queueMicrotask(ae));
					});
				},
			...
			return q?.add(Ce), Ce.event;
		}
		e.debounce = m;
		function p(S, A = 0, y) {
			return e.debounce(S, (R, N) => R ? (R.push(N), R) : [N], A, void 0, !0, void 0, y);
		}
		e.accumulate = p;
		function b(S, A = (R, N) => R === N, y) {
			let R = !0, N;
			return a(S, (H) => {
				const q = R || !A(H, N);
				return R = !1, N = H, q;
		...
		e.latch = b;
		function g(S, A, y) {
			return [e.filter(S, A, y), e.filter(S, (R) => !A(R), y)];
		}
		e.split = g;
		function v(S, A = !1, y = [], R) {
			let N = y.slice(), H = S((W) => {
				N ? N.push(W) : P.fire(W);
			});
			R && R.add(H);
			const q = () => {
				N?.forEach((W) => P.fire(W)), N = null;
			}, P = new ke({
				onWillAddFirstListener() {
					H || (H = S((W) => P.fire(W)), R && R.add(H));
				},
		...
		class E {
			...
			forEach(A) {
				return this.steps.push((y) => (A(y), y)), this;
			}
			filter(A) {
				return this.steps.push((y) => A(y) ? y : k), this;
			}
			reduce(A, y) {
				let R = y;
				return this.steps.push((N) => (R = A(R, N), R)), this;
			}
			latch(A = (y, R) => y === R) {
				let y = !0, R;
				return this.steps.push((N) => {
					const H = y || !A(N, R);
					return y = !1, R = N, H ? N : k;
				}), this;
			}
			evaluate(A) {
				for (const y of this.steps) if (A = y(A), A === k) break;
				return A;
			}
		}
		function I(S, A, y = (R) => R) {
			const R = (...P) => q.fire(y(...P)), N = () => S.on(A, R), H = () => S.removeListener(A, R), q = new ke({
				onWillAddFirstListener: N,
				onDidRemoveLastListener: H
			});
			return q.event;
		}
		e.fromNodeEventEmitter = I;
		function D(S, A, y = (R) => R) {
			const R = (...P) => q.fire(y(...P)), N = () => S.addEventListener(A, R), H = () => S.removeEventListener(A, R), q = new ke({
				onWillAddFirstListener: N,
				onDidRemoveLastListener: H
			});
			return q.event;
		...
		function w(S, A) {
			let y;
			const R = new Promise((N, H) => {
				const q = n(S)(N, null, A);
				y = () => q.dispose();
			});
			return R.cancel = y, R;
		}
		...
		class C {
			constructor(A, y) {
				...
				this.emitter = new ke(R), y && y.add(this.emitter);
			}
			beginUpdate(A) {
				this._counter++;
			}
		...
		function z(S, A) {
			return new C(S, A).emitter.event;
		}
		e.fromObservable = z;
		function L(S) {
			return (A, y, R) => {
				...
				const q = {
					...
					endUpdate() {
						N--, N === 0 && (S.reportChanges(), H && (H = !1, A.call(y)));
					},
				...
				S.addObserver(q), S.reportChanges();
				const P = { dispose() {
					S.removeObserver(q);
				} };
				return R instanceof gn ? R.add(P) : Array.isArray(R) && R.push(P), P;
			};
		}
	...
	var Io = class yi {
		...
		constructor(t) {
			this.listenerCount = 0, this.invocationCount = 0, this.elapsedOverall = 0, this.durations = [], this.name = `${t}_${yi._idPool++}`, yi.all.add(this);
		}
		start(t) {
	...
	var Ho = class co {
		...
		constructor(t, n, r = (co._idPool++).toString(16).padStart(3, "0")) {
		...
		static create() {
			return new ho((/* @__PURE__ */ new Error()).stack ?? "");
		}
		constructor(t) {
			this.value = t;
		}
...
`));
	...
	var ke = class {
		constructor(e) {
			this._size = 0, this._options = e, this._leakageMon = this._options?.leakWarningThreshold ? new Ho(e?.onListenerError ?? At, this._options?.leakWarningThreshold ?? zo) : void 0, this._perfMon = this._options?._profName ? new Io(this._options._profName) : void 0, this._deliveryQueue = this._options?.deliveryQueue;
		}
		dispose() {
		...
		get event() {
			return this._event ??= (e, t, n) => {
				if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
					...
					console.warn(a);
					const o = this._leakageMon.getMostFrequentStack() ?? ["UNKNOWN stack", -1], l = new Wo(`${a}. HINT: Stack shows most frequent listener (${o[1]}-times)`, o[0]);
					return (this._options?.onListenerError || At)(l), ht.None;
				}
				if (this._disposed) return ht.None;
				t && (e = e.bind(t));
				const r = new wn(e);
				let i;
				this._leakageMon && this._size >= Math.ceil(this._leakageMon.threshold * .2) && (r.stack = Uo.create(), i = this._leakageMon.check(r.stack, this._size + 1)), this._listeners ? this._listeners instanceof wn ? (this._deliveryQueue ??= new qo(), this._listeners = [this._listeners, r]) : this._listeners.push(r) : (this._options?.onWillAddFirstListener?.(this), this._listeners = r, this._options?.onDidAddFirstListener?.(this)), this._options?.onDidAddListener?.(this), this._size++;
				const s = Et(() => {
					i?.(), this._removeListener(r);
				});
				return n instanceof gn ? n.add(s) : Array.isArray(n) && n.push(s), s;
			}, this._event;
		}
		_removeListener(e) {
		...
		fire(e) {
			if (this._deliveryQueue?.current && (this._deliverQueue(this._deliveryQueue), this._perfMon?.stop()), this._perfMon?.start(this._size), this._listeners) if (this._listeners instanceof wn) this._deliver(this._listeners, e);
			else {
	...
	const Fo = Ci() === "pseudo" || typeof document < "u" && document.location && typeof document.location.hash == "string" && document.location.hash.indexOf("pseudo=true") >= 0;
	function Ii(e, t) {
		let n;
		...
		}), Fo && (n = "［" + n.replace(/[aouei]/g, "$&$&") + "］"), n;
	}
	function F(e, t, ...n) {
		return Ii(typeof e == "number" ? Bo(e, t) : t, n);
	}
	function Bo(e, t) {
		const n = Oo()?.[e];
		if (typeof n != "string") {
	...
	let Nt = !1, Ct = !1, It = !1, zi = !1, xe;
	const Ae = globalThis;
	let ce;
	typeof Ae.vscode < "u" && typeof Ae.vscode.process < "u" ? ce = Ae.vscode.process : typeof process < "u" && typeof process?.versions?.node == "string" && (ce = process);
	const Go = typeof ce?.versions?.electron == "string" && ce?.type === "renderer";
	if (typeof ce == "object") {
		Nt = ce.platform === "win32", Ct = ce.platform === "darwin", It = ce.platform === "linux", It && ce.env.SNAP && ce.env.SNAP_REVISION, ce.env.CI || ce.env.BUILD_ARTIFACTSTAGINGDIRECTORY || ce.env.GITHUB_WORKSPACE;
		const e = ce.env.VSCODE_NLS_CONFIG;
		if (e) try {
			const t = JSON.parse(e);
			t.userLocale, t.osLocale, t.resolvedLanguage, t.languagePack?.translationsConfigFile;
		} catch {}
	} else typeof navigator == "object" && !Go ? (xe = navigator.userAgent, Nt = xe.indexOf("Windows") >= 0, Ct = xe.indexOf("Macintosh") >= 0, (xe.indexOf("Macintosh") >= 0 || xe.indexOf("iPad") >= 0 || xe.indexOf("iPhone") >= 0) && navigator.maxTouchPoints && navigator.maxTouchPoints, It = xe.indexOf("Linux") >= 0, xe?.indexOf("Mobi"), zi = !0, Ci(), navigator.language.toLowerCase()) : console.error("Unable to resolve platform.");
	const ut = Nt, Xo = Ct;
	zi && typeof Ae.importScripts == "function" && Ae.origin;
	const Se = xe, Yo = typeof Ae.postMessage == "function" && !Ae.importScripts;
	(() => {
		if (Yo) {
			const e = [];
			...
			return (n) => {
				...
				e.push({
					id: r,
					callback: n
				}), Ae.postMessage({ vscodeScheduleAsyncWork: r }, "*");
			};
		}
		return (e) => setTimeout(e);
	})();
	const Qo = !!(Se && Se.indexOf("Chrome") >= 0);
	Se && Se.indexOf("Firefox");
	!Qo && Se && Se.indexOf("Safari");
	Se && Se.indexOf("Edg/");
	...
	var yn = class {
		...
		get value() {
			...
			} else if (this._state === qe.Running) throw new Error("Cannot read the value of a lazy that is being initialized");
	...
	var kn = class St {
		...
		static {
			this.cache = new Ko({ getCacheKey: JSON.stringify }, (t) => {
				...
				let a = t.filter((l) => !l.startsWith("_") && Object.hasOwn(s, l));
		...
		static {
			this._locales = new yn(() => Object.keys(St.ambiguousCharacterData.value).filter((t) => !t.startsWith("_")));
		}
		static getLocales() {
		...
		static getData() {
			return this._data || (this._data = new Set([...Object.values(ln.getRawData())].flat())), this._data;
		}
		static isInvisibleCharacter(t) {
			return ln.getData().has(t);
		}
		static get codePoints() {
			return ln.getData();
		}
	};
	const Ln = "default", ul = "$initialize";
	var dl = class {
		...
		async sendMessage(e, t, n) {
			...
			return new Promise((i, s) => {
				this._pendingReplies[r] = {
					resolve: i,
					reject: s
				}, this._send(new dl(this._workerId, r, e, t, n));
			});
		}
		listen(e, t, n) {
			let r = null;
			const i = new ke({
				onWillAddFirstListener: () => {
					r = String(++this._lastSentReq), this._pendingEmitters.set(r, i), this._send(new ml(this._workerId, r, e, t, n));
				},
				onDidRemoveLastListener: () => {
		...
		createProxyToRemoteChannel(e, t) {
			return new Proxy(Object.create(null), { get: (n, r) => (typeof r == "string" && !n[r] && (Pi(r) ? n[r] = (i) => this.listen(e, r, i) : Wi(r) ? n[r] = this.listen(e, r, void 0) : r.charCodeAt(0) === 36 && (n[r] = async (...i) => (await t?.(), this.sendMessage(e, r, i)))), n[r]) });
		}
		_handleMessage(e) {
			switch (e.type) {
		...
		_handleRequestMessage(e) {
			...
			this._handler.handleMessage(e.channel, e.method, e.args).then((n) => {
				this._send(new Di(this._workerId, t, n, void 0));
			}, (n) => {
				n.detail instanceof Error && (n.detail = fn(n.detail)), this._send(new Di(this._workerId, t, void 0, fn(n)));
			});
		}
		_handleSubscribeEventMessage(e) {
			const t = e.req, n = this._handler.handleEvent(e.channel, e.eventName, e.arg)((r) => {
				this._send(new fl(this._workerId, t, r));
			});
	...
	function Wi(e) {
		return e[0] === "o" && e[1] === "n" && Hi(e.charCodeAt(2));
	}
	function Pi(e) {
		return /^onDynamic/.test(e) && Hi(e.charCodeAt(9));
	}
	var bl = class {
		constructor(e, t) {
			this._localChannels = /* @__PURE__ */ new Map(), this._remoteChannels = /* @__PURE__ */ new Map(), this._protocol = new gl({
				sendMessage: (n, r) => {
					e(n, r);
				},
		...
		_handleMessage(e, t, n) {
			if (e === Ln && t === ul) return this.initialize(n[0]);
	...
	let qi = !1;
	function wl(e) {
		if (qi) throw new Error("WebWorker already initialized!");
		qi = !0;
	...
	const Oi = typeof Buffer < "u";
	new yn(() => new Uint8Array(256));
	let xn;
	var _l = class uo {
		static wrap(t) {
			return Oi && !Buffer.isBuffer(t) && (t = Buffer.from(t.buffer, t.byteOffset, t.byteLength)), new uo(t);
		}
		constructor(t) {
			this.buffer = t, this.byteLength = this.buffer.byteLength;
		}
		toString() {
			return Oi ? this.buffer.toString() : (xn || (xn = new TextDecoder()), xn.decode(this.buffer));
		}
	};
	const Fi = "0123456789abcdef";
	function vl({ buffer: e }) {
		let t = "";
	...
	function yl(e, t) {
		t = Bi(149417, t);
		for (let n = 0, r = e.length; n < r; n++) t = Bi(e.charCodeAt(n), t);
		return t;
	}
	function An(e, t, n = 32) {
		const r = n - t, i = ~((1 << r) - 1);
		return (e << t | (i & e) >>> r) >>> 0;
	}
	function dt(e, t = 32) {
		return e instanceof ArrayBuffer ? vl(_l.wrap(new Uint8Array(e))) : (e >>> 0).toString(16).padStart(t / 4, "0");
	}
	(class mo {
		static {
		...
		update(t) {
			...
			for (s !== 0 ? (a = s, o = -1, s = 0) : (a = t.charCodeAt(0), o = 0);;) {
				...
				if (zt(a)) if (o + 1 < n) {
					...
					Tn(c) ? (o++, l = Ui(a, c)) : l = 65533;
				} else {
					s = a;
					break;
				}
				else Tn(a) && (l = 65533);
				if (i = this._push(r, i, l), o++, o < n) a = t.charCodeAt(o);
				else break;
			}
		...
		digest() {
			return this._finished || (this._finished = !0, this._leftoverHighSurrogate && (this._leftoverHighSurrogate = 0, this._buffLen = this._push(this._buff, this._buffLen, 65533)), this._totalLen += this._buffLen, this._wrapUp()), dt(this._h0) + dt(this._h1) + dt(this._h2) + dt(this._h3) + dt(this._h4);
		}
		_wrapUp() {
		...
		_step() {
			const t = mo._bigBlock32, n = this._buffDV;
			for (let d = 0; d < 64; d += 4) t.setUint32(d, n.getUint32(d, !1), !1);
			for (let d = 64; d < 320; d += 4) t.setUint32(d, An(t.getUint32(d - 12, !1) ^ t.getUint32(d - 32, !1) ^ t.getUint32(d - 56, !1) ^ t.getUint32(d - 64, !1), 1), !1);
			let r = this._h0, i = this._h1, s = this._h2, a = this._h3, o = this._h4, l, c, u;
			for (let d = 0; d < 80; d++) d < 20 ? (l = i & s | ~i & a, c = 1518500249) : d < 40 ? (l = i ^ s ^ a, c = 1859775393) : d < 60 ? (l = i & s | i & a | s & a, c = 2400959708) : (l = i ^ s ^ a, c = 3395469782), u = An(r, 5) + l + o + c + t.getUint32(d * 4, !1) & 4294967295, o = a, a = s, s = An(i, 30), i = r, r = u;
	...
	function Tl(e, t, n) {
		return new $i(new Vi(e), new Vi(t)).ComputeDiff(n).changes;
	}
	var Ge = class {
		static Assert(e, t) {
		...
		constructor(t, n, r = null) {
			...
			const [i, s, a] = ot._getElements(t), [o, l, c] = ot._getElements(n);
			this._hasStrings = a && c, this._originalStringElements = i, this._originalElementsOrHash = s, this._modifiedStringElements = o, this._modifiedElementsOrHash = l, this.m_forwardHistory = [], this.m_reverseHistory = [];
		}
		...
		static _getElements(t) {
			...
			if (ot._isStringArray(n)) {
				const r = new Int32Array(n.length);
				for (let i = 0, s = n.length; i < s; i++) r[i] = yl(n[i], 0);
				return [
					n,
					r,
					!0
		...
		ElementsAreStrictEqual(t, n) {
			return this.ElementsAreEqual(t, n) ? ot._getStrictElement(this._originalSequence, t) === ot._getStrictElement(this._modifiedSequence, n) : !1;
		}
		...
		ComputeDiffRecursive(t, n, r, i, s) {
			...
			if (t > n || r > i) {
				let d;
				return r <= i ? (Ge.Assert(t === n + 1, "originalStart should only be one more than originalEnd"), d = [new He(t, 0, r, i - r + 1)]) : t <= n ? (Ge.Assert(r === i + 1, "modifiedStart should only be one more than modifiedEnd"), d = [new He(t, n - t + 1, r, 0)]) : (Ge.Assert(t === n + 1, "originalStart should only be one more than originalEnd"), Ge.Assert(r === i + 1, "modifiedStart should only be one more than modifiedEnd"), d = []), d;
			}
			const a = [0], o = [0], l = this.ComputeRecursionPoint(t, n, r, i, a, o, s), c = a[0], u = o[0];
			if (l !== null) return l;
			if (!s[0]) {
				const d = this.ComputeDiffRecursive(t, c, r, u, s);
				let m = [];
				return s[0] ? m = [new He(c + 1, n - (c + 1) + 1, u + 1, i - (u + 1) + 1)] : m = this.ComputeDiffRecursive(c + 1, n, u + 1, i, s), this.ConcatenateChanges(d, m);
			}
			return [new He(t, n - t + 1, r, i - r + 1)];
		}
		WALKTRACE(t, n, r, i, s, a, o, l, c, u, d, m, p, b, g, v, T, k) {
			let E = null, I = null, D = new ji(), w = n, f = r, _ = p[0] - v[0] - i, C = -1073741824, z = this.m_forwardHistory.length - 1;
			do {
				const L = _ + t;
				L === w || L < f && c[L - 1] < c[L + 1] ? (d = c[L + 1], b = d - _ - i, d < C && D.MarkNextChange(), C = d, D.AddModifiedElement(d + 1, b), _ = L + 1 - t) : (d = c[L - 1] + 1, b = d - _ - i, d < C && D.MarkNextChange(), C = d - 1, D.AddOriginalElement(d, b + 1), _ = L - 1 - t), z >= 0 && (c = this.m_forwardHistory[z], t = c[0], w = 1, f = c.length - 1);
			} while (--z >= -1);
			if (E = D.getReverseChanges(), k[0]) {
				let L = p[0] + 1, S = v[0] + 1;
				if (E !== null && E.length > 0) {
					const A = E[E.length - 1];
					L = Math.max(L, A.getOriginalEnd()), S = Math.max(S, A.getModifiedEnd());
				}
				I = [new He(L, m - L + 1, S, g - S + 1)];
			} else {
				D = new ji(), w = a, f = o, _ = p[0] - v[0] - l, C = 1073741824, z = T ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2;
				do {
					const L = _ + s;
					L === w || L < f && u[L - 1] >= u[L + 1] ? (d = u[L + 1] - 1, b = d - _ - l, d > C && D.MarkNextChange(), C = d + 1, D.AddOriginalElement(d + 1, b + 1), _ = L + 1 - s) : (d = u[L - 1], b = d - _ - l, d > C && D.MarkNextChange(), C = d, D.AddModifiedElement(d + 1, b + 1), _ = L - 1 - s), z >= 0 && (u = this.m_reverseHistory[z], s = u[0], w = 1, f = u.length - 1);
				} while (--z >= -1);
				I = D.getChanges();
			}
			return this.ConcatenateChanges(E, I);
		}
		ComputeRecursionPoint(t, n, r, i, s, a, o) {
			...
			const b = n - t + (i - r), g = b + 1, v = new Int32Array(g), T = new Int32Array(g), k = i - r, E = n - t, I = t - r, D = n - i, w = (E - k) % 2 === 0;
			v[k] = t, T[E] = n, o[0] = !1;
			for (let f = 1; f <= b / 2 + 1; f++) {
				let _ = 0, C = 0;
				u = this.ClipDiagonalBound(k - f, f, k, g), d = this.ClipDiagonalBound(k + f, f, k, g);
				for (let L = u; L <= d; L += 2) {
					L === u || L < d && v[L - 1] < v[L + 1] ? l = v[L + 1] : l = v[L - 1] + 1, c = l - (L - k) - I;
					const S = l;
					for (; l < n && c < i && this.ElementsAreEqual(l + 1, c + 1);) l++, c++;
					if (v[L] = l, l + c > _ + C && (_ = l, C = c), !w && Math.abs(L - E) <= f - 1 && l >= T[L]) return s[0] = l, a[0] = c, S <= T[L] && f <= 1448 ? this.WALKTRACE(k, u, d, I, E, m, p, D, v, T, l, n, s, c, i, a, w, o) : null;
				}
				const z = (_ - t + (C - r) - f) / 2;
				if (this.ContinueProcessingPredicate !== null && !this.ContinueProcessingPredicate(_, z)) return o[0] = !0, s[0] = _, a[0] = C, z > 0 && f <= 1448 ? this.WALKTRACE(k, u, d, I, E, m, p, D, v, T, l, n, s, c, i, a, w, o) : (t++, r++, [new He(t, n - t + 1, r, i - r + 1)]);
				m = this.ClipDiagonalBound(E - f, f, E, g), p = this.ClipDiagonalBound(E + f, f, E, g);
				for (let L = m; L <= p; L += 2) {
					L === m || L < p && T[L - 1] >= T[L + 1] ? l = T[L + 1] - 1 : l = T[L - 1], c = l - (L - E) - D;
					const S = l;
					for (; l > t && c > r && this.ElementsAreEqual(l, c);) l--, c--;
					if (T[L] = l, w && Math.abs(L - k) <= f && l <= v[L]) return s[0] = l, a[0] = c, S >= v[L] && f <= 1448 ? this.WALKTRACE(k, u, d, I, E, m, p, D, v, T, l, n, s, c, i, a, w, o) : null;
				}
				if (f <= 1447) {
					let L = new Int32Array(d - u + 2);
					L[0] = k - u + 1, Xe.Copy2(v, u, L, 1, d - u + 1), this.m_forwardHistory.push(L), L = new Int32Array(p - m + 2), L[0] = E - m + 1, Xe.Copy2(T, m, L, 1, p - m + 1), this.m_reverseHistory.push(L);
				}
			}
			return this.WALKTRACE(k, u, d, I, E, m, p, D, v, T, l, n, s, c, i, a, w, o);
		}
		PrettifyChanges(t) {
			...
			if (this._hasStrings) for (let n = 1, r = t.length; n < r; n++) {
				const i = t[n - 1], s = t[n], a = s.originalStart - i.originalStart - i.originalLength, o = i.originalStart, l = s.originalStart + s.originalLength, c = l - o, u = i.modifiedStart, d = s.modifiedStart + s.modifiedLength, m = d - u;
				if (a < 5 && c < 20 && m < 20) {
					const p = this._findBetterContiguousSequence(o, c, u, m, a);
					if (p) {
						const [b, g] = p;
						(b !== i.originalStart + i.originalLength || g !== i.modifiedStart + i.modifiedLength) && (i.originalLength = b - i.originalStart, i.modifiedLength = g - i.modifiedStart, s.originalStart = b + a, s.modifiedStart = g + a, s.originalLength = l - s.originalStart, s.modifiedLength = d - s.modifiedStart);
					}
				}
			}
			return t;
		...
		ConcatenateChanges(t, n) {
			...
			if (this.ChangesOverlap(t[t.length - 1], n[0], r)) {
				...
				return Xe.Copy(t, 0, i, 0, t.length - 1), i[t.length - 1] = r[0], Xe.Copy(n, 1, i, t.length, n.length - 1), i;
			} else {
				const i = new Array(t.length + n.length);
				return Xe.Copy(t, 0, i, 0, t.length), Xe.Copy(n, 0, i, t.length, n.length), i;
			}
		}
		ChangesOverlap(t, n, r) {
			if (Ge.Assert(t.originalStart <= n.originalStart, "Left change is not less than or equal to right change"), Ge.Assert(t.modifiedStart <= n.modifiedStart, "Left change is not less than or equal to right change"), t.originalStart + t.originalLength >= n.originalStart || t.modifiedStart + t.modifiedLength >= n.modifiedStart) {
				const i = t.originalStart;
				let s = t.originalLength;
				const a = t.modifiedStart;
				let o = t.modifiedLength;
				return t.originalStart + t.originalLength >= n.originalStart && (s = n.originalStart + n.originalLength - t.originalStart), t.modifiedStart + t.modifiedLength >= n.modifiedStart && (o = n.modifiedStart + n.modifiedLength - t.modifiedStart), r[0] = new He(i, s, a, o), !0;
		...
		static intersectRanges(t, n) {
			...
			const o = n.startLineNumber, l = n.startColumn, c = n.endLineNumber, u = n.endColumn;
			return r < o ? (r = o, i = l) : r === o && (i = Math.max(i, l)), s > c ? (s = c, a = u) : s === c && (a = Math.min(a, u)), r > s || r === s && i > a ? null : new te(r, i, s, a);
		}
		equalsRange(t) {
		...
		static compareRangesUsingStarts(t, n) {
			if (t && n) {
				...
				if (r === i) {
					...
					if (s === a) {
						const o = t.endLineNumber | 0, l = n.endLineNumber | 0;
						return o === l ? (t.endColumn | 0) - (n.endColumn | 0) : o - l;
					}
					return s - a;
				}
				return r - i;
	...
	var kl = class fo {
		constructor(t) {
			const n = Gi(t);
			this._defaultValue = n, this._asciiMap = fo._createAsciiMap(n), this._map = /* @__PURE__ */ new Map();
		}
		...
		constructor(e) {
			...
			for (let i = 0, s = e.length; i < s; i++) {
				const [a, o, l] = e[i];
				o > t && (t = o), a > n && (n = a), l > n && (n = l);
			}
			t++, n++;
			const r = new Sl(n, t, 0);
			for (let i = 0, s = e.length; i < s; i++) {
				const [a, o, l] = e[i];
				r.set(a, o, l);
			}
	...
	var Rl = class Ti {
		...
		static computeLinks(t, n = xl()) {
			const r = Al(), i = [];
			for (let s = 1, a = t.getLineCount(); s <= a; s++) {
				const o = t.getLineContent(s), l = o.length;
				let c = 0, u = 0, d = 0, m = 1, p = !1, b = !1, g = !1, v = !1;
				for (; c < l;) {
					let T = !1;
					const k = o.charCodeAt(c);
					if (m === 13) {
						let E;
						switch (k) {
							case 40:
							...
							case 34:
							case 96:
								d === k ? E = 1 : d === 39 || d === 34 || d === 96 ? E = 0 : E = 1;
								break;
							case 42:
								E = d === 42 ? 1 : 0;
								break;
						...
						E === 1 && (i.push(Ti._createLink(r, o, s, u, c)), T = !0);
					} else if (m === 12) {
						let E;
						k === 91 ? (b = !0, E = 0) : E = r.get(k), E === 1 ? T = !0 : m = 13;
					} else m = n.nextState(m, k), m === 0 && (T = !0);
					T && (m = 1, p = !1, b = !1, v = !1, u = c + 1, d = k), c++;
				}
				m === 13 && i.push(Ti._createLink(r, o, s, u, l));
			}
			return i;
		}
	};
	function Ml(e) {
		return !e || typeof e.getLineCount != "function" || typeof e.getLineContent != "function" ? [] : Rl.computeLinks(e);
	}
	var El = class po {
		constructor() {
	...
	const Xi = Object.freeze(function(e, t) {
	...
	(function(e) {
		function t(n) {
			return n === e.None || n === e.Cancelled || n instanceof Ut ? !0 : !n || typeof n != "object" ? !1 : typeof n.isCancellationRequested == "boolean" && typeof n.onCancellationRequested == "function";
		}
		e.isCancellationToken = t, e.None = Object.freeze({
			isCancellationRequested: !1,
			onCancellationRequested: bn.None
	...
	var Ut = class {
		...
		get onCancellationRequested() {
			return this._isCancelled ? Xi : (this._emitter || (this._emitter = new ke()), this._emitter.event);
		}
		dispose() {
		...
		get token() {
			return this._token || (this._token = new Ut()), this._token;
		}
		cancel() {
			this._token ? this._token instanceof Ut && this._token.cancel() : this._token = Ht.Cancelled;
		}
		dispose(e = !1) {
			e && this.cancel(), this._parentListener?.dispose(), this._token ? this._token instanceof Ut && this._token.dispose() : this._token = Ht.None;
		}
	}, Mn = class {
		constructor() {
	...
	const Dt = new Mn(), En = new Mn(), Nn = new Mn(), Cl = new Array(230), Il = Object.create(null), zl = Object.create(null), Yi = [];
	for (let e = 0; e <= 193; e++) Yi[e] = -1;
	(function() {
		const t = [
			[
				1,
		...
		for (const i of t) {
			const [s, a, o, l, c, u, d, m, p] = i;
			if (r[a] || (r[a] = !0, Il[o] = a, zl[o.toLowerCase()] = a, s && (Yi[a] = l)), !n[l]) {
				if (n[l] = !0, !c) throw new Error(`String representation missing for key code ${l} around scan code ${o}`);
				Dt.define(l, c), En.define(l, m || c), Nn.define(l, p || m || c);
			}
			u && (Cl[u] = l);
		}
	})();
	...
	(function(e) {
		function t(o) {
			return Dt.keyCodeToStr(o);
		}
		e.toString = t;
		function n(o) {
			return Dt.strToKeyCode(o);
		}
		e.fromString = n;
		function r(o) {
			return En.keyCodeToStr(o);
		}
		e.toUserSettingsUS = r;
		function i(o) {
			return Nn.keyCodeToStr(o);
		}
		e.toUserSettingsGeneral = i;
		function s(o) {
			return En.strToKeyCode(o) || Nn.strToKeyCode(o);
		}
	...
	if (typeof Cn < "u" && typeof Cn.process < "u") {
		...
		get platform() {
			return ut ? "win32" : Xo ? "darwin" : "linux";
		},
		get arch() {},
		get env() {
			return {};
	...
	const Wt = Je.cwd, Ul = Je.env, Dl = Je.platform, Wl = 65, Pl = 97, ql = 90, Ol = 122, Oe = 46, re = 47, he = 92, Re = 58, Fl = 63;
				...
				if (!(a === c - 1 || o === 1)) if (o === 2) {
					if (i.length < 2 || s !== 2 || i.charCodeAt(i.length - 1) !== Oe || i.charCodeAt(i.length - 2) !== Oe) {
						if (i.length > 2) {
							...
							u === -1 ? (i = "", s = 0) : (i = i.slice(0, u), s = i.length - 1 - i.lastIndexOf(n)), a = c, o = 0;
							continue;
						} else if (i.length !== 0) {
							i = "", s = 0, a = c, o = 0;
							continue;
	...
	function Zi(e, t) {
		Bl(t, "pathObject");
		const n = t.dir || t.root, r = t.base || `${t.name || ""}${Vl(t.ext)}`;
	...
	const le = {
		resolve(...e) {
			...
			for (let i = e.length - 1; i >= -1; i--) {
				...
				} else t.length === 0 ? s = Wt() : (s = Ul[`=${t}`] || Wt(), (s === void 0 || s.slice(0, 2).toLowerCase() !== t.toLowerCase() && s.charCodeAt(2) === he) && (s = `${t}\\`));
				const a = s.length;
				let o = 0, l = "", c = !1;
				const u = s.charCodeAt(0);
				if (a === 1) j(u) && (o = 1, c = !0);
				else if (j(u)) if (c = !0, j(s.charCodeAt(1))) {
					let d = 2, m = d;
					for (; d < a && !j(s.charCodeAt(d));) d++;
					if (d < a && d !== m) {
						const p = s.slice(m, d);
						for (m = d; d < a && j(s.charCodeAt(d));) d++;
						if (d < a && d !== m) {
							for (m = d; d < a && !j(s.charCodeAt(d));) d++;
							(d === a || d !== m) && (l = `\\\\${p}\\${s.slice(m, d)}`, o = d);
						}
					}
				} else o = 1;
				else Me(u) && s.charCodeAt(1) === Re && (l = s.slice(0, 2), o = 2, a > 2 && j(s.charCodeAt(2)) && (c = !0, o = 3));
		...
		normalize(e) {
			...
			if (t === 1) return In(s) ? "\\" : e;
			if (j(s)) if (i = !0, j(e.charCodeAt(1))) {
				let o = 2, l = o;
				for (; o < t && !j(e.charCodeAt(o));) o++;
				if (o < t && o !== l) {
					const c = e.slice(l, o);
					for (l = o; o < t && j(e.charCodeAt(o));) o++;
					if (o < t && o !== l) {
						for (l = o; o < t && !j(e.charCodeAt(o));) o++;
						if (o === t) return `\\\\${c}\\${e.slice(l)}\\`;
						o !== l && (r = `\\\\${c}\\${e.slice(l, o)}`, n = o);
					}
				}
			} else n = 1;
			else Me(s) && e.charCodeAt(1) === Re && (r = e.slice(0, 2), n = 2, t > 2 && j(e.charCodeAt(2)) && (i = !0, n = 3));
			let a = n < t ? Pt(e.slice(n), !i, "\\", j) : "";
			if (a.length === 0 && !i && (a = "."), a.length > 0 && j(e.charCodeAt(t - 1)) && (a += "\\"), !i && r === void 0 && e.includes(":")) {
				if (a.length >= 2 && Me(a.charCodeAt(0)) && a.charCodeAt(1) === Re) return `.\\${a}`;
				let o = e.indexOf(":");
				do
		...
		isAbsolute(e) {
			...
			return j(n) || t > 2 && Me(n) && e.charCodeAt(1) === Re && j(e.charCodeAt(2));
		},
		join(...e) {
		...
		relative(e, t) {
			...
			if (n.length !== e.length || r.length !== t.length) {
				const b = n.split("\\"), g = r.split("\\");
				b[b.length - 1] === "" && b.pop(), g[g.length - 1] === "" && g.pop();
				const v = b.length, T = g.length, k = v < T ? v : T;
				let E;
				for (E = 0; E < k && b[E].toLowerCase() === g[E].toLowerCase(); E++);
				return E === 0 ? r : E === k ? T > k ? g.slice(E).join("\\") : v > k ? "..\\".repeat(v - 1 - E) + ".." : "" : "..\\".repeat(v - E) + g.slice(E).join("\\");
			}
			let i = 0;
			...
			const a = s - i;
			let o = 0;
			for (; o < t.length && t.charCodeAt(o) === he;) o++;
			let l = t.length;
			for (; l - 1 > o && t.charCodeAt(l - 1) === he;) l--;
			const c = l - o, u = a < c ? a : c;
			let d = -1, m = 0;
			for (; m < u; m++) {
				const b = e.charCodeAt(i + m);
				if (b !== t.charCodeAt(o + m)) break;
				b === he && (d = m);
			}
			if (m !== u) {
				if (d === -1) return r;
				...
				if (c > u) {
					if (t.charCodeAt(o + m) === he) return r.slice(o + m + 1);
					if (m === 2) return r.slice(o + m);
				}
				a > u && (e.charCodeAt(i + m) === he ? d = m : m === 2 && (d = 3)), d === -1 && (d = 0);
			}
			let p = "";
			for (m = i + d + 1; m <= s; ++m) (m === s || e.charCodeAt(m) === he) && (p += p.length === 0 ? ".." : "\\..");
			return o += d, p.length > 0 ? `${p}${r.slice(o, l)}` : (r.charCodeAt(o) === he && ++o, r.slice(o, l));
		},
		toNamespacedPath(e) {
			...
			if (t.charCodeAt(0) === he) {
				if (t.charCodeAt(1) === he) {
					...
					if (n !== Fl && n !== Oe) return `\\\\?\\UNC\\${t.slice(2)}`;
				}
			} else if (Me(t.charCodeAt(0)) && t.charCodeAt(1) === Re && t.charCodeAt(2) === he) return `\\\\?\\${t}`;
			return t;
		},
		dirname(e) {
			ee(e, "path");
			...
			} else Me(i) && e.charCodeAt(1) === Re && (n = t > 2 && j(e.charCodeAt(2)) ? 3 : 2, r = n);
			let s = -1, a = !0;
		...
		basename(e, t) {
			...
			let n = 0, r = -1, i = !0, s;
			if (e.length >= 2 && Me(e.charCodeAt(0)) && e.charCodeAt(1) === Re && (n = 2), t !== void 0 && t.length > 0 && t.length <= e.length) {
				if (t === e) return "";
				...
				for (s = e.length - 1; s >= n; --s) {
					...
					} else o === -1 && (i = !1, o = s + 1), a >= 0 && (l === t.charCodeAt(a) ? --a === -1 && (r = s) : (a = -1, r = o));
				}
		...
		extname(e) {
			...
			e.length >= 2 && e.charCodeAt(1) === Re && Me(e.charCodeAt(0)) && (t = r = 2);
			for (let o = e.length - 1; o >= t; --o) {
				...
				i === -1 && (s = !1, i = o + 1), l === Oe ? n === -1 ? n = o : a !== 1 && (a = 1) : n !== -1 && (a = -1);
			}
		...
		parse(e) {
			...
			if (j(i)) {
				if (r = 1, j(e.charCodeAt(1))) {
					let d = 2, m = d;
					for (; d < n && !j(e.charCodeAt(d));) d++;
					if (d < n && d !== m) {
						for (m = d; d < n && j(e.charCodeAt(d));) d++;
						if (d < n && d !== m) {
							for (m = d; d < n && !j(e.charCodeAt(d));) d++;
							d === n ? r = d : d !== m && (r = d + 1);
						}
			...
			} else if (Me(i) && e.charCodeAt(1) === Re) {
			...
			let s = -1, a = r, o = -1, l = !0, c = e.length - 1, u = 0;
			for (; c >= r; --c) {
				...
				o === -1 && (l = !1, o = c + 1), i === Oe ? s === -1 ? s = c : u !== 1 && (u = 1) : s !== -1 && (u = -1);
			}
			return o !== -1 && (s === -1 || u === 0 || u === 1 && s === o - 1 && s === a + 1 ? t.base = t.name = e.slice(a, o) : (t.name = e.slice(a, s), t.base = e.slice(a, o), t.ext = e.slice(s, o))), a > 0 && a !== r ? t.dir = e.slice(0, a - 1) : t.dir = t.root, t;
		},
		sep: "\\",
		delimiter: ";",
		win32: null,
		...
		resolve(...e) {
			...
			for (let r = e.length - 1; r >= 0 && !n; r--) {
				const i = e[r];
				ee(i, `paths[${r}]`), i.length !== 0 && (t = `${i}/${t}`, n = i.charCodeAt(0) === re);
			}
			if (!n) {
				const r = jl();
				t = `${r}/${t}`, n = r.charCodeAt(0) === re;
			}
			return t = Pt(t, !n, "/", In), n ? `/${t}` : t.length > 0 ? t : ".";
		},
		normalize(e) {
			if (ee(e, "path"), e.length === 0) return ".";
			const t = e.charCodeAt(0) === re, n = e.charCodeAt(e.length - 1) === re;
			return e = Pt(e, !t, "/", In), e.length === 0 ? t ? "/" : n ? "./" : "." : (n && (e += "/"), t ? `/${e}` : e);
		},
		isAbsolute(e) {
		...
		join(...e) {
			...
			return t.length === 0 ? "." : ue.normalize(t.join("/"));
		},
		relative(e, t) {
			if (ee(e, "from"), ee(t, "to"), e === t || (e = ue.resolve(e), t = ue.resolve(t), e === t)) return "";
			...
			} else i > o && (e.charCodeAt(n + c) === re ? l = c : c === 0 && (l = 0));
			let u = "";
		...
		parse(e) {
			...
			let r;
			n ? (t.root = "/", r = 1) : r = 0;
			let i = -1, s = 0, a = -1, o = !0, l = e.length - 1, c = 0;
			for (; l >= r; --l) {
				...
				a === -1 && (o = !1, a = l + 1), u === Oe ? i === -1 ? i = l : c !== 1 && (c = 1) : i !== -1 && (c = -1);
			}
			if (a !== -1) {
				const u = s === 0 && n ? 1 : s;
				i === -1 || c === 0 || c === 1 && i === a - 1 && i === s + 1 ? t.base = t.name = e.slice(u, a) : (t.name = e.slice(u, i), t.base = e.slice(u, a), t.ext = e.slice(i, a));
			}
	...
	Ue ? le.normalize : ue.normalize;
	Ue ? le.resolve : ue.resolve;
	Ue ? le.relative : ue.relative;
	Ue ? le.dirname : ue.dirname;
	Ue ? le.basename : ue.basename;
	Ue ? le.extname : ue.extname;
	Ue ? le.sep : ue.sep;
	const $l = /^\w[\w\d+.-]*$/, Gl = /^\//, Xl = /^\/\//;
	function Yl(e, t) {
		...
		if (e.scheme && !$l.test(e.scheme)) throw new Error("[UriError]: Scheme contains illegal characters.");
		if (e.path) {
			if (e.authority) {
				if (!Gl.test(e.path)) throw new Error("[UriError]: If a URI contains an authority component, then the path component must either be empty or begin with a slash (\"/\") character");
			} else if (Xl.test(e.path)) throw new Error("[UriError]: If a URI does not contain an authority component, then the path cannot begin with two slash characters (\"//\")");
		}
	}
	function Jl(e, t) {
		return !e && !t ? "file" : e;
	...
	var zn = class cn {
		static isUri(t) {
			return t instanceof cn ? !0 : !t || typeof t != "object" ? !1 : typeof t.authority == "string" && typeof t.fragment == "string" && typeof t.path == "string" && typeof t.query == "string" && typeof t.scheme == "string" && typeof t.fsPath == "string" && typeof t.with == "function" && typeof t.toString == "function";
		}
		constructor(t, n, r, i, s, a = !1) {
			typeof t == "object" ? (this.scheme = t.scheme || Q, this.authority = t.authority || Q, this.path = t.path || Q, this.query = t.query || Q, this.fragment = t.fragment || Q) : (this.scheme = Jl(t, a), this.authority = n || Q, this.path = Ql(this.scheme, r || Q), this.query = i || Q, this.fragment = s || Q, Yl(this, a));
		}
		get fsPath() {
			return Hn(this, !1);
		}
		with(t) {
			...
			return n === void 0 ? n = this.scheme : n === null && (n = Q), r === void 0 ? r = this.authority : r === null && (r = Q), i === void 0 ? i = this.path : i === null && (i = Q), s === void 0 ? s = this.query : s === null && (s = Q), a === void 0 ? a = this.fragment : a === null && (a = Q), n === this.scheme && r === this.authority && i === this.path && s === this.query && a === this.fragment ? this : new Qe(n, r, i, s, a);
		}
		static parse(t, n = !1) {
			const r = Zl.exec(t);
			return r ? new Qe(r[2] || Q, qt(r[4] || Q), qt(r[5] || Q), qt(r[7] || Q), qt(r[9] || Q), n) : new Qe(Q, Q, Q, Q, Q);
		}
		static file(t) {
			let n = Q;
			if (ut && (t = t.replace(/\\/g, _e)), t[0] === _e && t[1] === _e) {
				const r = t.indexOf(_e, 2);
				r === -1 ? (n = t.substring(2), t = _e) : (n = t.substring(2, r), t = t.substring(r) || _e);
			}
			return new Qe("file", n, t, Q, Q);
		}
		static from(t, n) {
		...
		static joinPath(t, ...n) {
			...
			let r;
			return ut && t.scheme === "file" ? r = cn.file(le.join(Hn(t, !0), ...n)).path : r = ue.join(t.path, ...n), t.with({ path: r });
		}
		toString(t = !1) {
			return Un(this, t);
		}
		...
		static revive(t) {
			if (t) {
				...
				{
					const n = new Qe(t);
					return n._formatted = t.external ?? null, n._fsPath = t._sep === Ki ? t.fsPath ?? null : null, n;
				}
			} else return t;
		}
	};
	const Ki = ut ? 1 : void 0;
	var Qe = class extends zn {
		...
		toString(e = !1) {
			return e ? Un(this, !0) : (this._formatted || (this._formatted = Un(this, !1)), this._formatted);
		}
		toJSON() {
			const e = { $mid: 1 };
			return this._fsPath && (e.fsPath = this._fsPath, e._sep = Ki), this._formatted && (e.external = this._formatted), this.path && (e.path = this.path), this.scheme && (e.scheme = this.scheme), this.authority && (e.authority = this.authority), this.query && (e.query = this.query), this.fragment && (e.fragment = this.fragment), e;
		}
	};
	const er = {
		58: "%3A",
	...
	function Kl(e) {
		...
		for (let n = 0; n < e.length; n++) {
			const r = e.charCodeAt(n);
			r === 35 || r === 63 ? (t === void 0 && (t = e.substr(0, n)), t += er[r]) : t !== void 0 && (t += e[n]);
		}
		return t !== void 0 ? t : e;
	}
	function Hn(e, t) {
		let n;
		return e.authority && e.path.length > 1 && e.scheme === "file" ? n = `//${e.authority}${e.path}` : e.path.charCodeAt(0) === 47 && (e.path.charCodeAt(1) >= 65 && e.path.charCodeAt(1) <= 90 || e.path.charCodeAt(1) >= 97 && e.path.charCodeAt(1) <= 122) && e.path.charCodeAt(2) === 58 ? t ? n = e.path.substr(1) : n = e.path[1].toLowerCase() + e.path.substr(2) : n = e.path, ut && (n = n.replace(/\//g, "\\")), n;
	}
	function Un(e, t) {
		const n = t ? Kl : tr;
		...
		return o && (r += "?", r += n(o, !1, !1)), l && (r += "#", r += t ? l : tr(l, !1, !1)), r;
	}
	function nr(e) {
		try {
			return decodeURIComponent(e);
		} catch {
			return e.length > 3 ? e.substr(0, 3) + nr(e.substr(3)) : e;
		}
	}
	const ir = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
	function qt(e) {
		return e.match(ir) ? e.replace(ir, (t) => nr(t)) : e;
	}
	var ec = class be extends V {
		constructor(t, n, r, i) {
	...
	var ic = class {
		...
		register(e, t) {
			return this._tokenizationSupports.set(e, t), this.handleChange([e]), Et(() => {
		...
		registerFactory(e, t) {
			...
			return this._factories.set(e, n), Et(() => {
	...
	(function(e) {
		...
		function r(a) {
			switch (a) {
				case 0: return F(728, "Method");
				case 1: return F(729, "Function");
				case 2: return F(730, "Constructor");
				case 3: return F(731, "Field");
				case 4: return F(732, "Variable");
				case 5: return F(733, "Class");
				case 6: return F(734, "Struct");
				case 7: return F(735, "Interface");
				case 8: return F(736, "Module");
				case 9: return F(737, "Property");
				case 10: return F(738, "Event");
				case 11: return F(739, "Operator");
				case 12: return F(740, "Unit");
				case 13: return F(741, "Value");
				case 14: return F(742, "Constant");
				case 15: return F(743, "Enum");
				case 16: return F(744, "Enum Member");
				case 17: return F(745, "Keyword");
				case 18: return F(746, "Text");
				case 19: return F(747, "Color");
				case 20: return F(748, "File");
				case 21: return F(749, "Reference");
				case 22: return F(750, "Custom Color");
				case 23: return F(751, "Folder");
				case 24: return F(752, "Type Parameter");
				case 25: return F(753, "User");
				case 26: return F(754, "Issue");
				case 27: return F(755, "Tool");
				case 28: return F(756, "Snippet");
				default: return "";
			}
		}
		e.toLabel = r;
	...
	F(757, "array"), F(758, "boolean"), F(759, "class"), F(760, "constant"), F(761, "constructor"), F(762, "enumeration"), F(763, "enumeration member"), F(764, "event"), F(765, "field"), F(766, "file"), F(767, "function"), F(768, "interface"), F(769, "key"), F(770, "method"), F(771, "module"), F(772, "namespace"), F(773, "null"), F(774, "number"), F(775, "object"), F(776, "operator"), F(777, "package"), F(778, "property"), F(779, "string"), F(780, "struct"), F(781, "type parameter"), F(782, "variable");
	var mr;
	(function(e) {
		const t = /* @__PURE__ */ new Map();
	...
	(class Pe {
		static {
			this.Comment = new Pe("comment");
		}
		static {
			this.Imports = new Pe("imports");
		}
		static {
			this.Region = new Pe("region");
		}
		static fromValue(t) {
			switch (t) {
				case "comment": return Pe.Comment;
				case "imports": return Pe.Imports;
				case "region": return Pe.Region;
			}
			return new Pe(t);
		}
		constructor(t) {
	...
	(class Lt {
		...
		constructor(t, n) {
			if (this[ls] = "ResourceMap", t instanceof Lt) this.map = new Map(t.map), this.toKey = n ?? Lt.defaultToKey;
			else if (cc(t)) {
				this.map = /* @__PURE__ */ new Map(), this.toKey = n ?? Lt.defaultToKey;
				for (const [r, i] of t) this.set(r, i);
			} else this.map = /* @__PURE__ */ new Map(), this.toKey = t ?? Lt.defaultToKey;
		}
		set(t, n) {
			return this.map.set(this.toKey(t), new lc(t, n)), this;
		}
		get(t) {
	...
	function bc(e, t, n, r, i) {
		return pc(e, t, n, r, i) && gc(e, t, n, r, i);
	}
	var wc = class {
		constructor(e, t) {
		...
		next(e) {
			...
			do {
				...
				if (r === this._prevMatchStartIndex && i === this._prevMatchLength) {
					if (i === 0) {
						ol(e, t, this._searchRegex.lastIndex) > 65535 ? this._searchRegex.lastIndex += 2 : this._searchRegex.lastIndex += 1;
						continue;
					}
					return null;
				}
				if (this._prevMatchStartIndex = r, this._prevMatchLength = i, !this._wordSeparators || bc(this._wordSeparators, e, t, r, i)) return n;
			} while (n);
			return null;
		}
	};
	...
	function vc(e = "") {
		let t = "(-?\\d*\\.\\d\\w*)|([^";
		for (const n of _c) e.indexOf(n) >= 0 || (t += "\\" + n);
	...
	function On(e, t, n, r, i) {
		if (t = bs(t), i || (i = Mt.first(ws)), n.length > i.maxLen) {
			let c = e - i.maxLen / 2;
			return c < 0 ? c = 0 : r += c, n = n.substring(c, e + i.maxLen / 2), On(e, t, n, r, i);
		}
		const s = Date.now(), a = e - 1 - r;
		let o = -1, l = null;
		for (let c = 1; !(Date.now() - s >= i.timeBudget); c++) {
			const u = a - i.windowSize * c;
	...
	var Tc = class {
		static computeUnicodeHighlights(e, t, n) {
			const r = n ? n.startLineNumber : 1, i = n ? n.endLineNumber : e.getLineCount(), s = new _s(t), a = s.getCandidateCodePoints();
			let o;
			a === "allNonBasicAscii" ? o = /* @__PURE__ */ new RegExp("[^\\t\\n\\r\\x20-\\x7E]", "g") : o = new RegExp(`${kc(Array.from(a))}`, "g");
			const l = new wc(null, o), c = [];
			let u = !1, d, m = 0, p = 0, b = 0;
			e: for (let g = r, v = i; g <= v; g++) {
				const T = e.getLineContent(g), k = T.length;
				l.reset(0);
				do
					if (d = l.next(T), d) {
						let E = d.index, I = d.index + d[0].length;
						E > 0 && zt(T.charCodeAt(E - 1)) && E--, I + 1 < k && zt(T.charCodeAt(I - 1)) && I++;
						const D = T.substring(E, I);
						let w = On(E + 1, gs, T, 0);
						w && w.endColumn <= E + 1 && (w = null);
						const f = s.shouldHighlightNonBasicASCII(D, w ? w.word : null);
						if (f !== 0) {
							if (f === 3 ? m++ : f === 2 ? p++ : f === 1 ? b++ : Lo(), c.length >= 1e3) {
								u = !0;
								break e;
							}
							c.push(new V(g, E + 1, g, I + 1));
						}
					}
				while (d);
			}
		...
		static computeUnicodeHighlightReason(e, t) {
			...
			switch (n.shouldHighlightNonBasicASCII(e, null)) {
				...
				case 3: {
					const r = e.codePointAt(0), i = n.ambiguousCharacters.getPrimaryConfusable(r), s = kn.getLocales().filter((a) => !kn.getInstance(new Set([...t.allowedLocales, a])).isAmbiguous(r));
					return {
						kind: 0,
	...
	function kc(e, t) {
		return `[${el(e.map((n) => String.fromCodePoint(n)).join(""))}]`;
	}
	var _s = class {
		constructor(e) {
			this.options = e, this.allowedCodePoints = new Set(e.allowedCodePoints), this.ambiguousCharacters = kn.getInstance(new Set(e.allowedLocales));
		}
		getCandidateCodePoints() {
			if (this.options.nonBasicASCII) return "allNonBasicAscii";
			const e = /* @__PURE__ */ new Set();
			if (this.options.invisibleCharacters) for (const t of Sn.codePoints) vs(String.fromCodePoint(t)) || e.add(t);
		...
		shouldHighlightNonBasicASCII(e, t) {
			...
			if (t) for (const s of t) {
				const a = s.codePointAt(0), o = cl(s);
				r = r || o, !o && !this.ambiguousCharacters.isAmbiguous(a) && !Sn.isInvisibleCharacter(a) && (i = !0);
			}
			return !r && i ? 0 : this.options.invisibleCharacters && !vs(e) && Sn.isInvisibleCharacter(n) ? 2 : this.options.ambiguousCharacters && this.ambiguousCharacters.isAmbiguous(n) ? 3 : 0;
		}
	};
	function vs(e) {
		return e === " " || e === `
` || e === "	";
	...
	(class hn {
		...
		findLastMaxBy(t) {
			let n, r = !0;
			return this.iterate((i) => ((r || Fn.isGreaterThan(t(i, n))) && (r = !1, n = i), !0)), n;
		}
	});
	var J = class ge {
		static fromTo(t, n) {
		...
		constructor(t, n) {
			if (this.start = t, this.endExclusive = n, t > n) throw new oe(`Invalid range: ${this.toString()}`);
		}
		get isEmpty() {
			return this.start === this.endExclusive;
		}
		delta(t) {
			return new ge(this.start + t, this.endExclusive + t);
		}
		deltaStart(t) {
			return new ge(this.start + t, this.endExclusive);
		}
		deltaEnd(t) {
			return new ge(this.start, this.endExclusive + t);
		}
		get length() {
		...
		join(t) {
			return new ge(Math.min(this.start, t.start), Math.max(this.endExclusive, t.endExclusive));
		}
		intersect(t) {
		...
		clip(t) {
			if (this.isEmpty) throw new oe(`Invalid clipping range: ${this.toString()}`);
		...
		joinRightTouching(t) {
			if (this.endExclusive !== t.start) throw new oe(`Invalid join: ${this.toString()} and ${t.toString()}`);
			return new ge(this.start, t.endExclusive);
		}
	};
	function Ze(e, t) {
		const n = Ke(e, t);
	...
	function Ke(e, t, n = 0, r = e.length) {
		let i = n, s = r;
		for (; i < s;) {
	...
	var ys = class go {
		...
		static {
			this.compareByStart = ft((t) => t.startLineNumber, pt);
		}
		static joinMany(t) {
			if (t.length === 0) return [];
			let n = new Ft(t[0].slice());
			for (let r = 1; r < t.length; r++) n = n.getUnion(new Ft(t[r].slice()));
			return n.ranges;
		}
		static join(t) {
			if (t.length === 0) throw new oe("lineRanges cannot be empty");
		...
		constructor(t, n) {
			if (t > n) throw new oe(`startLineNumber ${t} cannot be after endLineNumberExclusive ${n}`);
		...
		addMargin(t, n) {
			return new Te(this.startLineNumber - t, this.endLineNumberExclusive + n);
		}
	}, Ft = class lt {
		constructor(t = []) {
		...
		addRange(t) {
			if (t.length === 0) return;
			const n = Bn(this._normalizedRanges, (i) => i.endLineNumberExclusive >= t.startLineNumber), r = Ke(this._normalizedRanges, (i) => i.startLineNumber <= t.endLineNumberExclusive) + 1;
		...
		contains(t) {
			const n = Ze(this._normalizedRanges, (r) => r.startLineNumber <= t);
			return !!n && n.endLineNumberExclusive > t;
		}
		intersects(t) {
			const n = Ze(this._normalizedRanges, (r) => r.startLineNumber < t.endLineNumberExclusive);
		...
		getUnion(t) {
			...
			for (; r < this._normalizedRanges.length || i < t._normalizedRanges.length;) {
				...
				s === null ? s = a : s.endLineNumberExclusive >= a.startLineNumber ? s = new X(s.startLineNumber, Math.max(s.endLineNumberExclusive, a.endLineNumberExclusive)) : (n.push(s), s = a);
			}
			return s !== null && n.push(s), new lt(n);
		}
		subtractFrom(t) {
			const n = Bn(this._normalizedRanges, (a) => a.endLineNumberExclusive >= t.startLineNumber), r = Ke(this._normalizedRanges, (a) => a.startLineNumber <= t.endLineNumberExclusive) + 1;
			if (n === r) return new lt([t]);
			const i = [];
			let s = t.startLineNumber;
			for (let a = n; a < r; a++) {
				const o = this._normalizedRanges[a];
				o.startLineNumber > s && i.push(new X(s, o.startLineNumber)), s = o.endLineNumberExclusive;
			}
			return s < t.endLineNumberExclusive && i.push(new X(s, t.endLineNumberExclusive)), new lt(i);
		}
		toString() {
		...
		static {
			this.zero = new Ie(0, 0);
		}
		static betweenPositions(t, n) {
			return t.lineNumber === n.lineNumber ? new Ie(0, n.column - t.column) : new Ie(n.lineNumber - t.lineNumber, n.column - 1);
		}
		static fromPosition(t) {
			return new Ie(t.lineNumber - 1, t.column - 1);
		}
		static ofRange(t) {
			return Ie.betweenPositions(t.getStartPosition(), t.getEndPosition());
		}
		static ofText(t) {
			let n = 0, r = 0;
			for (const i of t) i === `
` ? (n++, r = 0) : r++;
		...
		add(t) {
			return t.lineCount === 0 ? new Ie(this.lineCount, this.columnCount + t.columnCount) : new Ie(this.lineCount + t.lineCount, t.columnCount);
		}
		createRange(t) {
		...
		getStringReplacement(e) {
			return new Bt.deps.StringReplacement(this.getOffsetRange(e.range), e.text);
		}
		getTextReplacement(e) {
			return new Bt.deps.TextReplacement(this.getRange(e.replaceRange), e.newText);
		}
		getTextEdit(e) {
			const t = e.replacements.map((n) => this.getTextReplacement(n));
			return new Bt.deps.TextEdit(t);
		}
	}, Bt = class {
		static {
			this._deps = void 0;
...
` && (this.lineStartOffsetByLineIdx.push(t + 1), t > 0 && e.charAt(t - 1) === "\r" ? this.lineEndOffsetByLineIdx.push(t - 1) : this.lineEndOffsetByLineIdx.push(t));
		...
		getPosition(e) {
			const t = Ke(this.lineStartOffsetByLineIdx, (n) => n <= e);
			return new Y(t + 1, e - this.lineStartOffsetByLineIdx[t] + 1);
		}
		get textLength() {
			const e = this.lineStartOffsetByLineIdx.length - 1;
			return new Bt.deps.TextLength(e, this.text.length - this.lineStartOffsetByLineIdx[e]);
		}
		getLineLength(e) {
		...
		getTransformer() {
			return this._transformer || (this._transformer = new Ic(this.getValue())), this._transformer;
		}
		getLineAt(e) {
		...
		constructor(e, t) {
			xo(t >= 1), super(), this._getLineContent = e, this._lineCount = t;
		}
		getValueOfRange(e) {
...
` + this._getLineContent(e.endLineNumber).substring(0, e.endColumn - 1), t;
		...
		get length() {
			...
			return new Vn(this._lineCount - 1, e.length);
		}
	}, Vt = class extends Hc {
		constructor(e) {
		...
		static joinReplacements(t, n) {
			...
			for (let a = 0; a < t.length; a++) {
				...
				if (s += o.text, a < t.length - 1) {
					const l = t[a + 1], c = V.fromPositions(o.range.getEndPosition(), l.range.getStartPosition()), u = n.getValueOfRange(c);
					s += u;
				}
			}
			return new $e(V.fromPositions(r, i), s);
		}
...
`, `
`), i = sl(n, r), s = Vn.ofText(n.substring(0, i)).addToPosition(this.range.getStartPosition()), a = r.substring(i);
			return new $e(V.fromPositions(s, this.range.getEndPosition()), a);
		}
...
`), r = this.text.replaceAll(`\r
`, `
`), i = al(n, r), s = Vn.ofText(n.substring(0, n.length - i)).addToPosition(this.range.getStartPosition()), a = r.substring(0, r.length - i);
			return new $e(V.fromPositions(this.range.getStartPosition(), s), a);
		}
		toString() {
		...
		static inverse(t, n, r) {
			...
			let s = 1, a = 1;
			for (const l of t) {
				const c = new ct(new X(s, l.original.startLineNumber), new X(a, l.modified.startLineNumber));
				c.modified.isEmpty || i.push(c), s = l.original.endLineNumberExclusive, a = l.modified.endLineNumberExclusive;
			}
			const o = new ct(new X(s, n + 1), new X(a, r + 1));
		...
		static clip(t, n, r) {
			...
			for (const s of t) {
				...
				a && !a.isEmpty && o && !o.isEmpty && i.push(new ct(a, o));
			}
			return i;
		}
		constructor(t, n) {
		...
		flip() {
			return new ct(this.modified, this.original);
		}
		join(t) {
			return new ct(this.original.join(t.original), this.modified.join(t.modified));
		}
		toRangeMapping() {
			const t = this.original.toInclusiveRange(), n = this.modified.toInclusiveRange();
			if (t && n) return new Ee(t, n);
			if (this.original.startLineNumber === 1 || this.modified.startLineNumber === 1) {
				if (!(this.modified.startLineNumber === 1 && this.original.startLineNumber === 1)) throw new oe("not a valid diff");
				return new Ee(new V(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1), new V(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1));
			} else return new Ee(new V(this.original.startLineNumber - 1, Number.MAX_SAFE_INTEGER, this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), new V(this.modified.startLineNumber - 1, Number.MAX_SAFE_INTEGER, this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER));
		}
		toRangeMapping2(t, n) {
			if (Ts(this.original.endLineNumberExclusive, t) && Ts(this.modified.endLineNumberExclusive, n)) return new Ee(new V(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1), new V(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1));
			if (!this.original.isEmpty && !this.modified.isEmpty) return new Ee(V.fromPositions(new Y(this.original.startLineNumber, 1), tt(new Y(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), t)), V.fromPositions(new Y(this.modified.startLineNumber, 1), tt(new Y(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), n)));
			if (this.original.startLineNumber > 1 && this.modified.startLineNumber > 1) return new Ee(V.fromPositions(tt(new Y(this.original.startLineNumber - 1, Number.MAX_SAFE_INTEGER), t), tt(new Y(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), t)), V.fromPositions(tt(new Y(this.modified.startLineNumber - 1, Number.MAX_SAFE_INTEGER), n), tt(new Y(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), n)));
			throw new oe();
		}
	};
	function tt(e, t) {
	...
	var gt = class un extends et {
		static fromRangeMappings(t) {
			return new un(X.join(t.map((n) => X.fromRangeInclusive(n.originalRange))), X.join(t.map((n) => X.fromRangeInclusive(n.modifiedRange))), t);
		}
		constructor(t, n, r) {
			super(t, n), this.innerChanges = r;
		}
		flip() {
			return new un(this.modified, this.original, this.innerChanges?.map((t) => t.flip()));
		}
		...
		static fromEdit(t) {
			...
			return t.replacements.map((r, i) => new ki(r.range, n[i]));
		}
		static assertSorted(t) {
			for (let n = 1; n < t.length; n++) {
				const r = t[n - 1], i = t[n];
				if (!(r.originalRange.getEndPosition().isBeforeOrEqual(i.originalRange.getStartPosition()) && r.modifiedRange.getEndPosition().isBeforeOrEqual(i.modifiedRange.getStartPosition()))) throw new oe("Range mappings must be sorted");
			}
		}
		constructor(t, n) {
		...
		flip() {
			return new ki(this.modifiedRange, this.originalRange);
		}
		toTextEdit(t) {
			const n = t.getValueOfRange(this.modifiedRange);
			return new Uc(this.originalRange, n);
		}
	};
	function ks(e, t, n, r = !1) {
		const i = [];
		for (const s of xc(e.map((a) => Dc(a, t, n)), (a, o) => a.original.intersectsOrTouches(o.original) || a.modified.intersectsOrTouches(o.modified))) {
			const a = s[0], o = s[s.length - 1];
			i.push(new gt(a.original.join(o.original), a.modified.join(o.modified), s.map((l) => l.innerChanges[0])));
		}
		return Rt(() => !r && i.length > 0 && (i[0].modified.startLineNumber !== i[0].original.startLineNumber || n.length.lineCount - i[i.length - 1].modified.endLineNumberExclusive !== t.length.lineCount - i[i.length - 1].original.endLineNumberExclusive) ? !1 : Mi(i, (s, a) => a.original.startLineNumber - s.original.endLineNumberExclusive === a.modified.startLineNumber - s.modified.endLineNumberExclusive && s.original.endLineNumberExclusive < a.original.startLineNumber && s.modified.endLineNumberExclusive < a.modified.startLineNumber)), i;
	}
	function Dc(e, t, n) {
		let r = 0, i = 0;
		return e.modifiedRange.endColumn === 1 && e.originalRange.endColumn === 1 && e.originalRange.startLineNumber + r <= e.originalRange.endLineNumber && e.modifiedRange.startLineNumber + r <= e.modifiedRange.endLineNumber && (i = -1), e.modifiedRange.startColumn - 1 >= n.getLineLength(e.modifiedRange.startLineNumber) && e.originalRange.startColumn - 1 >= t.getLineLength(e.originalRange.startLineNumber) && e.originalRange.startLineNumber <= e.originalRange.endLineNumber + i && e.modifiedRange.startLineNumber <= e.modifiedRange.endLineNumber + i && (r = 1), new gt(new X(e.originalRange.startLineNumber + r, e.originalRange.endLineNumber + 1 + i), new X(e.modifiedRange.startLineNumber + r, e.modifiedRange.endLineNumber + 1 + i), [e]);
	}
	const Wc = 3;
	var Pc = class {
		computeDiff(e, t, n) {
			...
			for (const a of r.changes) {
				let o;
				a.originalEndLineNumber === 0 ? o = new X(a.originalStartLineNumber + 1, a.originalStartLineNumber + 1) : o = new X(a.originalStartLineNumber, a.originalEndLineNumber + 1);
				let l;
				a.modifiedEndLineNumber === 0 ? l = new X(a.modifiedStartLineNumber + 1, a.modifiedStartLineNumber + 1) : l = new X(a.modifiedStartLineNumber, a.modifiedEndLineNumber + 1);
				let c = new gt(o, l, a.charChanges?.map((u) => new Ee(new V(u.originalStartLineNumber, u.originalStartColumn, u.originalEndLineNumber, u.originalEndColumn), new V(u.modifiedStartLineNumber, u.modifiedStartColumn, u.modifiedEndLineNumber, u.modifiedEndColumn))));
				s && (s.modified.endLineNumberExclusive === c.modified.startLineNumber || s.original.endLineNumberExclusive === c.original.startLineNumber) && (c = new gt(s.original.join(c.original), s.modified.join(c.modified), s.innerChanges && c.innerChanges ? s.innerChanges.concat(c.innerChanges) : void 0), i.pop()), i.push(c), s = c;
			}
			return Rt(() => Mi(i, (a, o) => o.original.startLineNumber - a.original.endLineNumberExclusive === o.modified.startLineNumber - a.modified.endLineNumberExclusive && a.original.endLineNumberExclusive < o.original.startLineNumber && a.modified.endLineNumberExclusive < o.modified.startLineNumber)), new Ot(i, [], r.quitEarly);
		}
	};
	function Ss(e, t, n, r) {
	...
	var Ls = class {
		constructor(e) {
			const t = [], n = [];
			for (let r = 0, i = e.length; r < i; r++) t[r] = $n(e[r], 1), n[r] = Gn(e[r], 1);
		...
		createCharSequence(e, t, n) {
			...
			let a = 0;
			for (let o = t; o <= n; o++) {
				const l = this.lines[o], c = e ? this._startColumns[o] : 1, u = e ? this._endColumns[o] : l.length + 1;
				for (let d = c; d < u; d++) r[a] = l.charCodeAt(d - 1), i[a] = o + 1, s[a] = d, a++;
				!e && o < n && (r[a] = 10, i[a] = o + 1, s[a] = l.length + 1, a++);
			}
			return new qc(r, i, s);
		}
	}, qc = class {
	...
	function Oc(e) {
		...
		for (let r = 1, i = e.length; r < i; r++) {
			...
			Math.min(a, o) < Wc ? (n.originalLength = s.originalStart + s.originalLength - n.originalStart, n.modifiedLength = s.modifiedStart + s.modifiedLength - n.modifiedStart) : (t.push(s), n = s);
		}
		return t;
	}
	var jn = class wo {
		...
		static createFromDiffResult(t, n, r, i, s, a, o) {
			...
			if (n.originalLength === 0 ? (l = r.getStartLineNumber(n.originalStart) - 1, c = 0) : (l = r.getStartLineNumber(n.originalStart), c = r.getEndLineNumber(n.originalStart + n.originalLength - 1)), n.modifiedLength === 0 ? (u = i.getStartLineNumber(n.modifiedStart) - 1, d = 0) : (u = i.getStartLineNumber(n.modifiedStart), d = i.getEndLineNumber(n.modifiedStart + n.modifiedLength - 1)), a && n.originalLength > 0 && n.originalLength < 20 && n.modifiedLength > 0 && n.modifiedLength < 20 && s()) {
				...
				if (p.getElements().length > 0 && b.getElements().length > 0) {
					let g = Ss(p, b, s, !0).changes;
					o && (g = Oc(g)), m = [];
					for (let v = 0, T = g.length; v < T; v++) m.push(jt.createFromDiffChange(g[v], p, b));
				}
			}
			return new wo(l, c, u, d, m);
		}
	}, Fc = class {
		constructor(e, t, n) {
			this.shouldComputeCharChanges = n.shouldComputeCharChanges, this.shouldPostProcessCharChanges = n.shouldPostProcessCharChanges, this.shouldIgnoreTrimWhitespace = n.shouldIgnoreTrimWhitespace, this.shouldMakePrettyDiff = n.shouldMakePrettyDiff, this.originalLines = e, this.modifiedLines = t, this.original = new Ls(e), this.modified = new Ls(t), this.continueLineDiff = xs(n.maxComputationTime), this.continueCharDiff = xs(n.maxComputationTime === 0 ? 0 : Math.min(n.maxComputationTime, 5e3));
		}
		computeDiff() {
			...
			const e = Ss(this.original, this.modified, this.continueLineDiff, this.shouldMakePrettyDiff), t = e.changes, n = e.quitEarly;
			if (this.shouldIgnoreTrimWhitespace) {
				const a = [];
				for (let o = 0, l = t.length; o < l; o++) a.push(jn.createFromDiffResult(this.shouldIgnoreTrimWhitespace, t[o], this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges));
				return {
					quitEarly: n,
					changes: a
				};
			...
			for (let a = -1, o = t.length; a < o; a++) {
				const l = a + 1 < o ? t[a + 1] : null, c = l ? l.originalStart : this.originalLines.length, u = l ? l.modifiedStart : this.modifiedLines.length;
				for (; i < c && s < u;) {
					...
					if (d !== m) {
						...
						{
							let p = Gn(d, 1), b = Gn(m, 1);
							const g = d.length + 1, v = m.length + 1;
							for (; p < g && b < v && d.charCodeAt(p - 1) === d.charCodeAt(b - 1);) p++, b++;
							(p < g || b < v) && this._pushTrimWhitespaceCharChange(r, i + 1, p, g, s + 1, b, v);
						}
					}
					i++, s++;
				}
				l && (r.push(jn.createFromDiffResult(this.shouldIgnoreTrimWhitespace, l, this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges)), i += l.originalLength, s += l.modifiedLength);
			}
			return {
				quitEarly: n,
				changes: r
		...
		_pushTrimWhitespaceCharChange(e, t, n, r, i, s, a) {
			...
			let o;
			this.shouldComputeCharChanges && (o = [new jt(t, n, t, r, i, s, i, a)]), e.push(new jn(t, t, i, i, o));
		}
		_mergeTrimWhitespaceCharChange(e, t, n, r, i, s, a) {
			const o = e.length;
			if (o === 0) return !1;
			const l = e[o - 1];
			return l.originalEndLineNumber === 0 || l.modifiedEndLineNumber === 0 ? !1 : l.originalEndLineNumber === t && l.modifiedEndLineNumber === i ? (this.shouldComputeCharChanges && l.charChanges && l.charChanges.push(new jt(t, n, t, r, i, s, i, a)), !0) : l.originalEndLineNumber + 1 === t && l.modifiedEndLineNumber + 1 === i ? (l.originalEndLineNumber = t, l.modifiedEndLineNumber = i, this.shouldComputeCharChanges && l.charChanges && l.charChanges.push(new jt(t, n, t, r, i, s, i, a)), !0) : !1;
		}
	};
	function $n(e, t) {
		const n = il(e);
	...
	var nt = class Si {
		static trivial(t, n) {
			return new Si([new de(J.ofLength(t.length), J.ofLength(n.length))], !1);
		}
		static trivialTimedOut(t, n) {
			return new Si([new de(J.ofLength(t.length), J.ofLength(n.length))], !0);
		}
		constructor(t, n) {
		...
		static invert(t, n) {
			const r = [];
			return Ac(t, (i, s) => {
				r.push(ze.fromOffsetPairs(i ? i.getEndExclusives() : Fe.zero, s ? s.getStarts() : new Fe(n, (i ? i.seq2Range.endExclusive - i.seq1Range.endExclusive : 0) + n)));
			}), r;
		}
		static fromOffsetPairs(t, n) {
			return new ze(new J(t.offset1, n.offset1), new J(t.offset2, n.offset2));
		}
		static assertSorted(t) {
			let n;
			for (const r of t) {
				if (n && !(n.seq1Range.endExclusive <= r.seq1Range.start && n.seq2Range.endExclusive <= r.seq2Range.start)) throw new oe("Sequence diffs must be sorted");
				n = r;
			}
		}
		constructor(t, n) {
		...
		swap() {
			return new ze(this.seq2Range, this.seq1Range);
		}
		toString() {
			return `${this.seq1Range} <-> ${this.seq2Range}`;
		}
		join(t) {
			return new ze(this.seq1Range.join(t.seq1Range), this.seq2Range.join(t.seq2Range));
		}
		delta(t) {
			return t === 0 ? this : new ze(this.seq1Range.delta(t), this.seq2Range.delta(t));
		}
		deltaStart(t) {
			return t === 0 ? this : new ze(this.seq1Range.deltaStart(t), this.seq2Range.deltaStart(t));
		}
		deltaEnd(t) {
			return t === 0 ? this : new ze(this.seq1Range.deltaEnd(t), this.seq2Range.deltaEnd(t));
		}
		intersect(t) {
			const n = this.seq1Range.intersect(t.seq1Range), r = this.seq2Range.intersect(t.seq2Range);
			if (!(!n || !r)) return new ze(n, r);
		}
		getStarts() {
		...
		static {
			this.zero = new dn(0, 0);
		}
		static {
			this.max = new dn(Number.MAX_SAFE_INTEGER, Number.MAX_SAFE_INTEGER);
		}
		constructor(t, n) {
		...
		delta(t) {
			return t === 0 ? this : new dn(this.offset1 + t, this.offset2 + t);
		}
		equals(t) {
		...
		constructor(e) {
			if (this.timeout = e, this.startTime = Date.now(), this.valid = !0, e <= 0) throw new oe("timeout must be positive");
		}
		isValid() {
...
`);
		...
		compute(e, t, n = Xn.instance, r) {
			if (e.length === 0 || t.length === 0) return nt.trivial(e, t);
			const i = new Yn(e.length, t.length), s = new Yn(e.length, t.length), a = new Yn(e.length, t.length);
			for (let p = 0; p < e.length; p++) for (let b = 0; b < t.length; b++) {
				if (!n.isValid()) return nt.trivialTimedOut(e, t);
				const g = p === 0 ? 0 : i.get(p - 1, b), v = b === 0 ? 0 : i.get(p, b - 1);
				let T;
				e.getElement(p) === t.getElement(b) ? (p === 0 || b === 0 ? T = 0 : T = i.get(p - 1, b - 1), p > 0 && b > 0 && s.get(p - 1, b - 1) === 3 && (T += a.get(p - 1, b - 1)), T += r ? r(p, b) : 1) : T = -1;
				const k = Math.max(g, v, T);
				if (k === T) {
					const E = p > 0 && b > 0 ? a.get(p - 1, b - 1) : 0;
					a.set(p, b, E + 1), s.set(p, b, 3);
				} else k === g ? (a.set(p, b, 0), s.set(p, b, 1)) : k === v && (a.set(p, b, 0), s.set(p, b, 2));
				i.set(p, b, k);
			}
			const o = [];
			let l = e.length, c = t.length;
			function u(p, b) {
				(p + 1 !== l || b + 1 !== c) && o.push(new de(new J(p + 1, l), new J(b + 1, c))), l = p, c = b;
			}
			let d = e.length - 1, m = t.length - 1;
			for (; d >= 0 && m >= 0;) s.get(d, m) === 3 ? (u(d, m), d--, m--) : s.get(d, m) === 1 ? d-- : m--;
			return u(-1, -1), o.reverse(), new nt(o, !1);
		}
	}, Rs = class {
		compute(e, t, n = Xn.instance) {
			...
			const r = e, i = t;
			function s(b, g) {
				for (; b < r.length && g < i.length && r.getElement(b) === i.getElement(g);) b++, g++;
				return b;
			}
			let a = 0;
			const o = new jc();
			o.set(0, s(0, 0));
			const l = new $c();
			l.set(0, o.get(0) === 0 ? null : new Ms(null, 0, 0, o.get(0)));
			let c = 0;
			e: for (;;) {
				if (a++, !n.isValid()) return nt.trivialTimedOut(r, i);
				const b = -Math.min(a, i.length + a % 2), g = Math.min(a, r.length + a % 2);
				for (c = b; c <= g; c += 2) {
					const v = c === g ? -1 : o.get(c + 1), T = c === b ? -1 : o.get(c - 1) + 1, k = Math.min(Math.max(v, T), r.length), E = k - c;
					if (k > r.length || E > i.length) continue;
					const I = s(k, E);
					o.set(c, I);
					const D = k === v ? l.get(c + 1) : l.get(c - 1);
					if (l.set(c, I !== k ? new Ms(D, k, E, I - k) : D), o.get(c) === r.length && o.get(c) - c === i.length) break e;
				}
			}
			let u = l.get(c);
			const d = [];
			...
			for (;;) {
				const b = u ? u.x + u.length : 0, g = u ? u.y + u.length : 0;
				if ((b !== m || g !== p) && d.push(new de(new J(b, m), new J(g, p))), !u) break;
				m = u.x, p = u.y, u = u.prev;
			}
			return d.reverse(), new nt(d, !1);
		}
	}, Ms = class {
		constructor(e, t, n, r) {
		...
		constructor(e, t, n) {
			...
			for (let r = this.range.startLineNumber; r <= this.range.endLineNumber; r++) {
				...
				if (!n) {
					const l = i.trimStart();
					a = i.length - l.length, i = l.trimEnd();
				}
		...
		getBoundaryScore(e) {
			const t = Cs(e > 0 ? this.elements[e - 1] : -1), n = Cs(e < this.elements.length ? this.elements[e] : -1);
			if (t === 7 && n === 8) return 0;
			if (t === 8) return 150;
			let r = 0;
			return t !== n && (r += 10, t === 0 && n === 1 && (r += 1)), r += Ns(t), r += Ns(n), r;
		}
		translateOffset(e, t = "right") {
			const n = Ke(this.firstElementOffsetByLineIdx, (i) => i <= e), r = e - this.firstElementOffsetByLineIdx[n];
		...
		findWordContaining(e) {
			if (e < 0 || e >= this.elements.length || !it(this.elements[e])) return;
			let t = e;
			for (; t > 0 && it(this.elements[t - 1]);) t--;
			let n = e;
			for (; n < this.elements.length && it(this.elements[n]);) n++;
			return new J(t, n);
		}
		findSubWordContaining(e) {
			if (e < 0 || e >= this.elements.length || !it(this.elements[e])) return;
			let t = e;
			for (; t > 0 && it(this.elements[t - 1]) && !Es(this.elements[t]);) t--;
			let n = e;
			for (; n < this.elements.length && it(this.elements[n]) && !Es(this.elements[n]);) n++;
			return new J(t, n);
		}
		countLinesIn(e) {
		...
		extendToFullLines(e) {
			return new J(Ze(this.firstElementOffsetByLineIdx, (t) => t <= e.start) ?? 0, Nc(this.firstElementOffsetByLineIdx, (t) => e.endExclusive <= t) ?? this.elements.length);
		}
	};
	function it(e) {
	...
	function Xc(e, t, n, r, i, s) {
		let { moves: a, excludedChanges: o } = Jc(e, t, n, s);
		if (!s.isValid()) return [];
		const l = Qc(e.filter((c) => !o.has(c)), r, i, t, n, s);
		return Mc(a, l), a = Zc(a), a = a.filter((c) => {
			const u = c.original.toOffsetRange().slice(t).map((d) => d.trim());
			return u.join(`
`).length >= 15 && Yc(u, (d) => d.length >= 2) >= 2;
		}), a = Kc(e, a), a;
	}
	function Yc(e, t) {
		let n = 0;
	...
	function Jc(e, t, n, r) {
		const i = [], s = e.filter((l) => l.modified.isEmpty && l.original.length >= 3).map((l) => new As(l.original, t, l)), a = new Set(e.filter((l) => l.original.isEmpty && l.modified.length >= 3).map((l) => new As(l.modified, n, l))), o = /* @__PURE__ */ new Set();
		for (const l of s) {
			let c = -1, u;
			for (const d of a) {
			...
			if (c > .9 && u && (a.delete(u), i.push(new et(l.range, u.range)), o.add(l.source), o.add(u.source)), !r.isValid()) return {
				moves: i,
				excludedChanges: o
			};
		}
	...
	function Qc(e, t, n, r, i, s) {
		...
		for (const m of e) for (let p = m.original.startLineNumber; p < m.original.endLineNumberExclusive - 2; p++) {
			...
			o.add(b, { range: new X(p, p + 3) });
		}
		const l = [];
		e.sort(ft((m) => m.modified.startLineNumber, pt));
		for (const m of e) {
			let p = [];
			for (let b = m.modified.startLineNumber; b < m.modified.endLineNumberExclusive - 2; b++) {
				const g = `${n[b - 1]}:${n[b + 1 - 1]}:${n[b + 2 - 1]}`, v = new X(b, b + 3), T = [];
				o.forEach(g, ({ range: k }) => {
					for (const I of p) if (I.originalLineRange.endLineNumberExclusive + 1 === k.endLineNumberExclusive && I.modifiedLineRange.endLineNumberExclusive + 1 === v.endLineNumberExclusive) {
						I.originalLineRange = new X(I.originalLineRange.startLineNumber, k.endLineNumberExclusive), I.modifiedLineRange = new X(I.modifiedLineRange.startLineNumber, v.endLineNumberExclusive), T.push(I);
						return;
					}
					const E = {
						modifiedLineRange: v,
		...
		l.sort(Ec(ft((m) => m.modifiedLineRange.length, pt)));
		const c = new Ft(), u = new Ft();
		for (const m of l) {
			const p = m.modifiedLineRange.startLineNumber - m.originalLineRange.startLineNumber, b = c.subtractFrom(m.modifiedLineRange), g = u.subtractFrom(m.originalLineRange).getWithDelta(p), v = b.getIntersection(g);
			for (const T of v.ranges) {
				if (T.length < 3) continue;
				const k = T, E = T.delta(-p);
				a.push(new et(E, k)), c.addRange(k), u.addRange(E);
			}
		}
		a.sort(ft((m) => m.original.startLineNumber, pt));
		const d = new ys(e);
		for (let m = 0; m < a.length; m++) {
			const p = a[m], b = d.findLastMonotonous((w) => w.original.startLineNumber <= p.original.startLineNumber), g = Ze(e, (w) => w.modified.startLineNumber <= p.modified.startLineNumber), v = Math.max(p.original.startLineNumber - b.original.startLineNumber, p.modified.startLineNumber - g.modified.startLineNumber), T = d.findLastMonotonous((w) => w.original.startLineNumber < p.original.endLineNumberExclusive), k = Ze(e, (w) => w.modified.startLineNumber < p.modified.endLineNumberExclusive), E = Math.max(T.original.endLineNumberExclusive - p.original.endLineNumberExclusive, k.modified.endLineNumberExclusive - p.modified.endLineNumberExclusive);
			let I;
			for (I = 0; I < v; I++) {
				const w = p.original.startLineNumber - I - 1, f = p.modified.startLineNumber - I - 1;
				if (w > r.length || f > i.length || c.contains(f) || u.contains(w) || !Is(r[w - 1], i[f - 1], s)) break;
			}
			I > 0 && (u.addRange(new X(p.original.startLineNumber - I, p.original.startLineNumber)), c.addRange(new X(p.modified.startLineNumber - I, p.modified.startLineNumber)));
			let D;
			for (D = 0; D < E; D++) {
				const w = p.original.endLineNumberExclusive + D, f = p.modified.endLineNumberExclusive + D;
				if (w > r.length || f > i.length || c.contains(f) || u.contains(w) || !Is(r[w - 1], i[f - 1], s)) break;
			}
			D > 0 && (u.addRange(new X(p.original.endLineNumberExclusive, p.original.endLineNumberExclusive + D)), c.addRange(new X(p.modified.endLineNumberExclusive, p.modified.endLineNumberExclusive + D))), (I > 0 || D > 0) && (a[m] = new et(new X(p.original.startLineNumber - I, p.original.endLineNumberExclusive + D), new X(p.modified.startLineNumber - I, p.modified.endLineNumberExclusive + D)));
		}
		return a;
	}
	function Is(e, t, n) {
		...
		const r = new Rs().compute(new $t([e], new V(1, 1, 1, e.length), !1), new $t([t], new V(1, 1, 1, t.length), !1), n);
		let i = 0;
		const s = de.invert(r.diffs, e.length);
		for (const l of s) l.seq1Range.forEach((c) => {
			Jn(e.charCodeAt(c)) || i++;
		});
		function a(l) {
			let c = 0;
			for (let u = 0; u < e.length; u++) Jn(l.charCodeAt(u)) || c++;
			return c;
		}
	...
	function Zc(e) {
		...
		e.sort(ft((n) => n.original.startLineNumber, pt));
		const t = [e[0]];
	...
	function Kc(e, t) {
		const n = new ys(e);
		return t = t.filter((r) => (n.findLastMonotonous((i) => i.original.startLineNumber < r.original.endLineNumberExclusive) || new et(new X(1, 1), new X(1, 1))) !== Ze(e, (i) => i.modified.startLineNumber < r.modified.endLineNumberExclusive)), t;
	}
	function zs(e, t, n) {
		let r = n;
		return r = Hs(e, t, r), r = Hs(e, t, r), r = eh(e, t, r), r;
	}
	function Hs(e, t, n) {
		...
		for (let s = 1; s < n.length; s++) {
			...
			if (o.seq1Range.isEmpty || o.seq2Range.isEmpty) {
				...
				let c;
				for (c = 1; c <= l && !(e.getElement(o.seq1Range.start - c) !== e.getElement(o.seq1Range.endExclusive - c) || t.getElement(o.seq2Range.start - c) !== t.getElement(o.seq2Range.endExclusive - c)); c++);
				if (c--, c === l) {
					r[r.length - 1] = new de(new J(a.seq1Range.start, o.seq1Range.endExclusive - l), new J(a.seq2Range.start, o.seq2Range.endExclusive - l));
					continue;
				}
				o = o.delta(-c);
			}
		...
		for (let s = 0; s < r.length - 1; s++) {
			...
			if (o.seq1Range.isEmpty || o.seq2Range.isEmpty) {
				...
				let c;
				for (c = 0; c < l && !(!e.isStronglyEqual(o.seq1Range.start + c, o.seq1Range.endExclusive + c) || !t.isStronglyEqual(o.seq2Range.start + c, o.seq2Range.endExclusive + c)); c++);
				if (c === l) {
					r[s + 1] = new de(new J(o.seq1Range.start + l, a.seq1Range.endExclusive), new J(o.seq2Range.start + l, a.seq2Range.endExclusive));
					continue;
				}
				c > 0 && (o = o.delta(c));
			}
	...
	function eh(e, t, n) {
		...
		for (let r = 0; r < n.length; r++) {
			const i = r > 0 ? n[r - 1] : void 0, s = n[r], a = r + 1 < n.length ? n[r + 1] : void 0, o = new J(i ? i.seq1Range.endExclusive + 1 : 0, a ? a.seq1Range.start - 1 : e.length), l = new J(i ? i.seq2Range.endExclusive + 1 : 0, a ? a.seq2Range.start - 1 : t.length);
			s.seq1Range.isEmpty ? n[r] = Us(s, e, t, o, l) : s.seq2Range.isEmpty && (n[r] = Us(s.swap(), t, e, l, o).swap());
		}
		return n;
	}
	...
	function th(e, t, n) {
		...
		for (const i of n) {
			...
			i.seq1Range.start - s.seq1Range.endExclusive <= 2 || i.seq2Range.start - s.seq2Range.endExclusive <= 2 ? r[r.length - 1] = new de(s.seq1Range.join(i.seq1Range), s.seq2Range.join(i.seq2Range)) : r.push(i);
		}
		return r;
	}
	function Ds(e, t, n, r, i = !1) {
		const s = de.invert(n, e.length), a = [];
		let o = new Fe(0, 0);
		function l(c, u) {
			if (c.offset1 < o.offset1 || c.offset2 < o.offset2) return;
			const d = r(e, c.offset1), m = r(t, c.offset2);
			if (!d || !m) return;
			let p = new de(d, m);
			const b = p.intersect(u);
			let g = b.seq1Range.length, v = b.seq2Range.length;
			for (; s.length > 0;) {
				const T = s[0];
				if (!(T.seq1Range.intersects(p.seq1Range) || T.seq2Range.intersects(p.seq2Range))) break;
				const k = new de(r(e, T.seq1Range.start), r(t, T.seq2Range.start)), E = k.intersect(T);
				if (g += E.seq1Range.length, v += E.seq2Range.length, p = p.join(k), p.seq1Range.endExclusive >= T.seq1Range.endExclusive) s.shift();
				else break;
			}
			(i && g + v < p.seq1Range.length + p.seq2Range.length || g + v < (p.seq1Range.length + p.seq2Range.length) * 2 / 3) && a.push(p), o = p.getEndExclusives();
		}
		for (; s.length > 0;) {
			const c = s.shift();
			c.seq1Range.isEmpty || (l(c.getStarts(), c), l(c.getEndExclusives().delta(-1), c));
		}
		return nh(n, a);
	}
	function nh(e, t) {
	...
	function ih(e, t, n) {
		...
		do {
			...
			for (let l = 1; l < r.length; l++) {
				let d = function(m, p) {
					const b = new J(u.seq1Range.endExclusive, c.seq1Range.start);
					return e.getText(b).replace(/\s/g, "").length <= 4 && (m.seq1Range.length + m.seq2Range.length > 5 || p.seq1Range.length + p.seq2Range.length > 5);
				};
				const c = r[l], u = o[o.length - 1];
				d(u, c) ? (s = !0, o[o.length - 1] = o[o.length - 1].join(c)) : o.push(c);
			}
			r = o;
		} while (i++ < 10 && s);
		return r;
	...
	function rh(e, t, n) {
		...
		do {
			...
			for (let c = 1; c < r.length; c++) {
				let m = function(p, b) {
					const g = new J(d.seq1Range.endExclusive, u.seq1Range.start);
					if (e.countLinesIn(g) > 5 || g.length > 500) return !1;
					const v = e.getText(g).trim();
					if (v.length > 20 || v.split(/\r\n|\r|\n/).length > 1) return !1;
					const T = e.countLinesIn(p.seq1Range), k = p.seq1Range.length, E = t.countLinesIn(p.seq2Range), I = p.seq2Range.length, D = e.countLinesIn(b.seq1Range), w = b.seq1Range.length, f = t.countLinesIn(b.seq2Range), _ = b.seq2Range.length, C = 130;
					function z(L) {
						return Math.min(L, C);
					}
					return Math.pow(Math.pow(z(T * 40 + k), 1.5) + Math.pow(z(E * 40 + I), 1.5), 1.5) + Math.pow(Math.pow(z(D * 40 + w), 1.5) + Math.pow(z(f * 40 + _), 1.5), 1.5) > (C ** 1.5) ** 1.5 * 1.3;
				};
		...
		return Rc(r, (l, c, u) => {
			...
			const p = e.extendToFullLines(c.seq1Range), b = e.getText(new J(p.start, c.seq1Range.start));
			m(b) && (d = d.deltaStart(-b.length));
			const g = e.getText(new J(c.seq1Range.endExclusive, p.endExclusive));
			m(g) && (d = d.deltaEnd(g.length));
			const v = de.fromOffsetPairs(l ? l.getEndExclusives() : Fe.zero, u ? u.getStarts() : Fe.max), T = d.intersect(v);
			a.length > 0 && T.getStarts().equals(a[a.length - 1].getEndExclusives()) ? a[a.length - 1] = a[a.length - 1].join(T) : a.push(T);
		}), a;
	}
	var Ws = class {
		constructor(e, t) {
		...
		getBoundaryScore(e) {
			return 1e3 - ((e === 0 ? 0 : Ps(this.lines[e - 1])) + (e === this.lines.length ? 0 : Ps(this.lines[e])));
		}
		getText(e) {
...
`);
	...
	var sh = class {
		constructor() {
			this.dynamicProgrammingDiffing = new Vc(), this.myersDiffingAlgorithm = new Rs();
		}
		computeDiff(e, t, n) {
			if (e.length <= 1 && Lc(e, t, (I, D) => I === D)) return new Ot([], [], !1);
			if (e.length === 1 && e[0].length === 0 || t.length === 1 && t[0].length === 0) return new Ot([new gt(new X(1, e.length + 1), new X(1, t.length + 1), [new Ee(new V(1, 1, e.length, e[e.length - 1].length + 1), new V(1, 1, t.length, t[t.length - 1].length + 1))])], [], !1);
			const r = n.maxComputationTimeMs === 0 ? Xn.instance : new Bc(n.maxComputationTimeMs), i = !n.ignoreTrimWhitespace, s = /* @__PURE__ */ new Map();
			function a(I) {
				let D = s.get(I);
				return D === void 0 && (D = s.size, s.set(I, D)), D;
			}
			const o = e.map((I) => a(I.trim())), l = t.map((I) => a(I.trim())), c = new Ws(o, e), u = new Ws(l, t), d = c.length + u.length < 1700 ? this.dynamicProgrammingDiffing.compute(c, u, r, (I, D) => e[I] === t[D] ? t[D].length === 0 ? .1 : 1 + Math.log(1 + t[D].length) : .99) : this.myersDiffingAlgorithm.compute(c, u, r);
			let m = d.diffs, p = d.hitTimeout;
			m = zs(c, u, m), m = ih(c, u, m);
			const b = [], g = (I) => {
				if (i) for (let D = 0; D < I; D++) {
					const w = v + D, f = T + D;
					if (e[w] !== t[f]) {
						const _ = this.refineDiff(e, t, new de(new J(w, w + 1), new J(f, f + 1)), r, i, n);
						for (const C of _.mappings) b.push(C);
						_.hitTimeout && (p = !0);
					}
				}
			};
			let v = 0, T = 0;
			for (const I of m) {
				Rt(() => I.seq1Range.start - v === I.seq2Range.start - T), g(I.seq1Range.start - v), v = I.seq1Range.endExclusive, T = I.seq2Range.endExclusive;
				const D = this.refineDiff(e, t, I, r, i, n);
				D.hitTimeout && (p = !0);
				for (const w of D.mappings) b.push(w);
			}
			g(e.length - v);
			const k = ks(b, new Vt(e), new Vt(t));
			let E = [];
			return n.computeMoves && (E = this.computeMoves(k, e, t, o, l, r, i, n)), Rt(() => {
				function I(w, f) {
					if (w.lineNumber < 1 || w.lineNumber > f.length) return !1;
					const _ = f[w.lineNumber - 1];
					return !(w.column < 1 || w.column > _.length + 1);
				}
				function D(w, f) {
					return !(w.startLineNumber < 1 || w.startLineNumber > f.length + 1 || w.endLineNumberExclusive < 1 || w.endLineNumberExclusive > f.length + 1);
				}
				for (const w of k) {
					if (!w.innerChanges) return !1;
					for (const f of w.innerChanges) if (!(I(f.modifiedRange.getStartPosition(), t) && I(f.modifiedRange.getEndPosition(), t) && I(f.originalRange.getStartPosition(), e) && I(f.originalRange.getEndPosition(), e))) return !1;
					if (!D(w.modified, t) || !D(w.original, e)) return !1;
				}
				return !0;
			}), new Ot(k, E, p);
		}
		computeMoves(e, t, n, r, i, s, a, o) {
			return Xc(e, t, n, r, i, s).map((l) => new Sc(l, ks(this.refineDiff(t, n, new de(l.original.toOffsetRange(), l.modified.toOffsetRange()), s, a, o).mappings, new Vt(t), new Vt(n), !0)));
		}
		refineDiff(e, t, n, r, i, s) {
			const a = ah(n).toRangeMapping2(e, t), o = new $t(e, a.originalRange, i), l = new $t(t, a.modifiedRange, i), c = o.length + l.length < 500 ? this.dynamicProgrammingDiffing.compute(o, l, r) : this.myersDiffingAlgorithm.compute(o, l, r);
			let u = c.diffs;
			return u = zs(o, l, u), u = Ds(o, l, u, (d, m) => d.findWordContaining(m)), s.extendToSubwords && (u = Ds(o, l, u, (d, m) => d.findSubWordContaining(m), !0)), u = th(o, l, u), u = rh(o, l, u), {
				mappings: u.map((d) => new Ee(o.translateRange(d.seq1Range), l.translateRange(d.seq2Range))),
				hitTimeout: c.hitTimeout
			};
		}
	};
	function ah(e) {
		return new et(new X(e.seq1Range.start + 1, e.seq1Range.endExclusive + 1), new X(e.seq2Range.start + 1, e.seq2Range.endExclusive + 1));
	}
	const qs = {
		getLegacy: () => new Pc(),
		getDefault: () => new sh()
	...
	var x = class {
		constructor(e, t, n, r = 1) {
			this._rgbaBrand = void 0, this.r = Math.min(255, Math.max(0, e)) | 0, this.g = Math.min(255, Math.max(0, t)) | 0, this.b = Math.min(255, Math.max(0, n)) | 0, this.a = De(Math.max(Math.min(1, r), 0), 3);
		}
		static equals(e, t) {
		...
		constructor(t, n, r, i) {
			this._hslaBrand = void 0, this.h = Math.max(Math.min(360, t), 0) | 0, this.s = De(Math.max(Math.min(1, n), 0), 3), this.l = De(Math.max(Math.min(1, r), 0), 3), this.a = De(Math.max(Math.min(1, i), 0), 3);
		}
		static equals(t, n) {
		...
		static fromRGBA(t) {
			...
			const u = (o + a) / 2, d = a - o;
			if (d > 0) {
				switch (c = Math.min(u <= .5 ? d / (2 * u) : d / (2 - 2 * u), 1), a) {
					case n:
						l = (r - i) / d + (r < i ? 6 : 0);
						break;
					case r:
		...
		static toRGBA(t) {
			...
			if (r === 0) a = o = l = i;
				...
				a = xt._hue2rgb(u, c, n + 1 / 3), o = xt._hue2rgb(u, c, n), l = xt._hue2rgb(u, c, n - 1 / 3);
			}
			return new x(Math.round(a * 255), Math.round(o * 255), Math.round(l * 255), s);
		}
	}, Gt = class vo {
		constructor(t, n, r, i) {
			this._hsvaBrand = void 0, this.h = Math.max(Math.min(360, t), 0) | 0, this.s = De(Math.max(Math.min(1, n), 0), 3), this.v = De(Math.max(Math.min(1, r), 0), 3), this.a = De(Math.max(Math.min(1, i), 0), 3);
		}
		static equals(t, n) {
		...
		static fromRGBA(t) {
			...
			let l;
			return a === 0 ? l = 0 : s === n ? l = ((r - i) / a % 6 + 6) % 6 : s === r ? l = (i - n) / a + 2 : l = (n - r) / a + 4, new vo(Math.round(l * 60), o, s, t.a);
		}
		static toRGBA(t) {
			...
			return n < 60 ? (c = a, u = o) : n < 120 ? (c = o, u = a) : n < 180 ? (u = a, d = o) : n < 240 ? (u = o, d = a) : n < 300 ? (c = o, d = a) : n <= 360 && (c = a, d = o), c = Math.round((c + l) * 255), u = Math.round((u + l) * 255), d = Math.round((d + l) * 255), new x(c, u, d, s);
		}
	}, Xt = class ne {
		static fromHex(t) {
		...
		constructor(t) {
			if (t) if (t instanceof x) this.rgba = t;
			else if (t instanceof Be) this._hsla = t, this.rgba = Be.toRGBA(t);
			else if (t instanceof Gt) this._hsva = t, this.rgba = Gt.toRGBA(t);
			else throw new Error("Invalid color ctor argument");
			else throw new Error("Color needs a value");
		}
		equals(t) {
			return !!t && x.equals(this.rgba, t.rgba) && Be.equals(this.hsla, t.hsla) && Gt.equals(this.hsva, t.hsva);
		}
		getRelativeLuminance() {
			...
			return De(.2126 * t + .7152 * n + .0722 * r, 4);
		}
		...
		lighten(t) {
			return new ne(new Be(this.hsla.h, this.hsla.s, this.hsla.l + this.hsla.l * t, this.hsla.a));
		}
		darken(t) {
			return new ne(new Be(this.hsla.h, this.hsla.s, this.hsla.l - this.hsla.l * t, this.hsla.a));
		}
		...
		opposite() {
			return new ne(new x(255 - this.rgba.r, 255 - this.rgba.g, 255 - this.rgba.b, this.rgba.a));
		}
		mix(t, n = .5) {
			const r = Math.min(Math.max(n, 0), 1), i = this.rgba, s = t.rgba;
			return new ne(new x(i.r + (s.r - i.r) * r, i.g + (s.g - i.g) * r, i.b + (s.b - i.b) * r, i.a + (s.a - i.a) * r));
		}
		makeOpaque(t) {
			if (this.isOpaque() || t.rgba.a !== 1) return this;
			const { r: n, g: r, b: i, a: s } = this.rgba;
			return new ne(new x(t.rgba.r - s * (t.rgba.r - n), t.rgba.g - s * (t.rgba.g - r), t.rgba.b - s * (t.rgba.b - i), 1));
		}
		toString() {
		...
		static {
			this.white = new ne(new x(255, 255, 255, 1));
		}
		static {
			this.black = new ne(new x(0, 0, 0, 1));
		}
		static {
			this.red = new ne(new x(255, 0, 0, 1));
		}
		static {
			this.blue = new ne(new x(0, 0, 255, 1));
		}
		static {
			this.green = new ne(new x(0, 255, 0, 1));
		}
		static {
			this.cyan = new ne(new x(0, 255, 255, 1));
		}
		static {
			this.lightgrey = new ne(new x(211, 211, 211, 1));
		}
		static {
			this.transparent = new ne(new x(0, 0, 0, 0));
		}
	};
	(function(e) {
		(function(t) {
			(function(n) {
				...
				n.formatRGBA = i;
				function s(g) {
					return g.hsla.a === 1 ? `hsl(${g.hsla.h}, ${Math.round(g.hsla.s * 100)}%, ${Math.round(g.hsla.l * 100)}%)` : e.Format.CSS.formatHSLA(g);
				}
				n.formatHSL = s;
				function a(g) {
				...
				n.formatHex = l;
				function c(g, v = !1) {
					return v && g.rgba.a === 1 ? e.Format.CSS.formatHex(g) : `#${o(g.rgba.r)}${o(g.rgba.g)}${o(g.rgba.b)}${o(Math.round(g.rgba.a * 255))}`;
				}
				n.formatHexA = c;
				function u(g) {
				...
				n.format = u;
				function d(g) {
					if (g === "transparent") return e.transparent;
					if (g.startsWith("#")) return p(g);
					if (g.startsWith("rgba(")) {
						const v = g.match(/rgba\((?<r>(?:\+|-)?\d+), *(?<g>(?:\+|-)?\d+), *(?<b>(?:\+|-)?\d+), *(?<a>(?:\+|-)?\d+(\.\d+)?)\)/);
						if (!v) throw new Error("Invalid color format " + g);
						return new e(new x(parseInt(v.groups?.r ?? "0"), parseInt(v.groups?.g ?? "0"), parseInt(v.groups?.b ?? "0"), parseFloat(v.groups?.a ?? "0")));
					}
					if (g.startsWith("rgb(")) {
						const v = g.match(/rgb\((?<r>(?:\+|-)?\d+), *(?<g>(?:\+|-)?\d+), *(?<b>(?:\+|-)?\d+)\)/);
						if (!v) throw new Error("Invalid color format " + g);
						return new e(new x(parseInt(v.groups?.r ?? "0"), parseInt(v.groups?.g ?? "0"), parseInt(v.groups?.b ?? "0")));
					}
					return m(g);
				}
				n.parse = d;
				function m(g) {
					switch (g) {
						case "aliceblue": return new e(new x(240, 248, 255, 1));
						case "antiquewhite": return new e(new x(250, 235, 215, 1));
						case "aqua": return new e(new x(0, 255, 255, 1));
						case "aquamarine": return new e(new x(127, 255, 212, 1));
						case "azure": return new e(new x(240, 255, 255, 1));
						case "beige": return new e(new x(245, 245, 220, 1));
						case "bisque": return new e(new x(255, 228, 196, 1));
						case "black": return new e(new x(0, 0, 0, 1));
						case "blanchedalmond": return new e(new x(255, 235, 205, 1));
						case "blue": return new e(new x(0, 0, 255, 1));
						case "blueviolet": return new e(new x(138, 43, 226, 1));
						case "brown": return new e(new x(165, 42, 42, 1));
						case "burlywood": return new e(new x(222, 184, 135, 1));
						case "cadetblue": return new e(new x(95, 158, 160, 1));
						case "chartreuse": return new e(new x(127, 255, 0, 1));
						case "chocolate": return new e(new x(210, 105, 30, 1));
						case "coral": return new e(new x(255, 127, 80, 1));
						case "cornflowerblue": return new e(new x(100, 149, 237, 1));
						case "cornsilk": return new e(new x(255, 248, 220, 1));
						case "crimson": return new e(new x(220, 20, 60, 1));
						case "cyan": return new e(new x(0, 255, 255, 1));
						case "darkblue": return new e(new x(0, 0, 139, 1));
						case "darkcyan": return new e(new x(0, 139, 139, 1));
						case "darkgoldenrod": return new e(new x(184, 134, 11, 1));
						case "darkgray": return new e(new x(169, 169, 169, 1));
						case "darkgreen": return new e(new x(0, 100, 0, 1));
						case "darkgrey": return new e(new x(169, 169, 169, 1));
						case "darkkhaki": return new e(new x(189, 183, 107, 1));
						case "darkmagenta": return new e(new x(139, 0, 139, 1));
						case "darkolivegreen": return new e(new x(85, 107, 47, 1));
						case "darkorange": return new e(new x(255, 140, 0, 1));
						case "darkorchid": return new e(new x(153, 50, 204, 1));
						case "darkred": return new e(new x(139, 0, 0, 1));
						case "darksalmon": return new e(new x(233, 150, 122, 1));
						case "darkseagreen": return new e(new x(143, 188, 143, 1));
						case "darkslateblue": return new e(new x(72, 61, 139, 1));
						case "darkslategray": return new e(new x(47, 79, 79, 1));
						case "darkslategrey": return new e(new x(47, 79, 79, 1));
						case "darkturquoise": return new e(new x(0, 206, 209, 1));
						case "darkviolet": return new e(new x(148, 0, 211, 1));
						case "deeppink": return new e(new x(255, 20, 147, 1));
						case "deepskyblue": return new e(new x(0, 191, 255, 1));
						case "dimgray": return new e(new x(105, 105, 105, 1));
						case "dimgrey": return new e(new x(105, 105, 105, 1));
						case "dodgerblue": return new e(new x(30, 144, 255, 1));
						case "firebrick": return new e(new x(178, 34, 34, 1));
						case "floralwhite": return new e(new x(255, 250, 240, 1));
						case "forestgreen": return new e(new x(34, 139, 34, 1));
						case "fuchsia": return new e(new x(255, 0, 255, 1));
						case "gainsboro": return new e(new x(220, 220, 220, 1));
						case "ghostwhite": return new e(new x(248, 248, 255, 1));
						case "gold": return new e(new x(255, 215, 0, 1));
						case "goldenrod": return new e(new x(218, 165, 32, 1));
						case "gray": return new e(new x(128, 128, 128, 1));
						case "green": return new e(new x(0, 128, 0, 1));
						case "greenyellow": return new e(new x(173, 255, 47, 1));
						case "grey": return new e(new x(128, 128, 128, 1));
						case "honeydew": return new e(new x(240, 255, 240, 1));
						case "hotpink": return new e(new x(255, 105, 180, 1));
						case "indianred": return new e(new x(205, 92, 92, 1));
						case "indigo": return new e(new x(75, 0, 130, 1));
						case "ivory": return new e(new x(255, 255, 240, 1));
						case "khaki": return new e(new x(240, 230, 140, 1));
						case "lavender": return new e(new x(230, 230, 250, 1));
						case "lavenderblush": return new e(new x(255, 240, 245, 1));
						case "lawngreen": return new e(new x(124, 252, 0, 1));
						case "lemonchiffon": return new e(new x(255, 250, 205, 1));
						case "lightblue": return new e(new x(173, 216, 230, 1));
						case "lightcoral": return new e(new x(240, 128, 128, 1));
						case "lightcyan": return new e(new x(224, 255, 255, 1));
						case "lightgoldenrodyellow": return new e(new x(250, 250, 210, 1));
						case "lightgray": return new e(new x(211, 211, 211, 1));
						case "lightgreen": return new e(new x(144, 238, 144, 1));
						case "lightgrey": return new e(new x(211, 211, 211, 1));
						case "lightpink": return new e(new x(255, 182, 193, 1));
						case "lightsalmon": return new e(new x(255, 160, 122, 1));
						case "lightseagreen": return new e(new x(32, 178, 170, 1));
						case "lightskyblue": return new e(new x(135, 206, 250, 1));
						case "lightslategray": return new e(new x(119, 136, 153, 1));
						case "lightslategrey": return new e(new x(119, 136, 153, 1));
						case "lightsteelblue": return new e(new x(176, 196, 222, 1));
						case "lightyellow": return new e(new x(255, 255, 224, 1));
						case "lime": return new e(new x(0, 255, 0, 1));
						case "limegreen": return new e(new x(50, 205, 50, 1));
						case "linen": return new e(new x(250, 240, 230, 1));
						case "magenta": return new e(new x(255, 0, 255, 1));
						case "maroon": return new e(new x(128, 0, 0, 1));
						case "mediumaquamarine": return new e(new x(102, 205, 170, 1));
						case "mediumblue": return new e(new x(0, 0, 205, 1));
						case "mediumorchid": return new e(new x(186, 85, 211, 1));
						case "mediumpurple": return new e(new x(147, 112, 219, 1));
						case "mediumseagreen": return new e(new x(60, 179, 113, 1));
						case "mediumslateblue": return new e(new x(123, 104, 238, 1));
						case "mediumspringgreen": return new e(new x(0, 250, 154, 1));
						case "mediumturquoise": return new e(new x(72, 209, 204, 1));
						case "mediumvioletred": return new e(new x(199, 21, 133, 1));
						case "midnightblue": return new e(new x(25, 25, 112, 1));
						case "mintcream": return new e(new x(245, 255, 250, 1));
						case "mistyrose": return new e(new x(255, 228, 225, 1));
						case "moccasin": return new e(new x(255, 228, 181, 1));
						case "navajowhite": return new e(new x(255, 222, 173, 1));
						case "navy": return new e(new x(0, 0, 128, 1));
						case "oldlace": return new e(new x(253, 245, 230, 1));
						case "olive": return new e(new x(128, 128, 0, 1));
						case "olivedrab": return new e(new x(107, 142, 35, 1));
						case "orange": return new e(new x(255, 165, 0, 1));
						case "orangered": return new e(new x(255, 69, 0, 1));
						case "orchid": return new e(new x(218, 112, 214, 1));
						case "palegoldenrod": return new e(new x(238, 232, 170, 1));
						case "palegreen": return new e(new x(152, 251, 152, 1));
						case "paleturquoise": return new e(new x(175, 238, 238, 1));
						case "palevioletred": return new e(new x(219, 112, 147, 1));
						case "papayawhip": return new e(new x(255, 239, 213, 1));
						case "peachpuff": return new e(new x(255, 218, 185, 1));
						case "peru": return new e(new x(205, 133, 63, 1));
						case "pink": return new e(new x(255, 192, 203, 1));
						case "plum": return new e(new x(221, 160, 221, 1));
						case "powderblue": return new e(new x(176, 224, 230, 1));
						case "purple": return new e(new x(128, 0, 128, 1));
						case "rebeccapurple": return new e(new x(102, 51, 153, 1));
						case "red": return new e(new x(255, 0, 0, 1));
						case "rosybrown": return new e(new x(188, 143, 143, 1));
						case "royalblue": return new e(new x(65, 105, 225, 1));
						case "saddlebrown": return new e(new x(139, 69, 19, 1));
						case "salmon": return new e(new x(250, 128, 114, 1));
						case "sandybrown": return new e(new x(244, 164, 96, 1));
						case "seagreen": return new e(new x(46, 139, 87, 1));
						case "seashell": return new e(new x(255, 245, 238, 1));
						case "sienna": return new e(new x(160, 82, 45, 1));
						case "silver": return new e(new x(192, 192, 192, 1));
						case "skyblue": return new e(new x(135, 206, 235, 1));
						case "slateblue": return new e(new x(106, 90, 205, 1));
						case "slategray": return new e(new x(112, 128, 144, 1));
						case "slategrey": return new e(new x(112, 128, 144, 1));
						case "snow": return new e(new x(255, 250, 250, 1));
						case "springgreen": return new e(new x(0, 255, 127, 1));
						case "steelblue": return new e(new x(70, 130, 180, 1));
						case "tan": return new e(new x(210, 180, 140, 1));
						case "teal": return new e(new x(0, 128, 128, 1));
						case "thistle": return new e(new x(216, 191, 216, 1));
						case "tomato": return new e(new x(255, 99, 71, 1));
						case "turquoise": return new e(new x(64, 224, 208, 1));
						case "violet": return new e(new x(238, 130, 238, 1));
						case "wheat": return new e(new x(245, 222, 179, 1));
						case "white": return new e(new x(255, 255, 255, 1));
						case "whitesmoke": return new e(new x(245, 245, 245, 1));
						case "yellow": return new e(new x(255, 255, 0, 1));
						case "yellowgreen": return new e(new x(154, 205, 50, 1));
						default: return null;
					}
				}
				function p(g) {
					const v = g.length;
					if (v === 0 || g.charCodeAt(0) !== 35) return null;
					if (v === 7) return new e(new x(16 * b(g.charCodeAt(1)) + b(g.charCodeAt(2)), 16 * b(g.charCodeAt(3)) + b(g.charCodeAt(4)), 16 * b(g.charCodeAt(5)) + b(g.charCodeAt(6)), 1));
					if (v === 9) return new e(new x(16 * b(g.charCodeAt(1)) + b(g.charCodeAt(2)), 16 * b(g.charCodeAt(3)) + b(g.charCodeAt(4)), 16 * b(g.charCodeAt(5)) + b(g.charCodeAt(6)), (16 * b(g.charCodeAt(7)) + b(g.charCodeAt(8))) / 255));
					if (v === 4) {
						const T = b(g.charCodeAt(1)), k = b(g.charCodeAt(2)), E = b(g.charCodeAt(3));
						return new e(new x(16 * T + T, 16 * k + k, 16 * E + E));
					}
					if (v === 5) {
						const T = b(g.charCodeAt(1)), k = b(g.charCodeAt(2)), E = b(g.charCodeAt(3)), I = b(g.charCodeAt(4));
						return new e(new x(16 * T + T, 16 * k + k, 16 * E + E, (16 * I + I) / 255));
					}
					return null;
				}
				n.parseHex = p;
	...
	function oh(e, t) {
		if (!e) return;
		const n = Xt.Format.CSS.parseHex(t);
		if (n) return {
			range: e,
	...
	function Fs(e, t, n) {
		...
		const r = Os(t[0].values());
		return {
			range: e,
			color: Qn(r[0], r[1], r[2], n ? r[3] : 1)
		};
	}
	function Bs(e, t, n) {
		if (!e || t.length !== 1) return;
		const r = Os(t[0].values()), i = new Xt(new Be(r[0], r[1] / 100, r[2] / 100, n ? r[3] : 1));
		return {
			range: e,
			color: Qn(i.rgba.r, i.rgba.g, i.rgba.b, i.rgba.a)
		};
	}
	function wt(e, t) {
	...
	function lh(e) {
		const t = [], n = wt(e, /\b(rgb|rgba|hsl|hsla)(\([0-9\s,.\%]*\))|^(#)([A-Fa-f0-9]{3})\b|^(#)([A-Fa-f0-9]{4})\b|^(#)([A-Fa-f0-9]{6})\b|^(#)([A-Fa-f0-9]{8})\b|(?<=['"\s])(#)([A-Fa-f0-9]{3})\b|(?<=['"\s])(#)([A-Fa-f0-9]{4})\b|(?<=['"\s])(#)([A-Fa-f0-9]{6})\b|(?<=['"\s])(#)([A-Fa-f0-9]{8})\b/gm);
		if (n.length > 0) for (const r of n) {
			const i = r.filter((l) => l !== void 0), s = i[1], a = i[2];
			if (!a) continue;
			let o;
			s === "rgb" ? o = Fs(bt(e, r), wt(a, /^\(\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*,\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*,\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*\)$/gm), !1) : s === "rgba" ? o = Fs(bt(e, r), wt(a, /^\(\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*,\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*,\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*,\s*(0[.][0-9]+|[.][0-9]+|[01][.]|[01])\s*\)$/gm), !0) : s === "hsl" ? o = Bs(bt(e, r), wt(a, /^\(\s*((?:360(?:\.0+)?|(?:36[0]|3[0-5][0-9]|[12][0-9][0-9]|[1-9]?[0-9])(?:\.\d+)?))\s*[\s,]\s*(100|\d{1,2}[.]\d*|\d{1,2})%\s*[\s,]\s*(100|\d{1,2}[.]\d*|\d{1,2})%\s*\)$/gm), !1) : s === "hsla" ? o = Bs(bt(e, r), wt(a, /^\(\s*((?:360(?:\.0+)?|(?:36[0]|3[0-5][0-9]|[12][0-9][0-9]|[1-9]?[0-9])(?:\.\d+)?))\s*[\s,]\s*(100|\d{1,2}[.]\d*|\d{1,2})%\s*[\s,]\s*(100|\d{1,2}[.]\d*|\d{1,2})%\s*[\s,]\s*(0[.][0-9]+|[.][0-9]+|[01][.]0*|[01])\s*\)$/gm), !0) : s === "#" && (o = oh(bt(e, r), s + a)), o && t.push(o);
		}
		return t;
	}
	function ch(e) {
	...
	function fh(e, t) {
		...
		const i = fc(t.markSectionHeaderRegex), s = new RegExp(t.markSectionHeaderRegex, `gdm${i ? "s" : ""}`);
		if (tl(s)) return n;
		for (let a = 1; a <= r; a += Vs - uh) {
			const o = Math.min(a + Vs - 1, r), l = [];
			for (let d = a; d <= o; d++) l.push(e.getLineContent(d));
			const c = l.join(`
`);
			s.lastIndex = 0;
			let u;
			for (; (u = s.exec(c)) !== null;) {
				const d = c.substring(0, u.index), m = (d.match(/\n/g) || []).length, p = a + m, b = u[0].split(`
`), g = b.length, v = p + g - 1, T = d.lastIndexOf(`
`) + 1, k = u.index - T + 1, E = b[b.length - 1], I = {
					range: {
						startLineNumber: p,
						startColumn: k,
						endLineNumber: v,
						endColumn: g === 1 ? k + u[0].length : E.length + 1
					},
					text: (u.groups ?? {}).label ?? "",
					hasSeparatorLine: ((u.groups ?? {}).separator ?? "") !== "",
					shouldBeInComments: !0
				};
				(I.text || I.hasSeparatorLine) && (n.length === 0 || n[n.length - 1].range.endLineNumber < I.range.startLineNumber) && n.push(I), s.lastIndex = u.index + u[0].length;
			}
		}
		return n;
	}
	...
	var wh = class {
		...
		_ensureNoFinalValue() {
			if (this._finalValue) throw new oe("ProducerConsumer: cannot produce after final value has been set");
		}
	...
	(class we {
		constructor(t, n) {
			this._onReturn = n, this._producerConsumer = new wh(), this._iterator = {
	...
	var _h = class {
		...
		$acceptNewModel(e) {
			this._models[e.url] = new kh(zn.parse(e.url), e.lines, e.EOL, e.versionId);
		}
		...
		getWordAtPosition(e, t) {
			const n = On(e.column, bs(t), this._lines[e.lineNumber - 1], 0);
		...
		constructor(t = null) {
			this._foreignModule = t, this._requestHandlerBrand = void 0, this._workerTextModelSyncServer = new Th();
		}
		dispose() {}
		async $ping() {
			return "pong";
		...
		async $computeUnicodeHighlights(t, n, r) {
			...
			return i ? Tc.computeUnicodeHighlights(i, n, r) : {
				ranges: [],
				hasMore: !1,
		...
		async $computeDiff(t, n, r, i) {
			...
			return !s || !a ? null : mn.computeDiff(s, a, r, i);
		}
		static computeDiff(t, n, r, i) {
			const s = i === "advanced" ? qs.getDefault() : qs.getLegacy(), a = t.getLinesContent(), o = n.getLinesContent(), l = s.computeDiff(a, o, r), c = l.changes.length > 0 ? !1 : this._modelsAreIdentical(t, n);
			function u(d) {
				return d.map((m) => [
		...
		async $computeMoreMinimalEdits(t, n, r) {
			...
			const s = [];
			let a;
			n = n.slice(0).sort((l, c) => l.range && c.range ? V.compareRangesUsingStarts(l.range, c.range) : (l.range ? 0 : 1) - (c.range ? 0 : 1));
			let o = 0;
			for (let l = 1; l < n.length; l++) V.getEndPosition(n[o].range).equals(V.getStartPosition(n[l].range)) ? (n[o].range = V.fromPositions(V.getStartPosition(n[o].range), V.getEndPosition(n[l].range)), n[o].text += n[l].text) : (o++, n[o] = n[l]);
			n.length = o + 1;
			for (let { range: l, text: c, eol: u } of n) {
				if (typeof u == "number" && (a = u), V.isEmpty(l) && !c) continue;
				const d = i.getValueInRange(l);
				if (c = c.replace(/\r\n|\n|\r/g, i.eol), d === c) continue;
				if (Math.max(c.length, d.length) > mn._diffLimit) {
					s.push({
						range: l,
						text: c
					});
				...
				const m = Tl(d, c, r), p = i.offsetAt(V.lift(l).getStartPosition());
				for (const b of m) {
					const g = i.positionAt(p + b.originalStart), v = i.positionAt(p + b.originalStart + b.originalLength), T = {
					...
					i.getValueInRange(T.range) !== T.text && s.push(T);
				}
			}
		...
		async $textualSuggest(t, n, r, i) {
			const s = new Ni(), a = new RegExp(r, i), o = /* @__PURE__ */ new Set();
			e: for (const l of t) {
				const c = this._getModel(l);
				if (c) {
					for (const u of c.words(a)) if (!(u === n || !isNaN(Number(u))) && (o.add(u), o.size > mn._suggestionsLimit)) break e;
				}
			}
			return {
				words: Array.from(o),
		...
		async $navigateValueSet(t, n, r, i, s) {
			...
			const l = a.getValueInRange(n), c = a.getWordAtPosition({
				lineNumber: n.startLineNumber,
				column: n.startColumn
			}, o);
			if (!c) return null;
			const u = a.getValueInRange(c);
			return El.INSTANCE.navigateValueSet(n, l, c, u, r);
		}
		$fmr(t, n) {
	...
	function ve(...e) {
		...
		if (typeof t == "string") n = t, r = t, e.splice(0, 1), i = !e || typeof e[0] != "object" ? e : e[0];
			...
			let a = t[0];
			for (let o = 1; o < t.length; o++) a += `{${o - 1}}` + t[o];
			return ve(a, ...s);
	...
	var Mh = /{([^}]+)}/g;
	function Eh(e, t) {
		return Object.keys(t).length === 0 ? e : e.replace(Mh, (n, r) => t[r] ?? n);
	}
	var $s;
	(function(e) {
		function t(n) {
	...
	(function(e) {
		function t(r, i) {
			return r === Number.MAX_VALUE && (r = Yt.MAX_VALUE), i === Number.MAX_VALUE && (i = Yt.MAX_VALUE), {
				line: r,
				character: i
			};
		}
	...
	(function(e) {
		function t(r, i, s, a) {
			if (M.uinteger(r) && M.uinteger(i) && M.uinteger(s) && M.uinteger(a)) return {
				start: ie.create(r, i),
				end: ie.create(s, a)
			};
		...
		function n(r) {
			let i = r;
			return M.objectLiteral(i) && ie.is(i.start) && ie.is(i.end);
		}
		e.is = n;
	})($ || ($ = {}));
	var Jt;
	(function(e) {
		...
		function n(r) {
			let i = r;
			return M.objectLiteral(i) && $.is(i.range) && (M.string(i.uri) || M.undefined(i.uri));
		}
		e.is = n;
	})(Jt || (Jt = {}));
	var Xs;
	(function(e) {
		...
		function n(r) {
			let i = r;
			return M.objectLiteral(i) && $.is(i.targetRange) && M.string(i.targetUri) && $.is(i.targetSelectionRange) && ($.is(i.originSelectionRange) || M.undefined(i.originSelectionRange));
		}
		e.is = n;
	})(Xs || (Xs = {}));
	var ei;
	...
	(function(e) {
		...
		function n(r) {
			const i = r;
			return M.objectLiteral(i) && $.is(i.range) && ei.is(i.color);
		}
		e.is = n;
	})(Ys || (Ys = {}));
	var Js;
	(function(e) {
		...
		function n(r) {
			const i = r;
			return M.objectLiteral(i) && M.string(i.label) && (M.undefined(i.textEdit) || se.is(i)) && (M.undefined(i.additionalTextEdits) || M.typedArray(i.additionalTextEdits, se.is));
		}
		e.is = n;
	})(Js || (Js = {}));
	var Qt;
	...
	(function(e) {
		function t(r, i, s, a, o, l) {
			...
			return M.defined(s) && (c.startCharacter = s), M.defined(a) && (c.endCharacter = a), M.defined(o) && (c.kind = o), M.defined(l) && (c.collapsedText = l), c;
		}
		e.create = t;
		function n(r) {
			const i = r;
	...
	(function(e) {
		...
		function n(r) {
			var i;
			let s = r;
			return M.defined(s) && $.is(s.range) && M.string(s.message) && (M.number(s.severity) || M.undefined(s.severity)) && (M.integer(s.code) || M.string(s.code) || M.undefined(s.code)) && (M.undefined(s.codeDescription) || M.string((i = s.codeDescription) === null || i === void 0 ? void 0 : i.href)) && (M.string(s.source) || M.undefined(s.source)) && (M.undefined(s.relatedInformation) || M.typedArray(s.relatedInformation, ti.is));
		}
		e.is = n;
	})(Zt || (Zt = {}));
	var rt;
	...
	(function(e) {
		...
		function i(s) {
			const a = s;
			return M.objectLiteral(a) && M.string(a.newText) && $.is(a.range);
		}
		e.is = i;
	})(se || (se = {}));
	var ni;
	...
	(function(e) {
		...
		function i(s) {
			const a = s;
			return se.is(a) && (ni.is(a.annotationId) || st.is(a.annotationId));
		}
		e.is = i;
	})(ta || (ta = {}));
	var ii;
	(function(e) {
		...
		function n(r) {
			let i = r;
			return M.defined(i) && li.is(i.textDocument) && Array.isArray(i.edits);
		}
		e.is = n;
	})(ii || (ii = {}));
	var ri;
	(function(e) {
		...
		function n(r) {
			let i = r;
			return i && i.kind === "create" && M.string(i.uri) && (i.options === void 0 || (i.options.overwrite === void 0 || M.boolean(i.options.overwrite)) && (i.options.ignoreIfExists === void 0 || M.boolean(i.options.ignoreIfExists))) && (i.annotationId === void 0 || st.is(i.annotationId));
		}
		e.is = n;
	})(ri || (ri = {}));
	var si;
	(function(e) {
		...
		function n(r) {
			let i = r;
			return i && i.kind === "rename" && M.string(i.oldUri) && M.string(i.newUri) && (i.options === void 0 || (i.options.overwrite === void 0 || M.boolean(i.options.overwrite)) && (i.options.ignoreIfExists === void 0 || M.boolean(i.options.ignoreIfExists))) && (i.annotationId === void 0 || st.is(i.annotationId));
		}
		e.is = n;
	})(si || (si = {}));
	var ai;
	(function(e) {
		...
		function n(r) {
			let i = r;
			return i && i.kind === "delete" && M.string(i.uri) && (i.options === void 0 || (i.options.recursive === void 0 || M.boolean(i.options.recursive)) && (i.options.ignoreIfNotExists === void 0 || M.boolean(i.options.ignoreIfNotExists))) && (i.annotationId === void 0 || st.is(i.annotationId));
		}
		e.is = n;
	})(ai || (ai = {}));
	var oi;
	(function(e) {
		function t(n) {
			let r = n;
			return r && (r.changes !== void 0 || r.documentChanges !== void 0) && (r.documentChanges === void 0 || r.documentChanges.every((i) => M.string(i.kind) ? ri.is(i) || si.is(i) || ai.is(i) : ii.is(i)));
		}
		e.is = t;
	})(oi || (oi = {}));
	var na;
	...
	(function(e) {
		function t(n) {
			const r = n;
			return M.objectLiteral(n) && Ne.is(r.kind) && M.string(r.value);
		}
		e.is = t;
	})(_t || (_t = {}));
	var me;
	...
	(function(e) {
		...
		function n(r) {
			const i = r;
			return i && M.string(i.newText) && $.is(i.insert) && $.is(i.replace);
		}
		e.is = n;
	})(aa || (aa = {}));
	var oa;
	...
	(function(e) {
		function t(n) {
			let r = n;
			return !!r && M.objectLiteral(r) && (_t.is(r.contents) || Kt.is(r.contents) || M.typedArray(r.contents, Kt.is)) && (n.range === void 0 || $.is(n.range));
		}
		e.is = t;
	})(ua || (ua = {}));
	var da;
	...
	(function(e) {
		...
		function n(r) {
			let i = r;
			return i && M.string(i.name) && M.number(i.kind) && $.is(i.range) && $.is(i.selectionRange) && (i.detail === void 0 || M.string(i.detail)) && (i.deprecated === void 0 || M.boolean(i.deprecated)) && (i.children === void 0 || Array.isArray(i.children)) && (i.tags === void 0 || Array.isArray(i.tags));
		}
		e.is = n;
	})(ui || (ui = {}));
	var ba;
	...
	(function(e) {
		...
		function n(r) {
			let i = r;
			return M.defined(i) && M.typedArray(i.diagnostics, Zt.is) && (i.only === void 0 || M.typedArray(i.only, M.string)) && (i.triggerKind === void 0 || i.triggerKind === tn.Invoked || i.triggerKind === tn.Automatic);
		}
		e.is = n;
	})(wa || (wa = {}));
	var _a;
	(function(e) {
		function t(r, i, s) {
			let a = { title: r }, o = !0;
			return typeof i == "string" ? (o = !1, a.kind = i) : rt.is(i) ? a.command = i : a.edit = i, o && s !== void 0 && (a.kind = s), a;
		}
		e.create = t;
		function n(r) {
			let i = r;
			return i && M.string(i.title) && (i.diagnostics === void 0 || M.typedArray(i.diagnostics, Zt.is)) && (i.kind === void 0 || M.string(i.kind)) && (i.edit !== void 0 || i.command !== void 0) && (i.command === void 0 || rt.is(i.command)) && (i.isPreferred === void 0 || M.boolean(i.isPreferred)) && (i.edit === void 0 || oi.is(i.edit));
		}
		e.is = n;
	})(_a || (_a = {}));
	var va;
	(function(e) {
		...
		function n(r) {
			let i = r;
			return M.defined(i) && $.is(i.range) && (M.undefined(i.command) || rt.is(i.command));
		}
		e.is = n;
	})(va || (va = {}));
	var ya;
	...
	(function(e) {
		...
		function n(r) {
			let i = r;
			return M.defined(i) && $.is(i.range) && (M.undefined(i.target) || M.string(i.target));
		}
		e.is = n;
	})(Ta || (Ta = {}));
	var nn;
	(function(e) {
		...
		function n(r) {
			let i = r;
			return M.objectLiteral(i) && $.is(i.range) && (i.parent === void 0 || e.is(i.parent));
		}
		e.is = n;
	})(nn || (nn = {}));
	var ka;
	...
	(function(e) {
		...
		function n(r) {
			const i = r;
			return i != null && $.is(i.range) && M.string(i.text);
		}
		e.is = n;
	})(xa || (xa = {}));
	var Aa;
	(function(e) {
		...
		function n(r) {
			const i = r;
			return i != null && $.is(i.range) && M.boolean(i.caseSensitiveLookup) && (M.string(i.variableName) || i.variableName === void 0);
		}
		e.is = n;
	})(Aa || (Aa = {}));
	var Ra;
	(function(e) {
		...
		function n(r) {
			const i = r;
			return i != null && $.is(i.range) && (M.string(i.expression) || i.expression === void 0);
		}
		e.is = n;
	})(Ra || (Ra = {}));
	var Ma;
	(function(e) {
		...
		function n(r) {
			const i = r;
			return M.defined(i) && $.is(r.stoppedLocation);
		}
		e.is = n;
	})(Ma || (Ma = {}));
	var di;
	...
	(function(e) {
		...
		function n(r) {
			const i = r;
			return M.objectLiteral(i) && (i.tooltip === void 0 || M.string(i.tooltip) || _t.is(i.tooltip)) && (i.location === void 0 || Jt.is(i.location)) && (i.command === void 0 || rt.is(i.command));
		}
		e.is = n;
	})(mi || (mi = {}));
	var Ea;
	(function(e) {
		...
		function n(r) {
			const i = r;
			return M.objectLiteral(i) && ie.is(i.position) && (M.string(i.label) || M.typedArray(i.label, mi.is)) && (i.kind === void 0 || di.is(i.kind)) && i.textEdits === void 0 || M.typedArray(i.textEdits, se.is) && (i.tooltip === void 0 || M.string(i.tooltip) || _t.is(i.tooltip)) && (i.paddingLeft === void 0 || M.boolean(i.paddingLeft)) && (i.paddingRight === void 0 || M.boolean(i.paddingRight));
		}
		e.is = n;
	})(Ea || (Ea = {}));
	var Na;
	...
	(function(e) {
		function t(n) {
			const r = n;
			return M.objectLiteral(r) && Kn.is(r.uri) && M.string(r.name);
		}
		e.is = t;
	})(Da || (Da = {}));
	var Wa;
	(function(e) {
		...
		function r(s, a) {
			...
			for (let u = l.length - 1; u >= 0; u--) {
				...
				if (p <= c) o = o.substring(0, m) + d.newText + o.substring(p, o.length);
		...
		function i(s, a) {
			...
			i(l, a), i(c, a);
			let u = 0, d = 0, m = 0;
			for (; u < l.length && d < c.length;) a(l[u], c[d]) <= 0 ? s[m++] = l[u++] : s[m++] = c[d++];
...
` && r++;
	...
	(function(e) {
		...
		e.number = a;
		function o(p, b, g) {
			return t.call(p) === "[object Number]" && b <= p && p <= g;
		}
		e.numberRange = o;
		function l(p) {
	...
	var Pa = class Ai {
		...
		update(t, n) {
			for (let r of t) if (Ai.isIncremental(r)) {
				const i = Oa(r.range), s = this.offsetAt(i.start), a = this.offsetAt(i.end);
				...
				const u = qa(r.text, !1, s);
				if (l - o === u.length) for (let m = 0, p = u.length; m < p; m++) c[m + o + 1] = u[m];
				else u.length < 1e4 ? c.splice(o + 1, l - o, ...u) : this._lineOffsets = c = c.slice(0, o + 1).concat(u, c.slice(l + 1));
				const d = r.text.length - (a - s);
				if (d !== 0) for (let m = o + 1 + u.length, p = c.length; m < p; m++) c[m] = c[m] + d;
			} else if (Ai.isFull(r)) this._content = r.text, this._lineOffsets = void 0;
			else throw new Error("Unknown change event received");
			this._version = n;
		}
		getLineOffsets() {
			return this._lineOffsets === void 0 && (this._lineOffsets = qa(this._content, !0)), this._lineOffsets;
		}
		positionAt(t) {
	...
	(function(e) {
		function t(i, s, a, o) {
			return new Pa(i, s, a, o);
		}
		e.create = t;
		function n(i, s, a) {
			if (i instanceof Pa) return i.update(s, a), i;
			throw new Error("TextDocument.update: document must be created by TextDocument.create");
		}
		e.update = n;
		function r(i, s) {
			let a = i.getText(), o = pi(s.map(Ch), (u, d) => {
				let m = u.range.start.line - d.range.start.line;
				return m === 0 ? u.range.start.character - d.range.start.character : m;
			}), l = 0;
			const c = [];
	...
	function pi(e, t) {
		...
		pi(r, t), pi(i, t);
		let s = 0, a = 0, o = 0;
		for (; s < r.length && a < i.length;) t(r[s], i[a]) <= 0 ? e[o++] = r[s++] : e[o++] = i[a++];
		for (; s < r.length;) e[o++] = r[s++];
	...
	(function(e) {
		e.LATEST = { textDocument: {
			completion: { completionItem: { documentationFormat: [Ne.Markdown, Ne.PlainText] } },
	...
	var Ih = class {
		...
		skipWhitespace() {
			return this.advanceWhileChar((e) => e === qh || e === Oh || e === Dh || e === Ph || e === Wh) > 0;
		}
		advanceWhileChar(e) {
	...
	const Ba = 33, at = 45, rn = 60, Le = 62, bi = 47, zh = 61, Hh = 34, Uh = 39, Dh = 10, Wh = 13, Ph = 12, qh = 32, Oh = 9, Fh = {
		"text/x-handlebars-template": !0,
		"text/html": !0
	};
	function fe(e, t = 0, n = B.WithinContent, r = !1) {
		const i = new Ih(e, t);
		let s = n, a = 0, o = U.Unknown, l, c, u, d, m;
		function p() {
		...
		function g(k, E, I) {
			return o = E, a = k, l = I, E;
		}
		function v() {
			const k = i.pos(), E = s, I = T();
			return I !== U.EOS && k === i.pos() && !(r && (I === U.StartTagClose || I === U.EndTagClose)) ? (console.warn("Scanner.scan has not advanced at offset " + k + ", state before: " + E + " after: " + s), i.advance(1), g(k, U.Unknown)) : I;
		}
		function T() {
			const k = i.pos();
			if (i.eos()) return g(k, U.EOS);
			let E;
			switch (s) {
				case B.WithinComment: return i.advanceIfChars([
					at,
					at,
					Le
				]) ? (s = B.WithinContent, g(k, U.EndCommentTag)) : (i.advanceUntilChars([
					at,
					at,
					Le
				]), g(k, U.Comment));
				case B.WithinDoctype: return i.advanceIfChar(Le) ? (s = B.WithinContent, g(k, U.EndDoctypeTag)) : (i.advanceUntilChar(Le), g(k, U.Doctype));
				case B.WithinContent:
					if (i.advanceIfChar(rn)) {
						if (!i.eos() && i.peekChar() === Ba) {
							if (i.advanceIfChars([
								Ba,
								at,
								at
							])) return s = B.WithinComment, g(k, U.StartCommentTag);
							if (i.advanceIfRegExp(/^!doctype/i)) return s = B.WithinDoctype, g(k, U.StartDoctypeTag);
						}
						return i.advanceIfChar(bi) ? (s = B.AfterOpeningEndTag, g(k, U.EndTagOpen)) : (s = B.AfterOpeningStartTag, g(k, U.StartTagOpen));
					}
					return i.advanceUntilChar(rn), g(k, U.Content);
				case B.AfterOpeningEndTag: return p().length > 0 ? (s = B.WithinEndTag, g(k, U.EndTag)) : i.skipWhitespace() ? g(k, U.Whitespace, ve("Tag name must directly follow the open bracket.")) : (s = B.WithinEndTag, i.advanceUntilChar(Le), k < i.pos() ? g(k, U.Unknown, ve("End tag name expected.")) : T());
				case B.WithinEndTag:
					if (i.skipWhitespace()) return g(k, U.Whitespace);
					if (i.advanceIfChar(Le)) return s = B.WithinContent, g(k, U.EndTagClose);
					if (r && i.peekChar() === rn) return s = B.WithinContent, g(k, U.EndTagClose, ve("Closing bracket missing."));
					E = ve("Closing bracket expected.");
					break;
				case B.AfterOpeningStartTag: return u = p(), m = void 0, d = void 0, u.length > 0 ? (c = !1, s = B.WithinTag, g(k, U.StartTag)) : i.skipWhitespace() ? g(k, U.Whitespace, ve("Tag name must directly follow the open bracket.")) : (s = B.WithinTag, i.advanceUntilChar(Le), k < i.pos() ? g(k, U.Unknown, ve("Start tag name expected.")) : T());
				case B.WithinTag: return i.skipWhitespace() ? (c = !0, g(k, U.Whitespace)) : c && (d = b(), d.length > 0) ? (s = B.AfterAttributeName, c = !1, g(k, U.AttributeName)) : i.advanceIfChars([bi, Le]) ? (s = B.WithinContent, g(k, U.StartTagSelfClose)) : i.advanceIfChar(Le) ? (u === "script" ? m && Fh[m] ? s = B.WithinContent : s = B.WithinScriptContent : u === "style" ? s = B.WithinStyleContent : s = B.WithinContent, g(k, U.StartTagClose)) : r && i.peekChar() === rn ? (s = B.WithinContent, g(k, U.StartTagClose, ve("Closing bracket missing."))) : (i.advance(1), g(k, U.Unknown, ve("Unexpected character in tag.")));
				case B.AfterAttributeName: return i.skipWhitespace() ? (c = !0, g(k, U.Whitespace)) : i.advanceIfChar(zh) ? (s = B.BeforeAttributeValue, g(k, U.DelimiterAssign)) : (s = B.WithinTag, T());
				case B.BeforeAttributeValue:
					if (i.skipWhitespace()) return g(k, U.Whitespace);
					let I = i.advanceIfRegExp(/^[^\s"'`=<>]+/);
					if (I.length > 0 && (i.peekChar() === Le && i.peekChar(-1) === bi && (i.goBack(1), I = I.substring(0, I.length - 1)), d === "type" && (m = I), I.length > 0)) return s = B.WithinTag, c = !1, g(k, U.AttributeValue);
					const D = i.peekChar();
					return D === Uh || D === Hh ? (i.advance(1), i.advanceUntilChar(D) && i.advance(1), d === "type" && (m = i.getSource().substring(k + 1, i.pos() - 1)), s = B.WithinTag, c = !1, g(k, U.AttributeValue)) : (s = B.WithinTag, c = !1, T());
				case B.WithinScriptContent:
					let w = 1;
					for (; !i.eos();) {
						const f = i.advanceIfRegExp(/<!--|-->|<\/?script\s*\/?>?/i);
						if (f.length === 0) return i.goToEnd(), g(k, U.Script);
						if (f === "<!--") w === 1 && (w = 2);
						else if (f === "-->") w = 1;
						else if (f[1] !== "/") w === 2 && (w = 3);
						else if (w === 3) w = 2;
					...
					return s = B.WithinContent, k < i.pos() ? g(k, U.Script) : T();
				case B.WithinStyleContent: return i.advanceUntilRegExp(/<\/style/i), s = B.WithinContent, k < i.pos() ? g(k, U.Styles) : T();
			}
			return i.advance(1), s = B.WithinContent, g(k, U.Unknown, E);
		}
		return {
			scan: v,
			getTokenType: () => o,
			getTokenOffset: () => a,
			getTokenLength: () => i.pos() - a,
			getTokenEnd: () => i.pos(),
			getTokenText: () => i.getSource().substring(a, i.pos()),
			getScannerState: () => s,
			getTokenError: () => l
		};
	}
	...
	var ja = class {
		...
		findNodeBefore(e) {
			const t = Va(this.children, (n) => e <= n.start) - 1;
			if (t >= 0) {
		...
		parse(e, t) {
			const n = fe(e, void 0, void 0, !0), r = new ja(0, e.length, [], void 0);
			let i = r, s = -1, a, o = null, l = n.scan();
			for (; l !== U.EOS;) {
				switch (l) {
					case U.StartTagOpen:
						const c = new ja(n.getTokenOffset(), e.length, [], i);
					...
					case U.EndTagClose:
						let u = i;
						for (; !u.isSameTag(a) && u.parent;) u = u.parent;
						if (u.parent) {
...
`,
	...
	const $h = 97, Gh = 122, Xh = 65, Yh = 90, Jh = 48, Qh = 57;
	function yt(e, t) {
		const n = e.charCodeAt(t);
		return $h <= n && n <= Gh || Xh <= n && n <= Yh || Jh <= n && n <= Qh;
	}
	function sn(e) {
		return typeof e < "u";
	}
	...
	var Ga = class {
		...
		provideValues(e, t) {
			...
			const r = (s) => {
				s.forEach((a) => {
					a.name.toLowerCase() === t && (a.values && a.values.forEach((o) => {
						n.push(o);
					}), a.valueSet && this._valueSetMap[a.valueSet] && this._valueSetMap[a.valueSet].forEach((o) => {
						n.push(o);
					}));
				});
...
`)), r.value !== "") return r;
	...
	var Kh = class {
		...
		async computeCompletions(e, t) {
			...
			for (const r of this.atributeCompletions) {
				const i = tu(e.getText(r.range));
				if (nu(i)) if (i === "." || i === "..") n.isIncomplete = !0;
				else {
					const s = iu(r.value, i, r.range), a = await this.providePathSuggestions(r.value, s, e, t);
					for (const o of a) n.items.push(o);
				}
			}
			return n;
		}
		async providePathSuggestions(e, t, n, r) {
			...
			if (s) try {
				const a = [], o = await this.readDirectory(s);
				for (const [l, c] of o) l.charCodeAt(0) !== eu && a.push(ru(l, c === gi.Directory, t));
				return a;
			} catch {}
			return [];
		}
	...
	const eu = 46;
	function tu(e) {
		return We(e, "'") || We(e, "\"") ? e.slice(1, -1) : e;
	}
	function nu(e) {
		return !(We(e, "http") || We(e, "https") || We(e, "//"));
	}
	function iu(e, t, n) {
		let r;
		...
		if (i === -1) r = su(n, 1, -1);
			...
			const s = t.slice(i + 1), a = Tt(n.end, -1 - s.length), o = s.indexOf(" ");
			let l;
			o !== -1 ? l = Tt(a, o) : l = Tt(n.end, -1), r = $.create(a, l);
		}
		return r;
	}
	function ru(e, t, n) {
	...
	function su(e, t, n) {
		const r = Tt(e.start, t), i = Tt(e.end, n);
		return $.create(r, i);
	}
	var au = class {
		constructor(e, t) {
		...
		async doComplete2(e, t, n, r, i) {
			...
			const s = new Kh(this.dataManager, this.lsOptions.fileSystemProvider.readDirectory), a = this.completionParticipants;
			this.completionParticipants = [s].concat(a);
			const o = this.doComplete(e, t, n, i);
			try {
		...
		_doComplete(e, t, n, r) {
			const i = {
				isIncomplete: !1,
				items: []
			}, s = this.completionParticipants, a = this.dataManager.getDataProviders().filter((y) => y.isApplicable(e.languageId) && (!r || r[y.getId()] !== !1)), o = this.dataManager.getVoidElements(a), l = this.doesSupportMarkdown(), c = e.getText(), u = e.offsetAt(t), d = n.findNodeBefore(u);
			if (!d) return i;
			const m = fe(c, d.start);
			let p = "", b;
			function g(y, R = u) {
				return y > u && (y = u), {
					start: e.positionAt(y),
					end: e.positionAt(R)
				};
			}
			function v(y, R) {
				const N = g(y, R);
				return a.forEach((H) => {
					H.provideTags().forEach((q) => {
						i.items.push({
							label: q.name,
							kind: me.Property,
							documentation: Ve(q, void 0, l),
							textEdit: se.replace(N, q.name),
			...
			function T(y) {
				let R = y;
				for (; R > 0;) {
					const N = c.charAt(R - 1);
					if (`
\r`.indexOf(N) >= 0) return c.substring(R, y);
					if (!an(N)) return null;
					R--;
				}
				return c.substring(0, y);
			}
			function k(y, R, N = u) {
				const H = g(y, N), q = Xa(c, N, B.WithinEndTag, U.EndTagClose) ? "" : ">";
				let P = d;
				for (R && (P = P.parent); P;) {
					const W = P.tag;
					if (W && (!P.closed || P.endTagStart && P.endTagStart > u)) {
						const G = {
							label: "/" + W,
							kind: me.Property,
							filterText: "/" + W,
							textEdit: se.replace(H, "/" + W + q),
							insertTextFormat: ye.PlainText
						}, Z = T(P.start), ae = T(y - 1);
						if (Z !== null && ae !== null && Z !== ae) {
							const Ce = Z + "</" + W + q;
							G.textEdit = se.replace(g(y - 1 - ae.length), Ce), G.filterText = ae + "</" + W;
						}
						return i.items.push(G), i;
					}
					P = P.parent;
				}
				return R || a.forEach((W) => {
					W.provideTags().forEach((G) => {
						i.items.push({
							label: "/" + G.name,
							kind: me.Property,
							documentation: Ve(G, void 0, l),
							filterText: "/" + G.name + q,
							textEdit: se.replace(H, "/" + G.name + q),
							insertTextFormat: ye.PlainText
						});
					});
				}), i;
			...
			const E = (y, R) => {
				...
				if (!this.dataManager.isVoidElement(R, o)) {
					const N = e.positionAt(y);
					i.items.push({
						label: "</" + R + ">",
						kind: me.Property,
						filterText: "</" + R + ">",
						textEdit: se.insert(N, "$0</" + R + ">"),
			...
			function w(y, R = u) {
				let N = u;
				for (; N < R && c[N] !== "<";) N++;
				const H = c.substring(y, R), q = g(y, N);
				let P = "";
				if (!Xa(c, R, B.AfterAttributeName, U.DelimiterAssign)) {
					const G = r?.attributeDefaultValue ?? "doublequotes";
					G === "empty" ? P = "=$1" : G === "singlequotes" ? P = "='$1'" : P = "=\"$1\"";
				}
				const W = D();
				return W[H] = !1, a.forEach((G) => {
					G.provideAttributes(p).forEach((Z) => {
						if (W[Z.name]) return;
						W[Z.name] = !0;
						let ae = Z.name, Ce;
						Z.valueSet !== "v" && P.length && (ae = ae + P, (Z.valueSet || Z.name === "style") && (Ce = {
							title: "Suggest",
							command: "editor.action.triggerSuggest"
						})), i.items.push({
							label: Z.name,
							kind: Z.valueSet === "handler" ? me.Function : me.Value,
							documentation: Ve(Z, void 0, l),
							textEdit: se.replace(q, ae),
							insertTextFormat: ye.Snippet,
							command: Ce
						});
					});
			...
			function f(y, R) {
				...
				H[N] = `${N}$1="$2"`;
				function q(P) {
					P.attributeNames.forEach((W) => {
						We(W, N) && !H[W] && !R[W] && (H[W] = W + "=\"$1\"");
					}), P.children.forEach((W) => q(W));
				}
				n && n.roots.forEach((P) => q(P)), Object.keys(H).forEach((P) => i.items.push({
					label: P,
					kind: me.Value,
					textEdit: se.replace(y, H[P]),
					insertTextFormat: ye.Snippet
				}));
			}
			function _(y, R = u) {
				...
				if (u > y && u <= R && ou(c[y])) {
					const P = y + 1;
					let W = R;
					R > y && c[R - 1] === c[y] && W--, N = g(lu(c, u, P), cu(c, u, W)), q = u >= P && u <= W ? c.substring(P, u) : "", H = !1;
				} else N = g(y, R), q = c.substring(y, u), H = !0;
				if (s.length > 0) {
					const P = p.toLowerCase(), W = b.toLowerCase(), G = g(y, R);
					for (const Z of s) Z.onHtmlAttributeValue && Z.onHtmlAttributeValue({
						document: e,
						position: t,
						tag: P,
						attribute: W,
				...
				return a.forEach((P) => {
					P.provideValues(p, b).forEach((W) => {
						const G = H ? "\"" + W.name + "\"" : W.name;
						i.items.push({
							label: W.name,
							filterText: G,
							kind: me.Unit,
							documentation: Ve(W, void 0, l),
							textEdit: se.replace(N, G),
							insertTextFormat: ye.PlainText
						});
					});
				}), L(), i;
			...
			function C(y) {
				return u === m.getTokenEnd() && (A = m.scan(), A === y && m.getTokenOffset() === u) ? m.getTokenEnd() : u;
			}
			function z() {
				for (const y of s) y.onHtmlContent && y.onHtmlContent({
					document: e,
					position: t
				});
				return L();
			...
			function L() {
				let y = u - 1, R = t.character;
				for (; y >= 0 && yt(c, y);) y--, R--;
				if (y >= 0 && c[y] === "&") {
					const N = $.create(ie.create(t.line, R - 1), t);
					for (const H in vt) if (jh(H, ";")) {
						const q = "&" + H;
						i.items.push({
							label: q,
							kind: me.Keyword,
							documentation: ve("Character entity representing '{0}'", vt[H]),
							textEdit: se.replace(N, q),
							insertTextFormat: ye.PlainText
						});
					}
				}
			...
			function S(y, R) {
				...
				i.items.push({
					...
					textEdit: se.replace(N, "!DOCTYPE html>"),
					insertTextFormat: ye.PlainText
				});
			}
			let A = m.scan();
			for (; A !== U.EOS && m.getTokenOffset() <= u;) {
				switch (A) {
					case U.StartTagOpen:
						if (m.getTokenEnd() === u) {
							const y = C(U.StartTag);
							return t.line === 0 && S(u, y), I(u, y);
						}
						break;
					case U.StartTag:
						...
						break;
					case U.AttributeName:
						if (m.getTokenOffset() <= u && u <= m.getTokenEnd()) return w(m.getTokenOffset(), m.getTokenEnd());
						b = m.getTokenText();
						break;
					case U.DelimiterAssign:
						if (m.getTokenEnd() === u) return _(u, C(U.AttributeValue));
						break;
					case U.AttributeValue:
						if (m.getTokenOffset() <= u && u <= m.getTokenEnd()) return _(m.getTokenOffset(), m.getTokenEnd());
						break;
					case U.Whitespace:
						if (u <= m.getTokenEnd()) switch (m.getScannerState()) {
							case B.AfterOpeningStartTag: return I(m.getTokenOffset(), C(U.StartTag));
							case B.WithinTag:
							case B.AfterAttributeName: return w(m.getTokenEnd());
							case B.BeforeAttributeValue: return _(m.getTokenEnd());
							case B.AfterOpeningEndTag: return k(m.getTokenOffset() - 1, !1);
							case B.WithinContent: return z();
						}
						break;
					case U.EndTagOpen:
						if (u <= m.getTokenEnd()) return k(m.getTokenOffset() + 1, !1, C(U.EndTag));
						break;
					case U.EndTag:
						if (u <= m.getTokenEnd()) {
							...
							for (; y >= 0;) {
								const R = c.charAt(y);
								if (R === "/") return k(y, !1, m.getTokenEnd());
								if (!an(R)) break;
								y--;
							}
						}
						break;
					case U.StartTagClose:
						if (u <= m.getTokenEnd() && p) return E(m.getTokenEnd(), p);
						break;
					case U.Content:
						if (u <= m.getTokenEnd()) return z();
						break;
					default:
		...
		doQuoteComplete(e, t, n, r) {
			...
			const a = s === "doublequotes" ? "\"$1\"" : "'$1'", o = n.findNodeBefore(i);
			if (o && o.attributes && o.start < i && (!o.endTagStart || o.endTagStart > i)) {
				const l = fe(e.getText(), o.start);
				let c = l.scan();
				for (; c !== U.EOS && l.getTokenEnd() <= i;) {
					if (c === U.AttributeName && l.getTokenEnd() === i - 1) return c = l.scan(), c !== U.DelimiterAssign || (c = l.scan(), c === U.Unknown || c === U.AttributeValue) ? null : a;
					c = l.scan();
				}
			}
			return null;
		...
		doTagComplete(e, t, n) {
			...
			if (i === ">") {
				const s = this.dataManager.getVoidElements(e.languageId), a = n.findNodeBefore(r);
				if (a && a.tag && !this.dataManager.isVoidElement(a.tag, s) && a.start < r && (!a.endTagStart || a.endTagStart > r)) {
					const o = fe(e.getText(), a.start);
					let l = o.scan();
					for (; l !== U.EOS && o.getTokenEnd() <= r;) {
						if (l === U.StartTagClose && o.getTokenEnd() === r) return `$0</${a.tag}>`;
						l = o.scan();
					}
				}
			} else if (i === "/") {
				...
				if (s && s.tag) {
					...
					let o = a.scan();
					for (; o !== U.EOS && a.getTokenEnd() <= r;) {
						if (o === U.EndTagOpen && a.getTokenEnd() === r) return e.getText().charAt(r) !== ">" ? `${s.tag}>` : s.tag;
						o = a.scan();
					}
				}
			}
		...
		doesSupportMarkdown() {
			if (!sn(this.supportsMarkdown)) {
				if (!sn(this.lsOptions.clientCapabilities)) return this.supportsMarkdown = !0, this.supportsMarkdown;
				const e = this.lsOptions.clientCapabilities.textDocument?.completion?.completionItem?.documentationFormat;
				this.supportsMarkdown = Array.isArray(e) && e.indexOf(Ne.Markdown) !== -1;
			}
	...
	var hu = class {
		...
		doHover(e, t, n, r) {
			const i = this.convertContents.bind(this), s = this.doesSupportMarkdown(), a = e.offsetAt(t), o = n.findNodeAt(a), l = e.getText();
			if (!o || !o.tag) return null;
			const c = this.dataManager.getDataProviders().filter((w) => w.isApplicable(e.languageId));
			function u(w, f, _) {
				for (const C of c) {
					let z = null;
					if (C.provideTags().forEach((L) => {
						if (L.name.toLowerCase() === w.toLowerCase()) {
							let S = Ve(L, r, s);
							S || (S = {
					...
					}), z) return z.contents = i(z.contents), z;
				}
				return null;
			}
			function d(w, f, _) {
				for (const C of c) {
					let z = null;
					if (C.provideAttributes(w).forEach((L) => {
						if (f === L.name && L.description) {
							const S = Ve(L, r, s);
							S ? z = {
								contents: S,
								range: _
			...
			function m(w, f, _, C) {
				for (const z of c) {
					let L = null;
					if (z.provideValues(w, f).forEach((S) => {
						if (_ === S.name && S.description) {
							const A = Ve(S, r, s);
							A ? L = {
								contents: A,
								range: C
					...
					}), L) return L.contents = i(L.contents), L;
				}
				return null;
			}
			function p(w, f) {
				...
				for (const C in vt) {
					let z = null;
					if (_ === "&" + C) {
						let L = vt[C].charCodeAt(0).toString(16).toUpperCase(), S = "U+";
						if (L.length < 4) {
							const y = 4 - L.length;
							let R = 0;
							for (; R < y;) S += "0", R += 1;
						...
						S += L;
						const A = ve("Character entity representing '{0}', unicode equivalent '{1}'", vt[C], S);
						A ? z = {
							contents: A,
							range: f
						} : z = null;
					}
					if (z) return z.contents = i(z.contents), z;
				}
				return null;
			}
			function b(w, f) {
				const _ = fe(e.getText(), f);
				let C = _.scan();
				for (; C !== U.EOS && (_.getTokenEnd() < a || _.getTokenEnd() === a && C !== w);) C = _.scan();
				return C === w && a <= _.getTokenEnd() ? {
					start: e.positionAt(_.getTokenOffset()),
					end: e.positionAt(_.getTokenEnd())
				} : null;
			}
			function g() {
				let w = a - 1, f = t.character;
				for (; w >= 0 && yt(l, w);) w--, f--;
				let _ = w + 1, C = f;
				for (; yt(l, _);) _++, C++;
				if (w >= 0 && l[w] === "&") {
					let z = null;
					return l[_] === ";" ? z = $.create(ie.create(t.line, f), ie.create(t.line, C + 1)) : z = $.create(ie.create(t.line, f), ie.create(t.line, C)), z;
				}
				return null;
			}
			function v(w) {
				let f = a - 1, _ = "&";
				for (; f >= 0 && yt(w, f);) f--;
				for (f = f + 1; yt(w, f);) _ += w[f], f += 1;
				return _ += ";", _;
			}
			if (o.endTagStart && a >= o.endTagStart) {
				const w = b(U.EndTag, o.endTagStart);
				return w ? u(o.tag, w) : null;
			}
			const T = b(U.StartTag, o.start);
			if (T) return u(o.tag, T);
			const k = b(U.AttributeName, o.start);
			if (k) {
				const w = o.tag;
				return d(w, e.getText(k), k);
			}
			const E = g();
			if (E) return p(l, E);
			function I(w, f) {
				const _ = fe(e.getText(), w);
				let C = _.scan(), z;
				for (; C !== U.EOS && _.getTokenEnd() <= f;) C = _.scan(), C === U.AttributeName && (z = _.getTokenText());
				return z;
			}
			const D = b(U.AttributeValue, o.start);
			if (D) {
				const w = o.tag, f = uu(e.getText(D)), _ = I(o.start, e.offsetAt(D.start));
				if (_) return m(w, _, f, D);
			}
			return null;
		}
		convertContents(e) {
		...
		var e = [
			...
			(function(r) {
				...
				i.prototype.clone_empty = function() {
					...
					for (var l = this.__items.length - 1; l >= 0; l--) if (this.__items[l].match(o)) return !0;
					return !1;
...
` && (c = c.replace(/[\n]/g, o)), c;
					...
					for (var l = 0; l < o.newlines; l++) this.__add_outputline();
					...
					for (var l = this.__lines.length; o < l;) this.__lines[o]._remove_indent(), o++;
					this.current_line._remove_wrap_indent();
				}, a.prototype.trim = function(o) {
					for (o = o === void 0 ? !1 : o, this.current_line.trim(); o && this.__lines.length > 1 && this.current_line.is_empty();) this.__lines.pop(), this.current_line = this.__lines[this.__lines.length - 1], this.current_line.trim();
					...
					for (var c = this.__lines.length - 2; c >= 0;) {
						...
						if (u.is_empty()) break;
						if (u.item(0).indexOf(o) !== 0 && u.item(-1) !== l) {
...
`).replace(/\\t/, "	")), u;
				...
				}, i.prototype._get_selection = function(o, l, c) {
					var u = this._get_selection_list(o, l, c);
					if (u.length !== 1) throw new Error("Invalid Option Value: The option '" + o + `' can only be one of the following values:
` + l + `
You passed in: '` + this.raw_options[o] + "'");
					return u[0];
				}, i.prototype._get_selection_list = function(o, l, c) {
					...
					var u = this._get_array(o, c);
					if (!this._is_valid_selection(u, l)) throw new Error("Invalid Option Value: The option '" + o + `' can contain only the following values:
` + l + `
You passed in: '` + this.raw_options[o] + "'");
					return u;
				...
				function s(o, l) {
					...
					o = a(o);
					var u;
					for (u in o) u !== l && (c[u] = o[u]);
					if (l && o[l]) for (u in o[l]) c[u] = o[l][u];
					return c;
				}
				function a(o) {
					var l = {}, c;
			...
			(function(r) {
				...
				s.prototype.restart = function() {
					...
					var c = "", u;
					return a && (u = this.match(a), u && (c += u[0])), o && (u || !a) && (c += this.readUntil(o, l)), c;
				}, s.prototype.readUntil = function(a, o) {
					var l = "", c = this.__position;
					a.lastIndex = this.__position;
					var u = a.exec(this.__input);
					return u ? (c = u.index, o && (c += u[0].length)) : c = this.__input_length, l = this.__input.substring(this.__position, c), this.__position = c, l;
				}, s.prototype.readUntilAfter = function(a) {
					return this.readUntil(a, !0);
				}, s.prototype.get_regexp = function(a, o) {
					var l = null, c = "g";
					return o && i && (c = "y"), typeof a == "string" && a !== "" ? l = new RegExp(a, c) : a && (l = new RegExp(a.source, c)), l;
			...
			(function(r) {
				...
				i.prototype.get_directives = function(s) {
					...
					for (var o = this.__directive_pattern.exec(s); o;) a[o[1]] = o[2], o = this.__directive_pattern.exec(s);
					return a;
			...
			(function(r, i, s) {
				var a = s(17).Options, o = s(2).Output, l = s(8).InputScanner, c = s(13).Directives, u = new c(/\/\*/, /\*\//), d = /\r\n|[\r\n]/, m = /\r\n|[\r\n]/g, p = /\s/, b = /(?:\s|\n)+/g, g = /\/\*(?:[\s\S]*?)((?:\*\/)|$)/g, v = /\/\/(?:[^\n\r\u2028\u2029]*)/g;
				function T(k, E) {
					this._source_text = k || "", this._options = new a(E), this._ch = null, this._input = null, this.NESTED_AT_RULE = {
						page: !0,
						"font-face": !0,
						keyframes: !0,
						media: !0,
				...
				T.prototype.eatString = function(k) {
					var E = "";
...
`) break;
					...
					return E;
				}, T.prototype.eatWhitespace = function(k) {
					for (var E = p.test(this._input.peek()), I = 0; p.test(this._input.peek());) this._ch = this._input.next(), k && this._ch === `
` && (I === 0 || I < this._options.max_preserve_newlines) && (I++, this._output.add_new_line(!0));
					return E;
				}, T.prototype.foundNestedPseudoClass = function() {
					for (var k = 0, E = 1, I = this._input.peek(E); I;) {
						if (I === "{") return !0;
						if (I === "(") k += 1;
						else if (I === ")") {
							if (k === 0) return !1;
					...
					var k = this._source_text, E = this._options.eol;
					E === "auto" && (E = `
`, k && d.test(k || "") && (E = k.match(d)[0])), k = k.replace(m, `
`);
					var I = k.match(/^[\t ]*/)[0];
					this._output = new o(this._options, I), this._input = new l(k), this._indentLevel = 0, this._nestedLevel = 0, this._ch = null;
					for (var D = 0, w = !1, f = !1, _ = !1, C = !1, z = !1, L = this._ch, S = !1, A, y, R; A = this._input.read(b), y = A !== "", R = L, this._ch = this._input.next(), this._ch === "\\" && this._input.hasNext() && (this._ch += this._input.next()), L = this._ch, this._ch;) if (this._ch === "/" && this._input.peek() === "*") {
						this._output.add_new_line(), this._input.back();
						var N = this._input.read(g), H = u.get_directives(N);
						H && H.ignore === "start" && (N += u.readIgnored(this._input)), this.print_string(N), this.eatWhitespace(!0), this._output.add_new_line();
					} else if (this._ch === "/" && this._input.peek() === "/") this._output.space_before_token = !0, this._input.back(), this.print_string(this._input.read(v)), this.eatWhitespace(!0);
					else if (this._ch === "$") {
						this.preserveSingleSpace(y), this.print_string(this._ch);
						var q = this._input.peekUntilAfter(/[: ,;{}()[\]\/='"]/g);
						q.match(/[ :]$/) && (q = this.eatString(": ").replace(/\s+$/, ""), this.print_string(q), this._output.space_before_token = !0), D === 0 && q.indexOf(":") !== -1 && (f = !0, this.indent());
					} else if (this._ch === "@") if (this.preserveSingleSpace(y), this._input.peek() === "{") this.print_string(this._ch + this.eatString("}"));
					else {
						this.print_string(this._ch);
						var P = this._input.peekUntilAfter(/[: ,;{}()[\]\/='"]/g);
						P.match(/[ :]$/) && (P = this.eatString(": ").replace(/\s+$/, ""), this.print_string(P), this._output.space_before_token = !0), D === 0 && P.indexOf(":") !== -1 ? (f = !0, this.indent()) : P in this.NESTED_AT_RULE ? (this._nestedLevel += 1, P in this.CONDITIONAL_GROUP_RULE && (_ = !0)) : D === 0 && !f && (C = !0);
					}
					else if (this._ch === "#" && this._input.peek() === "{") this.preserveSingleSpace(y), this.print_string(this._ch + this.eatString("}"));
					else if (this._ch === "{") f && (f = !1, this.outdent()), C = !1, _ ? (_ = !1, w = this._indentLevel >= this._nestedLevel) : w = this._indentLevel >= this._nestedLevel - 1, this._options.newline_between_rules && w && this._output.previous_line && this._output.previous_line.item(-1) !== "{" && this._output.ensure_empty_line_above("/", ","), this._output.space_before_token = !0, this._options.brace_style === "expand" ? (this._output.add_new_line(), this.print_string(this._ch), this.indent(), this._output.set_indent(this._indentLevel)) : (R === "(" ? this._output.space_before_token = !1 : R !== "," && this.indent(), this.print_string(this._ch)), this.eatWhitespace(!0), this._output.add_new_line();
					else if (this._ch === "}") this.outdent(), this._output.add_new_line(), R === "{" && this._output.trim(!0), f && (this.outdent(), f = !1), this.print_string(this._ch), w = !1, this._nestedLevel && this._nestedLevel--, this.eatWhitespace(!0), this._output.add_new_line(), this._options.newline_between_rules && !this._output.just_added_blankline() && this._input.peek() !== "}" && this._output.add_new_line(!0), this._input.peek() === ")" && (this._output.trim(!0), this._options.brace_style === "expand" && this._output.add_new_line(!0));
					else if (this._ch === ":") {
						for (var W = 0; W < this.NON_SEMICOLON_NEWLINE_PROPERTY.length; W++) if (this._input.lookBack(this.NON_SEMICOLON_NEWLINE_PROPERTY[W])) {
							S = !0;
							break;
						}
						(w || _) && !(this._input.lookBack("&") || this.foundNestedPseudoClass()) && !this._input.lookBack("(") && !C && D === 0 ? (this.print_string(":"), f || (f = !0, this._output.space_before_token = !0, this.eatWhitespace(!0), this.indent())) : (this._input.lookBack(" ") && (this._output.space_before_token = !0), this._input.peek() === ":" ? (this._ch = this._input.next(), this.print_string("::")) : this.print_string(":"));
					} else if (this._ch === "\"" || this._ch === "'") {
						var G = R === "\"" || R === "'";
						this.preserveSingleSpace(G || y), this.print_string(this._ch + this.eatString(this._ch)), this.eatWhitespace(!0);
					} else if (this._ch === ";") S = !1, D === 0 ? (f && (this.outdent(), f = !1), C = !1, this.print_string(this._ch), this.eatWhitespace(!0), this._input.peek() !== "/" && this._output.add_new_line()) : (this.print_string(this._ch), this.eatWhitespace(!0), this._output.space_before_token = !0);
					else if (this._ch === "(") if (this._input.lookBack("url")) this.print_string(this._ch), this.eatWhitespace(), D++, this.indent(), this._ch = this._input.next(), this._ch === ")" || this._ch === "\"" || this._ch === "'" ? this._input.back() : this._ch && (this.print_string(this._ch + this.eatString(")")), D && (D--, this.outdent()));
					else {
						var Z = !1;
						this._input.lookBack("with") && (Z = !0), this.preserveSingleSpace(y || Z), this.print_string(this._ch), f && R === "$" && this._options.selector_separator_newline ? (this._output.add_new_line(), z = !0) : (this.eatWhitespace(), D++, this.indent());
					}
					else if (this._ch === ")") D && (D--, this.outdent()), z && this._input.peek() === ";" && this._options.selector_separator_newline && (z = !1, this.outdent(), this._output.add_new_line()), this.print_string(this._ch);
					else if (this._ch === ",") this.print_string(this._ch), this.eatWhitespace(!0), this._options.selector_separator_newline && (!f || z) && D === 0 && !C ? this._output.add_new_line() : this._output.space_before_token = !0;
					else if ((this._ch === ">" || this._ch === "+" || this._ch === "~") && !f && D === 0) this._options.space_around_combinator ? (this._output.space_before_token = !0, this.print_string(this._ch), this._output.space_before_token = !0) : (this.print_string(this._ch), this.eatWhitespace(), this._ch && p.test(this._ch) && (this._ch = ""));
					else if (this._ch === "]") this.print_string(this._ch);
					else if (this._ch === "[") this.preserveSingleSpace(y), this.print_string(this._ch);
						...
						var ae = R === "\"" || R === "'";
						this.preserveSingleSpace(ae || y), this.print_string(this._ch), !this._output.just_added_newline() && this._input.peek() === `
` && S && this._output.add_new_line();
					}
					return this._output.get_code(E);
				}, r.exports.Beautifier = T;
			}),
			(function(r, i, s) {
				var a = s(6).Options;
				function o(l) {
...
` && (c = c.replace(/[\n]/g, o)), c;
			...
			(function(r) {
				function i(s, a, o, l) {
					this.type = s, this.text = a, this.comments_before = null, this.newlines = o || 0, this.whitespace_before = l || "", this.parent = null, this.next = null, this.previous = null, this.opened = null, this.closed = null, this.directives = null;
				}
				r.exports.Token = i;
			}),
			,
...
You passed in: '` + this.raw_options[o] + "'");
			...
			(function(r, i, s) {
				var a = s(8).InputScanner, o = s(3).Token, l = s(10).TokenStream, c = s(11).WhitespacePattern, u = {
					START: "TK_START",
					RAW: "TK_RAW",
					EOF: "TK_EOF"
				}, d = function(m, p) {
					this._input = new a(m), this._options = p || {}, this.__tokens = null, this._patterns = {}, this._patterns.whitespace = new c(this._input);
				};
				d.prototype.tokenize = function() {
					this._input.restart(), this.__tokens = new l(), this._reset();
					for (var m, p = new o(u.START, ""), b = null, g = [], v = new l(); p.type !== u.EOF;) {
						for (m = this._get_next_token(p, b); this._is_comment(m);) v.add(m), m = this._get_next_token(p, b);
						v.isEmpty() || (m.comments_before = v, v = new l()), m.parent = b, this._is_opening(m) ? (g.push(b), b = m) : b && this._is_closing(m, b) && (m.opened = b, b.closed = m, b = g.pop(), m.parent = b), m.previous = p, p.next = m, this.__tokens.add(m), p = m;
					}
					...
					return new o(m, p, this._patterns.whitespace.newline_count, this._patterns.whitespace.whitespace_before_token);
			...
			(function(r) {
				...
				i.prototype.restart = function() {
					...
					var a = null;
					return s = s || 0, s += this.__position, s >= 0 && s < this.__tokens_length && (a = this.__tokens[s]), a;
			...
			(function(r, i, s) {
				var a = s(12).Pattern;
				function o(l, c) {
					a.call(this, l, c), c ? this._line_regexp = this._input.get_regexp(c._line_regexp) : this.__set_whitespace_patterns("", ""), this.newline_count = 0, this.whitespace_before_token = "";
				}
				o.prototype = new a(), o.prototype.__set_whitespace_patterns = function(l, c) {
			...
			(function(r) {
				...
				i.prototype.read = function() {
					...
					var a = this._create();
					return a._until_after = !0, a._until_pattern = this._input.get_regexp(s), a._update(), a;
				}, i.prototype.until = function(s) {
					var a = this._create();
					return a._until_after = !1, a._until_pattern = this._input.get_regexp(s), a._update(), a;
				}, i.prototype.starting_with = function(s) {
					var a = this._create();
					return a._starting_pattern = this._input.get_regexp(s, !0), a._update(), a;
				}, i.prototype.matching = function(s) {
					var a = this._create();
					return a._match_pattern = this._input.get_regexp(s, !0), a._update(), a;
			...
			(function(r, i, s) {
				...
				function l(c, u) {
					a.call(this, c, u), this.__template_pattern = null, this._disabled = Object.assign({}, o), this._excluded = Object.assign({}, o), u && (this.__template_pattern = this._input.get_regexp(u.__template_pattern), this._excluded = Object.assign(this._excluded, u._excluded), this._disabled = Object.assign(this._disabled, u._disabled));
					var d = new a(c);
					this.__patterns = {
				...
				l.prototype = new a(), l.prototype._create = function() {
					...
					var u = this._create();
					for (var d in o) u._disabled[d] = c.templating.indexOf(d) === -1;
					return u._update(), u;
			...
			,
			(function(r, i, s) {
				var a = s(19).Beautifier, o = s(20).Options;
				function l(c, u, d, m) {
					return new a(c, u, d, m).beautify();
				}
				r.exports = l, r.exports.defaultOptions = function() {
					return new o();
				};
			...
			(function(r, i, s) {
				var a = s(20).Options, o = s(2).Output, l = s(21).Tokenizer, c = s(21).TOKEN, u = /\r\n|[\r\n]/, d = /\r\n|[\r\n]/g, m = function(w, f) {
				...
				m.prototype.current_line_has_match = function(w) {
					...
					for (var _ = 0; _ < f; _++) this.print_newline(_ > 0);
					return f !== 0;
				}, m.prototype.traverse_whitespace = function(w) {
				...
				}, m.prototype.print_newline = function(w) {
					this._output.add_new_line(w);
				}, m.prototype.print_token = function(w) {
				...
				}, m.prototype.get_full_indent = function(w) {
					return w = this.indent_level + (w || 0), w < 1 ? "" : this._output.get_indent_string(w);
				};
				var p = function(w) {
					for (var f = null, _ = w.next; _.type !== c.EOF && w.closed !== _;) {
						if (_.type === c.ATTRIBUTE && _.text === "type") {
							_.next && _.next.type === c.EQUALS && _.next.next && _.next.next.type === c.VALUE && (f = _.next.next.text);
							break;
						}
						_ = _.next;
					}
					...
					var _ = null, C = null;
					return f.closed ? (w === "script" ? _ = "text/javascript" : w === "style" && (_ = "text/css"), _ = p(f) || _, _.search("text/css") > -1 ? C = "css" : _.search(/module|((text|application|dojo)\/(x-)?(javascript|ecmascript|jscript|livescript|(ld\+)?json|method|aspect))/) > -1 ? C = "javascript" : _.search(/(text|application|dojo)\/(x-)?(html)/) > -1 ? C = "html" : _.search(/test\/null/) > -1 && (C = "null"), C) : null;
				};
				function g(w, f) {
					return f.indexOf(w) !== -1;
				}
				function v(w, f, _) {
					this.parent = w || null, this.tag = f ? f.tag_name : "", this.indent_level = _ || 0, this.parser_token = f || null;
				}
				function T(w) {
					this._printer = w, this._current_frame = null;
				}
				T.prototype.get_parser_token = function() {
					return this._current_frame ? this._current_frame.parser_token : null;
				}, T.prototype.record_tag = function(w) {
					var f = new v(this._current_frame, w, this._printer.indent_level);
					this._current_frame = f;
				}, T.prototype._try_pop_frame = function(w) {
					var f = null;
					return w && (f = w.parser_token, this._printer.indent_level = w.indent_level, this._current_frame = w.parent), f;
				}, T.prototype._get_frame = function(w, f) {
					for (var _ = this._current_frame; _ && w.indexOf(_.tag) === -1;) {
						if (f && f.indexOf(_.tag) !== -1) {
							_ = null;
							break;
						}
						_ = _.parent;
					...
					return _;
				}, T.prototype.try_pop = function(w, f) {
					var _ = this._get_frame([w], f);
					return this._try_pop_frame(_);
				}, T.prototype.indent_to_tag = function(w) {
					var f = this._get_frame(w);
					f && (this._printer.indent_level = f.indent_level);
				};
				function k(w, f, _, C) {
					this._source_text = w || "", f = f || {}, this._js_beautify = _, this._css_beautify = C, this._tag_stack = null;
					var z = new a(f, "html");
...
`, w && u.test(w) && (f = w.match(u)[0])), w = w.replace(d, `
`);
					var _ = w.match(/^[\t ]*/)[0], C = {
						text: "",
						type: ""
					}, z = new E(), L = new m(this._options, _), S = new l(w, this._options).tokenize();
					this._tag_stack = new T(L);
					for (var A = null, y = S.next(); y.type !== c.EOF;) y.type === c.TAG_OPEN || y.type === c.COMMENT ? (A = this._handle_tag_open(L, y, z, C, S), z = A) : y.type === c.ATTRIBUTE || y.type === c.EQUALS || y.type === c.VALUE || y.type === c.TEXT && !z.tag_complete ? A = this._handle_inside_tag(L, y, z, C) : y.type === c.TAG_CLOSE ? A = this._handle_tag_close(L, y, z) : y.type === c.TEXT ? A = this._handle_text(L, y, z) : y.type === c.CONTROL_FLOW_OPEN ? A = this._handle_control_flow_open(L, y) : y.type === c.CONTROL_FLOW_CLOSE ? A = this._handle_control_flow_close(L, y) : L.add_raw_token(y), C = A, y = S.next();
					return L._output.get_code(f);
				}, k.prototype._handle_control_flow_open = function(w, f) {
					var _ = {
						text: f.text,
						type: f.type
					};
					return w.set_space_before_token(f.newlines || f.whitespace_before !== "", !0), f.newlines ? w.print_preserved_newlines(f) : w.set_space_before_token(f.newlines || f.whitespace_before !== "", !0), w.print_token(f), w.indent(), _;
				}, k.prototype._handle_control_flow_close = function(w, f) {
					var _ = {
						text: f.text,
						type: f.type
					};
					return w.deindent(), f.newlines ? w.print_preserved_newlines(f) : w.set_space_before_token(f.newlines || f.whitespace_before !== "", !0), w.print_token(f), _;
				}, k.prototype._handle_tag_close = function(w, f, _) {
					var C = {
						text: f.text,
						type: f.type
					};
					return w.alignment_size = 0, _.tag_complete = !0, w.set_space_before_token(f.newlines || f.whitespace_before !== "", !0), _.is_unformatted ? w.add_raw_token(f) : (_.tag_start_char === "<" && (w.set_space_before_token(f.text[0] === "/", !0), this._is_wrap_attributes_force_expand_multiline && _.has_wrapped_attrs && w.print_newline(!1)), w.print_token(f)), _.indent_content && !(_.is_unformatted || _.is_content_unformatted) && (w.indent(), _.indent_content = !1), !_.is_inline_element && !(_.is_unformatted || _.is_content_unformatted) && w.set_wrap_point(), C;
				}, k.prototype._handle_inside_tag = function(w, f, _, C) {
					var z = _.has_wrapped_attrs, L = {
						text: f.text,
						type: f.type
					};
					return w.set_space_before_token(f.newlines || f.whitespace_before !== "", !0), _.is_unformatted ? w.add_raw_token(f) : _.tag_start_char === "{" && f.type === c.TEXT ? w.print_preserved_newlines(f) ? (f.newlines = 0, w.add_raw_token(f)) : w.print_token(f) : (f.type === c.ATTRIBUTE ? w.set_space_before_token(!0) : (f.type === c.EQUALS || f.type === c.VALUE && f.previous.type === c.EQUALS) && w.set_space_before_token(!1), f.type === c.ATTRIBUTE && _.tag_start_char === "<" && ((this._is_wrap_attributes_preserve || this._is_wrap_attributes_preserve_aligned) && (w.traverse_whitespace(f), z = z || f.newlines !== 0), this._is_wrap_attributes_force && _.attr_count >= this._options.wrap_attributes_min_attrs && (C.type !== c.TAG_OPEN || this._is_wrap_attributes_force_expand_multiline) && (w.print_newline(!1), z = !0)), w.print_token(f), z = z || w.previous_token_wrapped(), _.has_wrapped_attrs = z), L;
				}, k.prototype._handle_text = function(w, f, _) {
					var C = {
						text: f.text,
						type: "TK_CONTENT"
					};
					return _.custom_beautifier_name ? this._print_custom_beatifier_text(w, f, _) : _.is_unformatted || _.is_content_unformatted ? w.add_raw_token(f) : (w.traverse_whitespace(f), w.print_token(f)), C;
				}, k.prototype._print_custom_beatifier_text = function(w, f, _) {
					var C = this;
					if (f.text !== "") {
						var z = f.text, L, S = 1, A = "", y = "";
						_.custom_beautifier_name === "javascript" && typeof this._js_beautify == "function" ? L = this._js_beautify : _.custom_beautifier_name === "css" && typeof this._css_beautify == "function" ? L = this._css_beautify : _.custom_beautifier_name === "html" && (L = function(W, G) {
							return new k(W, G, C._js_beautify, C._css_beautify).beautify();
						}), this._options.indent_scripts === "keep" ? S = 0 : this._options.indent_scripts === "separate" && (S = -w.indent_level);
						var R = w.get_full_indent(S);
						if (z = z.replace(/\n[ \t]*$/, ""), _.custom_beautifier_name !== "html" && z[0] === "<" && z.match(/^(<!--|<!\[CDATA\[)/)) {
							var N = /^(<!--[^\n]*|<!\[CDATA\[)(\n?)([ \t\n]*)([\s\S]*)(-->|]]>)$/.exec(z);
							if (!N) {
								w.add_raw_token(f);
								return;
							...
							A = R + N[1] + `
`, z = N[4], N[5] && (y = R + N[5]), z = z.replace(/\n[ \t]*$/, ""), (N[2] || N[3].indexOf(`
`) !== -1) && (N = N[3].match(/[ \t]+$/), N && (f.whitespace_before = N[0]));
						}
						if (z) if (L) {
							var H = function() {
								this.eol = `
`;
							...
							var P = f.whitespace_before;
							P && (z = z.replace(new RegExp(`
(` + P + ")?", "g"), `
`)), z = R + z.replace(/\n/g, `
` + R);
						}
						A && (z ? z = A + z + `
` + y : z = A + y), w.print_newline(!1), z && (f.text = z, f.whitespace_before = "", f.newlines = 0, w.add_raw_token(f), w.print_newline(!0));
					}
				}, k.prototype._handle_tag_open = function(w, f, _, C, z) {
					var L = this._get_tag_open_token(f);
					if ((_.is_unformatted || _.is_content_unformatted) && !_.is_empty_element && f.type === c.TAG_OPEN && !L.is_start_tag ? (w.add_raw_token(f), L.start_tag_token = this._tag_stack.try_pop(L.tag_name)) : (w.traverse_whitespace(f), this._set_tag_position(w, f, L, _, C), L.is_inline_element || w.set_wrap_point(), w.print_token(f)), L.is_start_tag && this._is_wrap_attributes_force) {
						var S = 0, A;
						do
							A = z.peek(S), A.type === c.ATTRIBUTE && (L.attr_count += 1), S += 1;
						while (A.type !== c.EOF && A.type !== c.TAG_CLOSE);
					}
					return (this._is_wrap_attributes_force_aligned || this._is_wrap_attributes_aligned_multiple || this._is_wrap_attributes_preserve_aligned) && (L.alignment_size = f.text.length + 1), !L.tag_complete && !L.is_unformatted && (w.alignment_size = L.alignment_size), L;
				};
				var E = function(w, f) {
					if (this.parent = w || null, this.text = "", this.type = "TK_TAG_OPEN", this.tag_name = "", this.is_inline_element = !1, this.is_unformatted = !1, this.is_content_unformatted = !1, this.is_empty_element = !1, this.is_start_tag = !1, this.is_end_tag = !1, this.indent_content = !1, this.multiline_content = !1, this.custom_beautifier_name = null, this.start_tag_token = null, this.attr_count = 0, this.has_wrapped_attrs = !1, this.alignment_size = 0, this.tag_complete = !1, this.tag_start_char = "", this.tag_check = "", !f) this.tag_complete = !0;
						...
						var _;
						this.tag_start_char = f.text[0], this.text = f.text, this.tag_start_char === "<" ? (_ = f.text.match(/^<([^\s>]*)/), this.tag_check = _ ? _[1] : "") : (_ = f.text.match(/^{{~?(?:[\^]|#\*?)?([^\s}]+)/), this.tag_check = _ ? _[1] : "", (f.text.startsWith("{{#>") || f.text.startsWith("{{~#>")) && this.tag_check[0] === ">" && (this.tag_check === ">" && f.next !== null ? this.tag_check = f.next.text.split(" ")[0] : this.tag_check = f.text.split(">")[1])), this.tag_check = this.tag_check.toLowerCase(), f.type === c.COMMENT && (this.tag_complete = !0), this.is_start_tag = this.tag_check.charAt(0) !== "/", this.tag_name = this.is_start_tag ? this.tag_check : this.tag_check.substr(1), this.is_end_tag = !this.is_start_tag || f.closed && f.closed.text === "/>";
						var C = 2;
						this.tag_start_char === "{" && this.text.length >= 3 && this.text.charAt(2) === "~" && (C = 3), this.is_end_tag = this.is_end_tag || this.tag_start_char === "{" && (this.text.length < 3 || /[^#\^]/.test(this.text.charAt(C)));
					}
				};
				k.prototype._get_tag_open_token = function(w) {
				...
				}, k.prototype._set_tag_position = function(w, f, _, C, z) {
					if (_.is_empty_element || (_.is_end_tag ? _.start_tag_token = this._tag_stack.try_pop(_.tag_name) : (this._do_optional_end_element(_) && (_.is_inline_element || w.print_newline(!1)), this._tag_stack.record_tag(_), (_.tag_name === "script" || _.tag_name === "style") && !(_.is_unformatted || _.is_content_unformatted) && (_.custom_beautifier_name = b(_.tag_check, f)))), g(_.tag_check, this._options.extra_liners) && (w.print_newline(!1), w._output.just_added_blankline() || w.print_newline(!0)), _.is_empty_element) _.tag_start_char === "{" && _.tag_check === "else" && (this._tag_stack.indent_to_tag([
						"if",
						"unless",
						"each"
					]), _.indent_content = !0, w.current_line_has_match(/{{#if/) || w.print_newline(!1)), _.tag_name === "!--" && z.type === c.TAG_CLOSE && C.is_end_tag && _.text.indexOf(`
`) === -1 || (_.is_inline_element || _.is_unformatted || w.print_newline(!1), this._calcluate_parent_multiline(w, _));
					else if (_.is_end_tag) {
						var L = !1;
						L = _.start_tag_token && _.start_tag_token.multiline_content, L = L || !_.is_inline_element && !(C.is_inline_element || C.is_unformatted) && !(z.type === c.TAG_CLOSE && _.start_tag_token === C) && z.type !== "TK_CONTENT", (_.is_content_unformatted || _.is_unformatted) && (L = !1), L && w.print_newline(!1);
					} else _.indent_content = !_.custom_beautifier_name, _.tag_start_char === "<" && (_.tag_name === "html" ? _.indent_content = this._options.indent_inner_html : _.tag_name === "head" ? _.indent_content = this._options.indent_head_inner_html : _.tag_name === "body" && (_.indent_content = this._options.indent_body_inner_html)), !(_.is_inline_element || _.is_unformatted) && (z.type !== "TK_CONTENT" || _.is_content_unformatted) && w.print_newline(!1), this._calcluate_parent_multiline(w, _);
				}, k.prototype._calcluate_parent_multiline = function(w, f) {
				...
				k.prototype._do_optional_end_element = function(w) {
					var f = null;
					if (!(w.is_empty_element || !w.is_start_tag || !w.parent)) {
						if (w.tag_name === "body") f = f || this._tag_stack.try_pop("head");
						else if (w.tag_name === "li") f = f || this._tag_stack.try_pop("li", [
							"ol",
							"ul",
							"menu"
						]);
						else if (w.tag_name === "dd" || w.tag_name === "dt") f = f || this._tag_stack.try_pop("dt", ["dl"]), f = f || this._tag_stack.try_pop("dd", ["dl"]);
						else if (w.parent.tag_name === "p" && I.indexOf(w.tag_name) !== -1) {
							var _ = w.parent.parent;
							(!_ || D.indexOf(_.tag_name) === -1) && (f = f || this._tag_stack.try_pop("p"));
						} else w.tag_name === "rp" || w.tag_name === "rt" ? (f = f || this._tag_stack.try_pop("rt", ["ruby", "rtc"]), f = f || this._tag_stack.try_pop("rp", ["ruby", "rtc"])) : w.tag_name === "optgroup" ? f = f || this._tag_stack.try_pop("optgroup", ["select"]) : w.tag_name === "option" ? f = f || this._tag_stack.try_pop("option", [
							"select",
							"datalist",
							"optgroup"
						]) : w.tag_name === "colgroup" ? f = f || this._tag_stack.try_pop("caption", ["table"]) : w.tag_name === "thead" ? (f = f || this._tag_stack.try_pop("caption", ["table"]), f = f || this._tag_stack.try_pop("colgroup", ["table"])) : w.tag_name === "tbody" || w.tag_name === "tfoot" ? (f = f || this._tag_stack.try_pop("caption", ["table"]), f = f || this._tag_stack.try_pop("colgroup", ["table"]), f = f || this._tag_stack.try_pop("thead", ["table"]), f = f || this._tag_stack.try_pop("tbody", ["table"])) : w.tag_name === "tr" ? (f = f || this._tag_stack.try_pop("caption", ["table"]), f = f || this._tag_stack.try_pop("colgroup", ["table"]), f = f || this._tag_stack.try_pop("tr", [
							"table",
							"thead",
							"tbody",
							"tfoot"
						])) : (w.tag_name === "th" || w.tag_name === "td") && (f = f || this._tag_stack.try_pop("td", [
							"table",
							"thead",
							"tbody",
							"tfoot",
			...
			(function(r, i, s) {
				var a = s(6).Options;
				function o(l) {
					a.call(this, l, "html"), this.templating.length === 1 && this.templating[0] === "auto" && (this.templating = [
						"django",
						"erb",
						"handlebars",
						"php"
			...
			(function(r, i, s) {
				var a = s(9).Tokenizer, o = s(9).TOKEN, l = s(13).Directives, c = s(14).TemplatablePattern, u = s(12).Pattern, d = {
					...
					RAW: o.RAW,
					EOF: o.EOF
				}, m = new l(/<\!--/, /-->/), p = function(b, g) {
					a.call(this, b, g), this._current_tag_name = "";
					var v = new c(this._input).read_options(this._options), T = new u(this._input);
					if (this.__patterns = {
						word: v.until(/[\n\r\t <]/),
						...
						angular_control_flow_start: T.matching(/\@[a-zA-Z]+[^({]*[({]/),
						handlebars_comment: T.starting_with(/{{!--/).until_after(/--}}/),
						handlebars: T.starting_with(/{{/).until_after(/}}/),
						handlebars_open: T.until(/[\n\r\t }]/),
						handlebars_raw_close: T.until(/}}/),
						comment: T.starting_with(/<!--/).until_after(/-->/),
						cdata: T.starting_with(/<!\[CDATA\[/).until_after(/]]>/),
						conditional_comment: T.starting_with(/<!\[/).until_after(/]>/),
						processing: T.starting_with(/<\?/).until_after(/\?>/)
						...
						this.__patterns.unformatted_content_delimiter = T.matching(k).until_after(k);
					}
				};
				p.prototype = new a(), p.prototype._is_comment = function(b) {
					return !1;
				}, p.prototype._is_opening = function(b) {
					return b.type === d.TAG_OPEN || b.type === d.CONTROL_FLOW_OPEN;
				}, p.prototype._is_closing = function(b, g) {
					return b.type === d.TAG_CLOSE && g && ((b.text === ">" || b.text === "/>") && g.text[0] === "<" || b.text === "}}" && g.text[0] === "{" && g.text[1] === "{") || b.type === d.CONTROL_FLOW_CLOSE && b.text === "}" && g.text.endsWith("{");
				}, p.prototype._reset = function() {
					this._current_tag_name = "";
				}, p.prototype._get_next_token = function(b, g) {
					var v = null;
					this._readWhitespace();
					var T = this._input.peek();
					return T === null ? this._create_token(d.EOF, "") : (v = v || this._read_open_handlebars(T, g), v = v || this._read_attribute(T, b, g), v = v || this._read_close(T, g), v = v || this._read_control_flows(T, g), v = v || this._read_raw_content(T, b, g), v = v || this._read_content_word(T, g), v = v || this._read_comment_or_cdata(T), v = v || this._read_processing(T), v = v || this._read_open(T, g), v = v || this._create_token(d.UNKNOWN, this._input.next()), v);
				}, p.prototype._read_comment_or_cdata = function(b) {
					var g = null, v = null, T = null;
					return b === "<" && (this._input.peek(1) === "!" && (v = this.__patterns.comment.read(), v ? (T = m.get_directives(v), T && T.ignore === "start" && (v += m.readIgnored(this._input))) : v = this.__patterns.cdata.read()), v && (g = this._create_token(d.COMMENT, v), g.directives = T)), g;
				}, p.prototype._read_processing = function(b) {
					var g = null, v = null, T = null;
					if (b === "<") {
						var k = this._input.peek(1);
						(k === "!" || k === "?") && (v = this.__patterns.conditional_comment.read(), v = v || this.__patterns.processing.read()), v && (g = this._create_token(d.COMMENT, v), g.directives = T);
					}
					return g;
				}, p.prototype._read_open = function(b, g) {
					var v = null, T = null;
					return (!g || g.type === d.CONTROL_FLOW_OPEN) && b === "<" && (v = this._input.next(), this._input.peek() === "/" && (v += this._input.next()), v += this.__patterns.element_name.read(), T = this._create_token(d.TAG_OPEN, v)), T;
				}, p.prototype._read_open_handlebars = function(b, g) {
					var v = null, T = null;
					return (!g || g.type === d.CONTROL_FLOW_OPEN) && this._options.indent_handlebars && b === "{" && this._input.peek(1) === "{" && (this._input.peek(2) === "!" ? (v = this.__patterns.handlebars_comment.read(), v = v || this.__patterns.handlebars.read(), T = this._create_token(d.COMMENT, v)) : (v = this.__patterns.handlebars_open.read(), T = this._create_token(d.TAG_OPEN, v))), T;
				}, p.prototype._read_control_flows = function(b, g) {
					var v = "", T = null;
					if (!this._options.templating.includes("angular") || !this._options.indent_handlebars) return T;
					if (b === "@") {
						if (v = this.__patterns.angular_control_flow_start.read(), v === "") return T;
						for (var k = v.endsWith("(") ? 1 : 0, E = 0; !(v.endsWith("{") && k === E);) {
							var I = this._input.next();
							if (I === null) break;
							I === "(" ? k++ : I === ")" && E++, v += I;
						}
						T = this._create_token(d.CONTROL_FLOW_OPEN, v);
					} else b === "}" && g && g.type === d.CONTROL_FLOW_OPEN && (v = this._input.next(), T = this._create_token(d.CONTROL_FLOW_CLOSE, v));
					return T;
				}, p.prototype._read_close = function(b, g) {
					var v = null, T = null;
					return g && g.type === d.TAG_OPEN && (g.text[0] === "<" && (b === ">" || b === "/" && this._input.peek(1) === ">") ? (v = this._input.next(), b === "/" && (v += this._input.next()), T = this._create_token(d.TAG_CLOSE, v)) : g.text[0] === "{" && b === "}" && this._input.peek(1) === "}" && (this._input.next(), this._input.next(), T = this._create_token(d.TAG_CLOSE, "}}"))), T;
				}, p.prototype._read_attribute = function(b, g, v) {
					var T = null, k = "";
					if (v && v.text[0] === "<") if (b === "=") T = this._create_token(d.EQUALS, this._input.next());
					else if (b === "\"" || b === "'") {
						var E = this._input.next();
						b === "\"" ? E += this.__patterns.double_quote.read() : E += this.__patterns.single_quote.read(), T = this._create_token(d.VALUE, E);
					} else k = this.__patterns.attribute.read(), k && (g.type === d.EQUALS ? T = this._create_token(d.VALUE, k) : T = this._create_token(d.ATTRIBUTE, k));
					return T;
				...
				}, p.prototype._read_raw_content = function(b, g, v) {
					var T = "";
					if (v && v.text[0] === "{") T = this.__patterns.handlebars_raw_close.read();
					else if (g.type === d.TAG_CLOSE && g.opened.text[0] === "<" && g.text[0] !== "/") {
						var k = g.opened.text.substr(1).toLowerCase();
						if (k === "script" || k === "style") {
							var E = this._read_comment_or_cdata(b);
							if (E) return E.type = d.TEXT, E;
							T = this._input.readUntil(new RegExp("</" + k + "[\\n\\r\\t ]*?>", "ig"));
						} else this._is_content_unformatted(k) && (T = this._input.readUntil(new RegExp("</" + k + "[\\n\\r\\t ]*?>", "ig")));
					}
					return T ? this._create_token(d.TEXT, T) : null;
				}, p.prototype._read_content_word = function(b, g) {
					var v = "";
					if (this._options.unformatted_content_delimiter && b === this._options.unformatted_content_delimiter[0] && (v = this.__patterns.unformatted_content_delimiter.read()), v || (v = g && g.type === d.CONTROL_FLOW_OPEN ? this.__patterns.word_control_flow_close_excluded.read() : this.__patterns.word.read()), v) return this._create_token(d.TEXT, v);
	...
	function pu(e, t, n) {
		...
		if (t) {
			...
			for (; m < r.length && Za(r, m);) m++;
			(m === r.length || Qa(r, m)) && (d = m), t = $.create(e.positionAt(c), e.positionAt(d));
		...
		} else t = $.create(ie.create(0, 0), e.positionAt(r.length));
		const o = {
			indent_size: a,
			indent_char: n.insertSpaces ? " " : "	",
			indent_empty_lines: pe(n, "indentEmptyLines", !1),
			wrap_line_length: pe(n, "wrapLineLength", 120),
			unformatted: wi(n, "unformatted", void 0),
			content_unformatted: wi(n, "contentUnformatted", void 0),
			...
			extra_liners: wi(n, "extraLiners", void 0),
...
`,
		...
		let l = fu(gu(r), o);
		if (s > 0) {
			const c = n.insertSpaces ? $a(" ", a * s) : $a("	", s);
			l = l.split(`
`).join(`
...
`.indexOf(e.charAt(t)) !== -1;
	...
	(() => {
		var e = { 470: (i) => {
			...
			function a(l, c) {
				for (var u, d = "", m = 0, p = -1, b = 0, g = 0; g <= l.length; ++g) {
					...
					if (u === 47) {
						if (!(p === g - 1 || b === 1)) if (p !== g - 1 && b === 2) {
							if (d.length < 2 || m !== 2 || d.charCodeAt(d.length - 1) !== 46 || d.charCodeAt(d.length - 2) !== 46) {
								if (d.length > 2) {
									var v = d.lastIndexOf("/");
									if (v !== d.length - 1) {
										v === -1 ? (d = "", m = 0) : m = (d = d.slice(0, v)).length - 1 - d.lastIndexOf("/"), p = g, b = 0;
										continue;
									}
						...
						} else d.length > 0 ? d += "/" + l.slice(p + 1, g) : d = l.slice(p + 1, g), m = g - p - 1;
						p = g, b = 0;
					} else u === 46 && b !== -1 ? ++b : b = -1;
				}
				return d;
			...
			var o = {
				...
				relative: function(l, c) {
					...
					for (var b = c.length - p, g = m < b ? m : b, v = -1, T = 0; T <= g; ++T) {
						if (T === g) {
							if (b > g) {
								if (c.charCodeAt(p + T) === 47) return c.slice(p + T + 1);
								if (T === 0) return c.slice(p + T);
							} else m > g && (l.charCodeAt(u + T) === 47 ? v = T : T === 0 && (v = 0));
							break;
						}
						var k = l.charCodeAt(u + T);
						if (k !== c.charCodeAt(p + T)) break;
						k === 47 && (v = T);
					}
					var E = "";
					for (T = u + v + 1; T <= d; ++T) T !== d && l.charCodeAt(T) !== 47 || (E.length === 0 ? E += ".." : E += "/..");
					return E.length > 0 ? E + c.slice(p + v) : (p += v, c.charCodeAt(p) === 47 && ++p, c.slice(p));
				},
				...
				basename: function(l, c) {
					...
					if (c !== void 0 && c.length > 0 && c.length <= l.length) {
						...
						for (u = l.length - 1; u >= 0; --u) {
							...
							} else g === -1 && (p = !1, g = u + 1), b >= 0 && (v === c.charCodeAt(b) ? --b == -1 && (m = u) : (b = -1, m = g));
						}
						return d === m ? m = g : m === -1 && (m = l.length), l.slice(d, m);
					}
				...
				extname: function(l) {
					...
					for (var c = -1, u = 0, d = -1, m = !0, p = 0, b = l.length - 1; b >= 0; --b) {
						...
						if (g !== 47) d === -1 && (m = !1, d = b + 1), g === 46 ? c === -1 ? c = b : p !== 1 && (p = 1) : c !== -1 && (p = -1);
						else if (!m) {
							u = b + 1;
							break;
						}
				...
				parse: function(l) {
					...
					m ? (c.root = "/", u = 1) : u = 0;
					for (var p = -1, b = 0, g = -1, v = !0, T = l.length - 1, k = 0; T >= u; --T) if ((d = l.charCodeAt(T)) !== 47) g === -1 && (v = !1, g = T + 1), d === 46 ? p === -1 ? p = T : k !== 1 && (k = 1) : p !== -1 && (k = -1);
					else if (!v) {
						b = T + 1;
						break;
					}
					return p === -1 || g === -1 || k === 0 || k === 1 && p === g - 1 && p === b + 1 ? g !== -1 && (c.base = c.name = b === 0 && m ? l.slice(1, g) : l.slice(b, g)) : (b === 0 && m ? (c.name = l.slice(1, p), c.base = l.slice(1, g)) : (c.name = l.slice(b, p), c.base = l.slice(b, g)), c.ext = l.slice(p, g)), b > 0 ? c.dir = l.slice(0, b - 1) : m && (c.dir = "/"), c;
				},
				sep: "/",
				delimiter: ":",
				win32: null,
		...
		(() => {
			...
			const s = /^\w[\w\d+.-]*$/, a = /^\//, o = /^\/\//;
			function l(L, S) {
				if (!L.scheme && S) throw new Error(`[UriError]: Scheme is missing: {scheme: "", authority: "${L.authority}", path: "${L.path}", query: "${L.query}", fragment: "${L.fragment}"}`);
				if (L.scheme && !s.test(L.scheme)) throw new Error("[UriError]: Scheme contains illegal characters.");
				if (L.path) {
					if (L.authority) {
						if (!a.test(L.path)) throw new Error("[UriError]: If a URI contains an authority component, then the path component must either be empty or begin with a slash (\"/\") character");
			...
			class m {
				static isUri(S) {
					return S instanceof m || !!S && typeof S.authority == "string" && typeof S.fragment == "string" && typeof S.path == "string" && typeof S.query == "string" && typeof S.scheme == "string" && typeof S.fsPath == "string" && typeof S.with == "function" && typeof S.toString == "function";
				}
				scheme;
				authority;
				path;
				query;
				fragment;
				constructor(S, A, y, R, N, H = !1) {
					typeof S == "object" ? (this.scheme = S.scheme || c, this.authority = S.authority || c, this.path = S.path || c, this.query = S.query || c, this.fragment = S.fragment || c) : (this.scheme = (function(q, P) {
						return q || P ? q : "file";
					})(S, H), this.authority = A || c, this.path = (function(q, P) {
						switch (q) {
							case "https":
							case "http":
							case "file": P ? P[0] !== u && (P = u + P) : P = u;
						}
						return P;
					})(this.scheme, y || c), this.query = R || c, this.fragment = N || c, l(this, H));
				}
				get fsPath() {
					return k(this);
				}
				with(S) {
					if (!S) return this;
					let { scheme: A, authority: y, path: R, query: N, fragment: H } = S;
					return A === void 0 ? A = this.scheme : A === null && (A = c), y === void 0 ? y = this.authority : y === null && (y = c), R === void 0 ? R = this.path : R === null && (R = c), N === void 0 ? N = this.query : N === null && (N = c), H === void 0 ? H = this.fragment : H === null && (H = c), A === this.scheme && y === this.authority && R === this.path && N === this.query && H === this.fragment ? this : new b(A, y, R, N, H);
				}
				static parse(S, A = !1) {
					const y = d.exec(S);
					return y ? new b(y[2] || c, w(y[4] || c), w(y[5] || c), w(y[7] || c), w(y[9] || c), A) : new b(c, c, c, c, c);
				}
				static file(S) {
					let A = c;
					if (i && (S = S.replace(/\\/g, u)), S[0] === u && S[1] === u) {
						const y = S.indexOf(u, 2);
						y === -1 ? (A = S.substring(2), S = u) : (A = S.substring(2, y), S = S.substring(y) || u);
					}
					return new b("file", A, S, c, c);
				}
				static from(S) {
					const A = new b(S.scheme, S.authority, S.path, S.query, S.fragment);
					return l(A, !0), A;
				}
				toString(S = !1) {
					return E(this, S);
				...
				static revive(S) {
					if (S) {
						...
						{
							const A = new b(S);
							return A._formatted = S.external, A._fsPath = S._sep === p ? S.fsPath : null, A;
						}
					}
					return S;
				}
			...
			class b extends m {
				...
				toString(S = !1) {
					return S ? E(this, !0) : (this._formatted || (this._formatted = E(this, !1)), this._formatted);
				}
				toJSON() {
					const S = { $mid: 1 };
					return this._fsPath && (S.fsPath = this._fsPath, S._sep = p), this._formatted && (S.external = this._formatted), this.path && (S.path = this.path), this.scheme && (S.scheme = this.scheme), this.authority && (S.authority = this.authority), this.query && (S.query = this.query), this.fragment && (S.fragment = this.fragment), S;
				}
			}
			const g = {
				58: "%3A",
			...
			function v(L, S, A) {
				...
				for (let N = 0; N < L.length; N++) {
					const H = L.charCodeAt(N);
					if (H >= 97 && H <= 122 || H >= 65 && H <= 90 || H >= 48 && H <= 57 || H === 45 || H === 46 || H === 95 || H === 126 || S && H === 47 || A && H === 91 || A && H === 93 || A && H === 58) R !== -1 && (y += encodeURIComponent(L.substring(R, N)), R = -1), y !== void 0 && (y += L.charAt(N));
					else {
						y === void 0 && (y = L.substr(0, N));
						const q = g[H];
						q !== void 0 ? (R !== -1 && (y += encodeURIComponent(L.substring(R, N)), R = -1), y += q) : R === -1 && (R = N);
					}
				}
				return R !== -1 && (y += encodeURIComponent(L.substring(R))), y !== void 0 ? y : L;
			}
			function T(L) {
				let S;
				for (let A = 0; A < L.length; A++) {
					const y = L.charCodeAt(A);
					y === 35 || y === 63 ? (S === void 0 && (S = L.substr(0, A)), S += g[y]) : S !== void 0 && (S += L[A]);
				}
				return S !== void 0 ? S : L;
			}
			function k(L, S) {
				let A;
				return A = L.authority && L.path.length > 1 && L.scheme === "file" ? `//${L.authority}${L.path}` : L.path.charCodeAt(0) === 47 && (L.path.charCodeAt(1) >= 65 && L.path.charCodeAt(1) <= 90 || L.path.charCodeAt(1) >= 97 && L.path.charCodeAt(1) <= 122) && L.path.charCodeAt(2) === 58 ? L.path[1].toLowerCase() + L.path.substr(2) : L.path, i && (A = A.replace(/\//g, "\\")), A;
			}
			function E(L, S) {
				const A = S ? T : v;
				let y = "", { scheme: R, authority: N, path: H, query: q, fragment: P } = L;
				if (R && (y += R, y += ":"), (N || R === "file") && (y += u, y += u), N) {
					let W = N.indexOf("@");
					if (W !== -1) {
						const G = N.substr(0, W);
						N = N.substr(W + 1), W = G.lastIndexOf(":"), W === -1 ? y += A(G, !1, !1) : (y += A(G.substr(0, W), !1, !1), y += ":", y += A(G.substr(W + 1), !1, !0)), y += "@";
					}
					N = N.toLowerCase(), W = N.lastIndexOf(":"), W === -1 ? y += A(N, !1, !0) : (y += A(N.substr(0, W), !1, !0), y += N.substr(W));
				}
				if (H) {
					if (H.length >= 3 && H.charCodeAt(0) === 47 && H.charCodeAt(2) === 58) {
						const W = H.charCodeAt(1);
						W >= 65 && W <= 90 && (H = `/${String.fromCharCode(W + 32)}:${H.substr(3)}`);
					} else if (H.length >= 2 && H.charCodeAt(1) === 58) {
						const W = H.charCodeAt(0);
						W >= 65 && W <= 90 && (H = `${String.fromCharCode(W + 32)}:${H.substr(2)}`);
					}
					y += A(H, !0, !1);
				}
				return q && (y += "?", y += A(q, !1, !1)), P && (y += "#", y += S ? P : v(P, !1, !1)), y;
			}
			function I(L) {
				try {
					return decodeURIComponent(L);
				} catch {
					return L.length > 3 ? L.substr(0, 3) + I(L.substr(3)) : L;
				}
			}
			const D = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
			function w(L) {
				return L.match(D) ? L.replace(D, ((S) => I(S))) : L;
			}
			var f = n(470);
			const _ = f.posix || f, C = "/";
			var z;
			(function(L) {
				L.joinPath = function(S, ...A) {
					return S.with({ path: _.join(S.path, ...A) });
				}, L.resolvePath = function(S, ...A) {
					let y = S.path, R = !1;
					y[0] !== C && (y = C + y, R = !0);
					let N = _.resolve(y, ...A);
					return R && N[0] === C && !S.authority && (N = N.substring(1)), S.with({ path: N });
				}, L.dirname = function(S) {
					if (S.path.length === 0 || S.path === C) return S;
					let A = _.dirname(S.path);
					return A.length === 1 && A.charCodeAt(0) === 46 && (A = ""), S.with({ path: A });
				}, L.basename = function(S) {
					return _.basename(S.path);
				}, L.extname = function(S) {
					return _.extname(S.path);
				};
			})(z || (z = {}));
		})(), Ka = r;
	})();
	const { URI: _u, Utils: md } = Ka;
	function _i(e) {
		const t = e[0];
	...
	function yu(e, t, n, r) {
		...
		return /^\#/i.test(t) ? e + t : /^\/\//i.test(t) ? (We(e, "https://") ? "https" : "http") + ":" + t.replace(/^\s*/g, "") : n ? n.resolveReference(t, r || e) : t;
	}
	function Tu(e, t, n, r, i, s) {
		const a = _i(n);
		if (!vu(a, e.languageId)) return;
		a.length < n.length && (r++, i--);
		const o = yu(e.uri, a, t, s);
		if (!o) return;
		const l = Su(o, e);
		return {
			range: $.create(e.positionAt(r), e.positionAt(i)),
			target: l
		};
	}
	const ku = 35;
	function Su(e, t) {
		try {
			let n = _u.parse(e);
			return n.scheme === "file" && n.query && (n = n.with({ query: null }), e = n.toString(!0)), n.scheme === "file" && n.fragment && !(e.startsWith(t.uri) && e.charCodeAt(t.uri.length) === ku) ? n.with({ fragment: null }).toString(!0) : e;
		} catch {
			return;
		}
	}
	var Lu = class {
		...
		findDocumentLinks(e, t) {
			const n = [], r = fe(e.getText(), 0);
			let i = r.scan(), s, a, o = !1, l;
			const c = {};
			for (; i !== U.EOS;) {
				switch (i) {
					case U.StartTag:
						a = r.getTokenText().toLowerCase(), l || (o = a === "base");
						break;
					case U.AttributeName:
					...
					case U.AttributeValue:
						if (a && s && this.dataManager.isPathAttribute(a, s)) {
							...
							if (!o) {
								const d = Tu(e, t, u, r.getTokenOffset(), r.getTokenEnd(), l);
								d && n.push(d);
							}
							o && typeof l > "u" && (l = _i(u), l && t && (l = t.resolveReference(l, e.uri))), o = !1, s = void 0;
						} else if (s === "id") {
							const u = _i(r.getTokenText());
	...
	function xu(e, t, n) {
		...
		if (!i.tag) return [];
		const s = [], a = no(U.StartTag, e, i.start), o = typeof i.endTagStart == "number" && no(U.EndTag, e, i.endTagStart);
		return (a && to(a, t) || o && to(o, t)) && (a && s.push({
			kind: en.Read,
			range: a
		}), o && s.push({
			kind: en.Read,
	...
	function no(e, t, n) {
		const r = fe(t.getText(), n);
		let i = r.scan();
		for (; i !== U.EOS && i !== e;) i = r.scan();
		return i !== U.EOS ? {
	...
	function Au(e, t) {
		...
		return n;
		function i(s, a) {
			const o = hi.create(s.name, s.kind, s.range, e.uri, a?.name);
			if (o.containerName ?? (o.containerName = ""), n.push(o), s.children) for (const l of s.children) i(l, s);
		}
	}
	function io(e, t) {
		const n = [];
	...
	function ro(e, t, n) {
		const r = Ru(t), i = $.create(e.positionAt(t.start), e.positionAt(t.end)), s = ui.create(r, void 0, ci.Field, i, i);
	...
	function Mu(e, t, n, r) {
		...
		if (!s.tag || !Eu(s, i, s.tag)) return null;
		const a = [], o = {
	...
	function so(e, t, n) {
		...
		return i.endTagStart && (i.start + 1 <= r && r <= i.start + 1 + s || i.endTagStart + 2 <= r && r <= i.endTagStart + 2 + s) ? [$.create(e.positionAt(i.start + 1), e.positionAt(i.start + 1 + s)), $.create(e.positionAt(i.endTagStart + 2), e.positionAt(i.endTagStart + 2 + s))] : null;
	}
	var Cu = class {
		constructor(e) {
			this.dataManager = e;
		...
		limitRanges(e, t) {
			...
			for (let u = 0; u < e.length; u++) {
				...
				if (!n) n = d, a(u, 0);
					...
					if (d.endLine <= n.endLine) r.push(n), n = d, a(u, r.length);
					else if (d.startLine > n.endLine) {
						do
							n = r.pop();
						while (n && d.startLine > n.endLine);
						n && r.push(n), n = d, a(u, r.length);
					}
				}
			}
			let o = 0, l = 0;
			...
			for (let u = 0; u < e.length; u++) {
				const d = i[u];
				typeof d == "number" && (d < l || d === l && o++ < t) && c.push(e[u]);
			}
			return c;
		}
		getFoldingRanges(e, t) {
			const n = this.dataManager.getVoidElements(e.languageId), r = fe(e.getText());
			let i = r.scan();
			const s = [], a = [];
			let o = null, l = -1;
			function c(d) {
			...
			for (; i !== U.EOS;) {
				switch (i) {
					...
					case U.EndTag:
						o = r.getTokenText();
						break;
					case U.StartTagClose: if (!o || !this.dataManager.isVoidElement(o, n)) break;
					case U.EndTagClose:
					case U.StartTagSelfClose: {
						let d = a.length - 1;
						for (; d >= 0 && a[d].tagName !== o;) d--;
						if (d >= 0) {
							const m = a[d];
							a.length = d;
							const p = e.positionAt(r.getTokenOffset()).line, b = m.startLine, g = p - 1;
							g > b && l !== b && c({
								startLine: b,
								endLine: g
							});
					...
					case U.Comment: {
						...
						if (m) if (m[1]) a.push({
							...
							let p = a.length - 1;
							for (; p >= 0 && a[p].tagName.length;) p--;
							if (p >= 0) {
								const b = a[p];
								a.length = p;
								const g = d;
								d = b.startLine, g > d && l !== d && c({
									startLine: d,
									endLine: g,
									kind: Qt.Region
								});
		...
		getSelectionRange(e, t, n) {
			...
			for (let a = r.length - 1; a >= 0; a--) {
				const o = r[a];
				(!i || o[0] !== i[0] || o[1] !== i[1]) && (s = nn.create($.create(t.positionAt(r[a][0]), t.positionAt(r[a][1])), s)), i = o;
			}
			return s || (s = nn.create($.create(e, e))), s;
		}
		getApplicableRanges(e, t, n) {
			...
			if (i.startTagEnd && !i.endTagStart) {
				...
				const a = $.create(e.positionAt(i.startTagEnd - 2), e.positionAt(i.startTagEnd));
				return e.getText(a) === "/>" ? s.unshift([i.start + 1, i.startTagEnd - 2]) : s.unshift([i.start + 1, i.startTagEnd - 1]), s = this.getAttributeLevelRanges(e, i, r).concat(s), s;
			}
		...
		getAttributeLevelRanges(e, t, n) {
			const r = $.create(e.positionAt(t.start), e.positionAt(t.end)), i = e.getText(r), s = n - t.start, a = fe(i);
			let o = a.scan();
			const l = t.start, c = [];
			let u = !1, d = -1;
			for (; o !== U.EOS;) {
				switch (o) {
					case U.AttributeName:
						...
						s <= a.getTokenEnd() && c.unshift([a.getTokenOffset(), a.getTokenEnd()]), u = !0, d = a.getTokenOffset();
						break;
					case U.AttributeValue: {
						if (!u) break;
						const m = a.getTokenText();
						if (s < a.getTokenOffset()) {
							c.push([d, a.getTokenEnd()]);
							break;
						}
						s >= a.getTokenOffset() && s <= a.getTokenEnd() && (c.unshift([a.getTokenOffset(), a.getTokenEnd()]), (m[0] === "\"" && m[m.length - 1] === "\"" || m[0] === "'" && m[m.length - 1] === "'") && s >= a.getTokenOffset() + 1 && s <= a.getTokenEnd() - 1 && c.unshift([a.getTokenOffset() + 1, a.getTokenEnd() - 1]), c.push([d, a.getTokenEnd()]));
						break;
					}
				}
				o = a.scan();
...
*   a _positive value_ means that the element should be focusable and reachable via sequential keyboard navigation; the order in which the elements are focused is the increasing value of the [**tabindex**](#attr-tabindex). If several elements share the same tabindex, their relative order follows their relative positions in the document.`
	...
	var Hu = class {
		...
		setDataProviders(e, t) {
			this.dataProviders = [], e && this.dataProviders.push(new Ga("html5", zu)), this.dataProviders.push(...t);
		}
		getDataProviders() {
			return this.dataProviders;
		}
		isVoidElement(e, t) {
			return !!e && Bh(t, e.toLowerCase(), (n, r) => n.localeCompare(r)) >= 0;
		}
		getVoidElements(e) {
	...
	function Wu(e = Du) {
		const t = new Hu(e), n = new hu(e, t), r = new au(e, t), i = new Vh(t), s = new Iu(i), a = new Cu(t), o = new Lu(t);
		return {
			...
			format: pu,
			findDocumentHighlights: xu,
			findDocumentLinks: o.findDocumentLinks.bind(o),
			findDocumentSymbols: Au,
	...
	var qu = class {
		constructor(e, t) {
			...
			if (n?.dataProviders) for (const s in n.dataProviders) i.push(Pu(s, n.dataProviders[s]));
		...
		_getTextDocument(e) {
			...
			for (let n of t) if (n.uri.toString() === e) return fi.create(e, this._languageId, n.version, n.getValue());
			return null;
		}
	};
	self.onmessage = () => {
