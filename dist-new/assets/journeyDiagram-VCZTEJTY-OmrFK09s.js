...
`+this.showPosition(),{text:"",token:null,line:this.yylineno})},"next"),lex:s(function(){var i=this.next();return i||this.lex()},"lex"),begin:s(function(i){this.conditionStack.push(i)},"begin"),popState:s(function(){return this.conditionStack.length-1>0?this.conditionStack.pop():this.conditionStack[0]},"popState"),_currentRules:s(function(){return this.conditionStack.length&&this.conditionStack[this.conditionStack.length-1]?this.conditions[this.conditionStack[this.conditionStack.length-1]].rules:this.conditions.INITIAL.rules},"_currentRules"),topState:s(function(i){return i=this.conditionStack.length-1-Math.abs(i||0),i>=0?this.conditionStack[i]:"INITIAL"},"topState"),pushState:s(function(i){this.begin(i)},"pushState"),stateStackSize:s(function(){return this.conditionStack.length},"stateStackSize"),options:{"case-insensitive":!0},performAction:s(function(i,a,o,f){switch(o){case 0:break;case 1:break;case 2:return 10;case 3:break;case 4:break;case 5:return 4;case 6:return 11;case 7:return this.begin("acc_title"),12;case 8:return this.popState(),"acc_title_value";case 9:return this.begin("acc_descr"),14;case 10:return this.popState(),"acc_descr_value";case 11:this.begin("acc_descr_multiline");break;case 12:this.popState();break;case 13:return"acc_descr_multiline_value";case 14:return 17;case 15:return 18;case 16:return 19;case 17:return":";case 18:return 6;case 19:return"INVALID"}},"anonymous"),rules:[/^(?:%(?!\{)[^\n]*)/i,/^(?:[^\}]%%[^\n]*)/i,/^(?:[\n]+)/i,/^(?:\s+)/i,/^(?:#[^\n]*)/i,/^(?:journey\b)/i,/^(?:title\s[^#\n;]+)/i,/^(?:accTitle\s*:\s*)/i,/^(?:(?!\n||)*[^\n]*)/i,/^(?:accDescr\s*:\s*)/i,/^(?:(?!\n||)*[^\n]*)/i,/^(?:accDescr\s*\{\s*)/i,/^(?:[\}])/i,/^(?:[^\}]*)/i,/^(?:section\s[^#:\n;]+)/i,/^(?:[^#:\n;]+)/i,/^(?::[^#\n;]+)/i,/^(?::)/i,/^(?:$)/i,/^(?:.)/i],conditions:{acc_descr_multiline:{rules:[12,13],inclusive:!1},acc_descr:{rules:[10],inclusive:!1},acc_title:{rules:[8],inclusive:!1},INITIAL:{rules:[0,1,2,3,4,5,6,7,9,11,14,15,16,17,18,19],inclusive:!0}}}})();function m(){this.yy={}}return s(m,"Parser"),m.prototype=g,g.Parser=m,new m})();Z.parser=Z;var Et=Z,V="",K=[],L=[],B=[],Pt=s(function(){K.length=0,L.length=0,V="",B.length=0,vt()},"clear"),It=s(function(e){V=e,K.push(e)},"addSection"),At=s(function(){return K},"getSections"),Ft=s(function(){let e=nt();const t=100;let l=0;for(;!e&&l<t;)e=nt(),l++;return L.push(...B),L},"getTasks"),Vt=s(function(){const e=[];return L.forEach(t=>{t.people&&e.push(...t.people)}),[...new Set(e)].sort()},"updateActors"),Rt=s(function(e,t){const l=t.substr(1).split(":");let d=0,r=[];l.length===1?(d=Number(l[0]),r=[]):(d=Number(l[0]),r=l[1].split(","));const c=r.map(y=>y.trim()),h={section:V,type:V,people:c,task:e,score:d};B.push(h)},"addTask"),Lt=s(function(e){const t={section:V,type:V,description:e,task:e,classes:[]};L.push(t)},"addTaskOrg"),nt=s(function(){const e=s(function(l){return B[l].processed},"compileTask");let t=!0;for(const[l,d]of B.entries())e(l),t=t&&d.processed;return t},"compileTasks"),st={getConfig:s(()=>R().journey,"getConfig"),clear:Pt,setDiagramTitle:_t,getDiagramTitle:xt,setAccTitle:kt,getAccTitle:Tt,setAccDescription:mt,getAccDescription:bt,addSection:It,getSections:At,getTasks:Ft,addTask:Rt,addTaskOrg:Lt,getActors:s(function(){return Vt()},"getActors")},Bt=s(e=>`.label {
  ...
  ${St()}
`,"getStyles"),Q=s(function(e,t){return $t(e,t)},"drawRect"),jt=s(function(e,t){const d=e.append("circle").attr("cx",t.cx).attr("cy",t.cy).attr("class","face").attr("r",15).attr("stroke-width",2).attr("overflow","visible"),r=e.append("g");r.append("circle").attr("cx",t.cx-15/3).attr("cy",t.cy-15/3).attr("r",1.5).attr("stroke-width",2).attr("fill","#666").attr("stroke","#666"),r.append("circle").attr("cx",t.cx+15/3).attr("cy",t.cy-15/3).attr("r",1.5).attr("stroke-width",2).attr("fill","#666").attr("stroke","#666");function c(g){const m=rt().startAngle(Math.PI/2).endAngle(3*(Math.PI/2)).innerRadius(7.5).outerRadius(6.8181818181818175);g.append("path").attr("class","mouth").attr("d",m).attr("transform","translate("+t.cx+","+(t.cy+2)+")")}s(c,"smile");function h(g){const m=rt().startAngle(3*Math.PI/2).endAngle(5*(Math.PI/2)).innerRadius(7.5).outerRadius(6.8181818181818175);g.append("path").attr("class","mouth").attr("d",m).attr("transform","translate("+t.cx+","+(t.cy+7)+")")}s(h,"sad");function y(g){g.append("line").attr("class","mouth").attr("stroke",2).attr("x1",t.cx-5).attr("y1",t.cy+7).attr("x2",t.cx+5).attr("y2",t.cy+7).attr("class","mouth").attr("stroke-width","1px").attr("stroke","#666")}return s(y,"ambivalent"),t.score>3?c(r):t.score<3?h(r):y(r),d},"drawFace"),ct=s(function(e,t){const l=e.append("circle");return l.attr("cx",t.cx),l.attr("cy",t.cy),l.attr("class","actor-"+t.pos),l.attr("fill",t.fill),l.attr("stroke",t.stroke),l.attr("r",t.r),l.class!==void 0&&l.attr("class",l.class),t.title!==void 0&&l.append("title").text(t.title),l},"drawCircle"),ht=s(function(e,t){return Ct(e,t)},"drawText"),Nt=s(function(e,t){function l(r,c,h,y,g){return r+","+c+" "+(r+h)+","+c+" "+(r+h)+","+(c+y-g)+" "+(r+h-g*1.2)+","+(c+y)+" "+r+","+(c+y)}s(l,"genPoints");const d=e.append("polygon");d.attr("points",l(t.x,t.y,50,20,7)),d.attr("class","labelBox"),t.y=t.y+t.labelMargin,t.x=t.x+.5*t.labelMargin,ht(e,t)},"drawLabel"),zt=s(function(e,t,l){const d=e.append("g"),r=ot();r.x=t.x,r.y=t.y,r.fill=t.fill,r.width=l.width*t.taskCount+l.diagramMarginX*(t.taskCount-1),r.height=l.height,r.class="journey-section section-type-"+t.num,r.rx=3,r.ry=3,Q(d,r),ut(l)(t.text,d,r.x,r.y,r.width,r.height,{class:"journey-section section-type-"+t.num},l,t.colour)},"drawSection"),J=-1,Wt=s(function(e,t,l,d){const r=t.x+l.width/2,c=e.append("g");J++,c.append("line").attr("id",d+"-task"+J).attr("x1",r).attr("y1",t.y).attr("x2",r).attr("y2",450).attr("class","task-line").attr("stroke-width","1px").attr("stroke-dasharray","4 2").attr("stroke","#666"),jt(c,{cx:r,cy:300+(5-t.score)*30,score:t.score});const h=ot();h.x=t.x,h.y=t.y,h.fill=t.fill,h.width=l.width,h.height=l.height,h.class="task task-type-"+t.num,h.rx=3,h.ry=3,Q(c,h);let y=t.x+14;t.people.forEach(g=>{const m=t.actors[g].color;ct(c,{cx:y,cy:t.y,r:7,fill:m,stroke:"#000",title:g,pos:t.actors[g].position}),y+=10}),ut(l)(t.task,c,h.x,h.y,h.width,h.height,{class:"task"},l,t.colour)},"drawTask"),Ot=s(function(e,t){Mt(e,t)},"drawBackgroundRect"),ut=(function(){function e(r,c,h,y,g,m,n,i){d(c.append("text").attr("x",h+g/2).attr("y",y+m/2+5).style("font-color",i).style("text-anchor","middle").text(r),n)}s(e,"byText");function t(r,c,h,y,g,m,n,i,a){const{taskFontSize:o,taskFontFamily:f}=i,p=r.split(/<br\s*\/?>/gi);for(let u=0;u<p.length;u++){const _=u*o-o*(p.length-1)/2,x=c.append("text").attr("x",h+g/2).attr("y",y).attr("fill",a).style("text-anchor","middle").style("font-size",o).style("font-family",f);x.append("tspan").attr("x",h+g/2).attr("dy",_).text(p[u]),x.attr("y",y+m/2).attr("dominant-baseline","central").attr("alignment-baseline","central"),d(x,n)}}s(t,"byTspan");function l(r,c,h,y,g,m,n,i){const a=c.append("switch"),o=a.append("foreignObject").attr("x",h).attr("y",y).attr("width",g).attr("height",m).attr("position","fixed").append("xhtml:div").style("display","table").style("height","100%").style("width","100%");o.append("div").attr("class","label").style("display","table-cell").style("text-align","center").style("vertical-align","middle").text(r),t(r,a,h,y,g,m,n,i),d(o,n)}s(l,"byFo");function d(r,c){for(const h in c)h in c&&r.attr(h,c[h])}return s(d,"_setTextAttrs"),function(r){return r.textPlacement==="fo"?l:r.textPlacement==="old"?e:t}})(),j={drawRect:Q,drawCircle:ct,drawSection:zt,drawText:ht,drawLabel:Nt,drawTask:Wt,drawBackgroundRect:Ot,initGraphics:s(function(e,t){J=-1,e.append("defs").append("marker").attr("id",t+"-arrowhead").attr("refX",5).attr("refY",2).attr("markerWidth",6).attr("markerHeight",4).attr("orient","auto").append("path").attr("d","M 0,0 V 4 L6,2 Z")},"initGraphics")},Yt=s(function(e){Object.keys(e).forEach(function(t){S[t]=e[t]})},"setConf"),M={},W=0;function yt(e){const t=R().journey,l=t.maxLabelWidth;W=0;let d=60;Object.keys(M).forEach(r=>{const c=M[r].color,h={cx:20,cy:d,r:7,fill:c,stroke:"#000",pos:M[r].position};j.drawCircle(e,h);let y=e.append("text").attr("visibility","hidden").text(r);const g=y.node().getBoundingClientRect().width;y.remove();let m=[];if(g<=l)m=[r];else{const n=r.split(" ");let i="";y=e.append("text").attr("visibility","hidden"),n.forEach(a=>{const o=i?`${i} ${a}`:a;if(y.text(o),y.node().getBoundingClientRect().width>l){if(i&&m.push(i),i=a,y.text(a),y.node().getBoundingClientRect().width>l){let f="";for(const p of a)f+=p,y.text(f+"-"),y.node().getBoundingClientRect().width>l&&(m.push(f.slice(0,-1)+"-"),f=p);i=f}}else i=o}),i&&m.push(i),y.remove()}m.forEach((n,i)=>{const a={x:40,y:d+7+i*20,fill:"#666",text:n,textMargin:t.boxTextMargin??5},o=j.drawText(e,a).node().getBoundingClientRect().width;o>W&&o>t.leftMargin-o&&(W=o)}),d+=Math.max(20,m.length*20)})}s(yt,"drawActorLegend");var S=R().journey,C=0,qt=s(function(e,t,l,d){const r=R(),c=r.journey.titleColor,h=r.journey.titleFontSize,y=r.journey.titleFontFamily,g=r.securityLevel;let m;g==="sandbox"&&(m=U("#i"+t));const n=g==="sandbox"?U(m.nodes()[0].contentDocument.body):U("body");T.init();const i=n.select("#"+t);j.initGraphics(i,t);const a=d.db.getTasks(),o=d.db.getDiagramTitle(),f=d.db.getActors();for(const A in M)delete M[A];let p=0;f.forEach(A=>{M[A]={color:S.actorColours[p%S.actorColours.length],position:p},p++}),yt(i),C=S.leftMargin+W,T.insert(0,0,C,Object.keys(M).length*50),Xt(i,a,0,t);const u=T.getBounds();o&&i.append("text").text(o).attr("x",C).attr("font-size",h).attr("font-weight","bold").attr("y",25).attr("fill",c).attr("font-family",y);const _=u.stopy-u.starty+2*S.diagramMarginY,x=C+u.stopx+2*S.diagramMarginX;wt(i,_,x,S.useMaxWidth),i.append("line").attr("x1",C).attr("y1",S.height*4).attr("x2",x-C-4).attr("y2",S.height*4).attr("stroke-width",4).attr("stroke","black").attr("marker-end","url(#"+t+"-arrowhead)");const E=o?70:0;i.attr("viewBox",`${u.startx} -25 ${x} ${_+E}`),i.attr("preserveAspectRatio","xMinYMin meet"),i.attr("height",_+E+25)},"draw"),T={data:{startx:void 0,stopx:void 0,starty:void 0,stopy:void 0},verticalPos:0,sequenceItems:[],init:s(function(){this.sequenceItems=[],this.data={startx:void 0,stopx:void 0,starty:void 0,stopy:void 0},this.verticalPos=0},"init"),updateVal:s(function(e,t,l,d){e[t]===void 0?e[t]=l:e[t]=d(l,e[t])},"updateVal"),updateBounds:s(function(e,t,l,d){const r=R().journey,c=this;let h=0;function y(g){return s(function(n){h++;const i=c.sequenceItems.length-h+1;c.updateVal(n,"starty",t-i*r.boxMargin,Math.min),c.updateVal(n,"stopy",d+i*r.boxMargin,Math.max),c.updateVal(T.data,"startx",e-i*r.boxMargin,Math.min),c.updateVal(T.data,"stopx",l+i*r.boxMargin,Math.max),g!=="activation"&&(c.updateVal(n,"startx",e-i*r.boxMargin,Math.min),c.updateVal(n,"stopx",l+i*r.boxMargin,Math.max),c.updateVal(T.data,"starty",t-i*r.boxMargin,Math.min),c.updateVal(T.data,"stopy",d+i*r.boxMargin,Math.max))},"updateItemBounds")}s(y,"updateFn"),this.sequenceItems.forEach(y())},"updateBounds"),insert:s(function(e,t,l,d){const r=Math.min(e,l),c=Math.max(e,l),h=Math.min(t,d),y=Math.max(t,d);this.updateVal(T.data,"startx",r,Math.min),this.updateVal(T.data,"starty",h,Math.min),this.updateVal(T.data,"stopx",c,Math.max),this.updateVal(T.data,"stopy",y,Math.max),this.updateBounds(r,h,c,y)},"insert"),bumpVerticalPos:s(function(e){this.verticalPos=this.verticalPos+e,this.data.stopy=this.verticalPos},"bumpVerticalPos"),getVerticalPos:s(function(){return this.verticalPos},"getVerticalPos"),getBounds:s(function(){return this.data},"getBounds")},H=S.sectionFills,at=S.sectionColours,Xt=s(function(e,t,l,d){const r=R().journey;let c="";const h=l+(r.height*2+r.diagramMarginY);let y=0,g="#CCC",m="black",n=0;for(const[i,a]of t.entries()){if(c!==a.section){g=H[y%H.length],n=y%H.length,m=at[y%at.length];let f=0;const p=a.section;for(let _=i;_<t.length&&t[_].section==p;_++)f=f+1;const u={x:i*r.taskMargin+i*r.width+C,y:50,text:a.section,fill:g,num:n,colour:m,taskCount:f};j.drawSection(e,u,r),c=a.section,y++}const o=a.people.reduce((f,p)=>(M[p]&&(f[p]=M[p]),f),{});a.x=i*r.taskMargin+i*r.width+C,a.y=h,a.width=r.diagramMarginX,a.height=r.diagramMarginY,a.colour=m,a.fill=g,a.num=n,a.actors=o,j.drawTask(e,a,r,d),T.insert(a.x,a.y,a.x+a.width+r.taskMargin,450)}},"drawTasks"),lt={setConf:Yt,draw:qt},Kt={parser:Et,db:st,renderer:lt,styles:Bt,init:s(e=>{lt.setConf(e.journey),st.clear()},"init")};export{Kt as diagram};
