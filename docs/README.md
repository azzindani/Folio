...
| [COMPOSITION.md](COMPOSITION.md) | **Proposal:** continuous composition — one scene with layered sub-sequences instead of slide scenes; have-vs-missing, the state-based `op:storyboard` protocol, build order | …you're picking up the next video workstream |
