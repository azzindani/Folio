...
| [COMPOSITION.md](COMPOSITION.md) | **Proposal:** continuous composition — one scene with layered sub-sequences instead of slide scenes; positioning (declarative 2D vs HTML video, leverage points, why no 3D), have-vs-missing, the state-based `op:storyboard` protocol, build order | …you're picking up the next video workstream |
