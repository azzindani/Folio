...
export interface Mood { theme: string; bg: string; accent: string; text_color: string; palette: string[]; bg_style: string; font: string; }
...
export const MOOD_BANK: Mood[] = [
  /* 0  bold red     */ { theme: 'bold-poster', bg: '#0A0A0A', accent: '#FF3D00', text_color: '#FAFAFA', palette: ['#FF3D00', '#F4B740', '#3DD4C8'], bg_style: 'tri:br + diagonal_stripes + grain', font: 'Anton' },
  /* 1  indigo tech  */ { theme: 'bold-poster', bg: '#0E0B14', accent: '#7C5CFF', text_color: '#F5F1EA', palette: ['#7C5CFF', '#27C2A0', '#F4B740'], bg_style: 'mesh + grid + grain', font: 'Space Grotesk' },
  /* 2  gold money   */ { theme: 'bold-poster', bg: '#0A0A0A', accent: '#F4B740', text_color: '#FAFAFA', palette: ['#F4B740', '#E0A96D', '#3DD4C8'], bg_style: 'blocks + glow + grain', font: 'Bebas Neue' },
  /* 3  teal ocean   */ { theme: 'bold-poster', bg: '#06141B', accent: '#2FD2C4', text_color: '#EAF6F4', palette: ['#2FD2C4', '#48A6C9', '#F2C66B'], bg_style: 'wave:bottom + rings:tr + grain', font: 'Space Grotesk' },
  /* 4  midnight sky */ { theme: 'bold-poster', bg: '#0A0E1C', accent: '#5B8CFF', text_color: '#EAF0FF', palette: ['#5B8CFF', '#9B7CFF', '#F2C66B'], bg_style: 'diag:tr + rings:tr + grain', font: 'Orbitron' },
  /* 5  plum night   */ { theme: 'bold-poster', bg: '#160A14', accent: '#FF5C8A', text_color: '#FDEFF3', palette: ['#FF5C8A', '#FFB347', '#7C5CFF'], bg_style: 'glow + arcs:bottom + grain', font: 'Playfair Display' },
  /* 6  sepia past   */ { theme: 'bold-poster', bg: '#17120B', accent: '#E0A96D', text_color: '#F6EFE2', palette: ['#E0A96D', '#C66B4A', '#8FA37E'], bg_style: 'vignette + crosshatch + grain', font: 'Playfair Display' },
  /* 7  forest green */ { theme: 'bold-poster', bg: '#08140F', accent: '#34C77B', text_color: '#EAF5EE', palette: ['#34C77B', '#9CCB6A', '#E0B15E'], bg_style: 'wave:bottom + dot_grid + grain', font: 'Bricolage Grotesque' },
  /* 8  sage cream   */ { theme: 'editorial-cream', bg: '#F2F0E6', accent: '#3E7C5A', text_color: '#1A1A1A', palette: ['#3E7C5A', '#9CAF88', '#6E8BB5'], bg_style: 'curve:tr + dot_grid + grain', font: 'Source Serif' },
  /* 9  terracotta   */ { theme: 'editorial-cream', bg: '#FAF5EC', accent: '#B8543C', text_color: '#1A1A1A', palette: ['#B8543C', '#E0A96D', '#6E8BB5'], bg_style: 'tri:br + diagonal_stripes + grain', font: 'Playfair Display' },
  /* 10 swiss blue   */ { theme: 'swiss-international', bg: '#F4F1EA', accent: '#1F4FD8', text_color: '#111111', palette: ['#1F4FD8', '#E5342B', '#111111'], bg_style: 'blocks + grid + grain', font: 'Space Grotesk' },
  /* 11 cool azure   */ { theme: 'editorial-cream', bg: '#EAF0F4', accent: '#1F6FB2', text_color: '#15202B', palette: ['#1F6FB2', '#3DB6C9', '#E08A3C'], bg_style: 'arcs:bottom + dot_grid + grain', font: 'Manrope' },
  /* 12 lavender     */ { theme: 'editorial-cream', bg: '#F3EEF6', accent: '#7A3FA0', text_color: '#1A1326', palette: ['#7A3FA0', '#C77DBB', '#6E8BB5'], bg_style: 'rings:tr + scallop + grain', font: 'Quicksand' },
  /* 13 clay gallery */ { theme: 'gallery', bg: '#EDE7DD', accent: '#A8432A', text_color: '#1A1A1A', palette: ['#A8432A', '#C9A24B', '#5E7E6E'], bg_style: 'shards + grain', font: 'Bricolage Grotesque' },
  /* 14 mono print   */ { theme: 'mono-print', bg: '#F5F5F2', accent: '#111111', text_color: '#111111', palette: ['#111111', '#E5342B', '#9A9A9A'], bg_style: 'blocks + crosshatch + grain', font: 'Bebas Neue' },
  /* 15 rose coral   */ { theme: 'editorial-cream', bg: '#FBEFEC', accent: '#E0533D', text_color: '#2A1512', palette: ['#E0533D', '#F2A65A', '#6E8BB5'], bg_style: 'wave:bottom + dots + grain', font: 'Plus Jakarta Sans' },
  /* 16 emerald noir */ { theme: 'bold-poster', bg: '#07130E', accent: '#1FBF75', text_color: '#E9F6EE', palette: ['#1FBF75', '#7FD99B', '#E0B15E'], bg_style: 'diag:tl + tri:br + grain', font: 'Space Grotesk' },
  /* 17 amber noir   */ { theme: 'bold-poster', bg: '#14100A', accent: '#FFB000', text_color: '#FBF3E4', palette: ['#FFB000', '#E0673B', '#5E7E6E'], bg_style: 'blocks + diagonal_stripes + grain', font: 'Anton' },
  /* 18 slate mono   */ { theme: 'mono-print', bg: '#ECEEF0', accent: '#2B2F36', text_color: '#15181C', palette: ['#2B2F36', '#C0392B', '#7E8A99'], bg_style: 'grid + tri:tr + grain', font: 'IBM Plex Sans' },
  /* 19 magenta pop  */ { theme: 'bold-poster', bg: '#120516', accent: '#E0218A', text_color: '#FCE9F4', palette: ['#E0218A', '#9B5CFF', '#36C9C0'], bg_style: 'shards + glow + grain', font: 'Audiowide' },
];
...
const DEFAULT_MOOD: Mood = MOOD_BANK[1] ?? { theme: 'bold-poster', bg: '#0E0B14', accent: '#7C5CFF', text_color: '#F5F1EA', palette: ['#7C5CFF', '#27C2A0', '#F4B740'], bg_style: 'mesh + grid + grain', font: 'Space Grotesk' };
