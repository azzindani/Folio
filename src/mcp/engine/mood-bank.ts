...
export const MOOD_BANK: Mood[] = [
  ...
  /* 8  sage cream   */ { theme: 'editorial-cream', bg: '#F2F0E6', accent: '#3E7C5A', text_color: '#1A1A1A', palette: ['#3E7C5A', '#9CAF88', '#6E8BB5'], bg_style: 'curve:tr + dot_grid + grain', font: 'Source Serif 4', headline: 'rotate' },
