...
export const TIER3_TOOLS: ToolDefinition[] = [
  ...
  },
  {
    ...
    inputSchema: {
      type: 'object',
      properties: {
        op:           { type: 'string', enum: ['presets', 'sequence', 'track', 'motion', 'motion_path', 'text', 'wiggle', 'camera', 'morph', 'keyframe', 'frame', 'preview', 'timeline', 'clear', 'export', 'export_status', 'scene', 'audio'], description: 'Which animation action to run.' },
        ...
        audio_id:     { type: 'string', description: 'op:audio — which sound to change or remove (default for a new one: its file name).' },
