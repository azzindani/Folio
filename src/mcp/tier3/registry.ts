...
export const TIER3_TOOLS: ToolDefinition[] = [
  ...
  },
  {
    ...
    inputSchema: {
      type: 'object',
      properties: {
        op:           { type: 'string', enum: ['presets', 'sequence', 'track', 'motion', 'motion_path', 'text', 'wiggle', 'camera', 'keyframe', 'frame', 'preview', 'timeline', 'clear', 'export', 'scene'], description: 'Which animation action to run.' },
