  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        delay:        { type: 'number', description: 'op:morph — when the shape starts to change, ms from the start of the layer\'s track. It must not overlap motion the layer already has.' },
