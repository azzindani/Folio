  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        preset:       { type: 'string', description: 'op:motion — preset name. Entrances: fade_in, rise, settle, scale_in, sweep_in, pop, drop, blur_in, draw_on, spin_in, flip_in, grow_up, whip, wipe_in, track_in. Exits: fade_out, sink, shrink_out, blur_out, sweep_out, pop_out, wipe_out. Loops: pulse, float, spin, drift, breathe, wobble, sway, heartbeat, flicker.' },
