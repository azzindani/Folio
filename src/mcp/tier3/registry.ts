...
export const TIER3_TOOLS: ToolDefinition[] = [
  ...
  },
  {
    ...
    inputSchema: {
      type: 'object',
      properties: {
        op:           { type: 'string', enum: ['presets', 'sequence', 'track', 'motion', 'motion_path', 'text', 'wiggle', 'camera', 'morph', 'keyframe', 'frame', 'preview', 'timeline', 'clear', 'export', 'export_status', 'scene', 'audio', 'beats'], description: 'Which animation action to run.' },
