...
// The coercion half lives in ./shorthand-coerce — the shapes a model sends when
// it does not follow the documented one. Re-exported here so every existing
// import keeps working; edit the sibling, not this line.
export {
  KNOWN_SHORTHAND_TYPES, parseCompactLayer, closeJsonString, lenientParseLayers,
  CONTAINER_TYPES, FILENAME_RE, isStrayContainerLayer, pruneStrayMeta, coerceShorthandLayers,
} from './shorthand-coerce';
