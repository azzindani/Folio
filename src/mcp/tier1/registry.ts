...
export const TIER1_TOOLS: ToolDefinition[] = [
  ...
  },
  {
    ...
    inputSchema: {
      type: 'object',
      properties: {
        op:            { type: 'string', enum: ['list', 'browse', 'inspect', 'rename', 'duplicate', 'move', 'delete', 'resume', 'gallery', 'asset_add', 'asset_list', 'asset_delete', 'asset_move', 'asset_read'], description: 'Which management action to run.' },
        ...
        name:          { type: 'string', description: 'op:asset_add — filename WITH extension. Images png/jpg/webp/gif/avif/svg · fonts ttf/otf/woff2/woff · docs md/txt/csv/json/yaml (source material to build a design FROM — read it back with op:asset_read).' },
        ...
        asset_path:    { type: 'string', description: 'op:asset_delete/asset_move/asset_read — project-relative path like "assets/images/team.jpg" or "assets/images/<folder>/team.jpg" (from asset_list).' },
