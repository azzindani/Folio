...
export const TIER1_TOOLS: ToolDefinition[] = [
  ...
  },
  {
    ...
    inputSchema: {
      type: 'object',
      properties: {
        op:            { type: 'string', enum: ['list', 'browse', 'inspect', 'rename', 'duplicate', 'move', 'delete', 'resume', 'gallery', 'asset_add', 'asset_process', 'asset_list', 'asset_delete', 'asset_move', 'asset_read', 'asset_write', 'asset_search', 'asset_fetch', 'asset_promote'], description: 'Which management action to run.' },
        ...
        query:         { type: 'string', description: 'op:asset_search — what you are looking for, in plain words ("overhead shot of a desk", "kubernetes logo", "grotesk"). Search engines index OBJECTS: for an abstract theme, name the concrete thing that stands for it.' },
