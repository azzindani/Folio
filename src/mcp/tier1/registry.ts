  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        asset_path:    { type: 'string', description: 'op:asset_delete/asset_move/asset_read/asset_write — project-relative path like "assets/images/team.jpg" or "assets/images/<folder>/team.jpg" (from asset_list).' },
