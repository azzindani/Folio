...
export const TOOL_OPS: Record<string, readonly string[]> = {
  ...
  animation: ['timeline', 'keyframe', 'export', 'export_status', 'motion', 'motion_path', 'sequence', 'track', 'clear', 'frame', 'presets', 'preview', 'scene', 'text', 'wiggle', 'camera', 'morph', 'audio', 'beats', 'captions'],
};
