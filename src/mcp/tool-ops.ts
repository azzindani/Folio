...
export const TOOL_OPS: Record<string, readonly string[]> = {
  ...
  animation: ['timeline', 'keyframe', 'export', 'export_status', 'motion', 'motion_path', 'sequence', 'track', 'clear', 'frame', 'presets', 'preview', 'scene', 'text', 'wiggle', 'camera', 'morph', 'audio', 'video', 'beats', 'captions', 'storyboard', 'markers', 'span', 'retime', 'loop', 'drive', 'precomp', 'link', 'parent', 'null', 'motion_blur', 'lint'],
};
